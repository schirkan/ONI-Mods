...
public class EnergyInfoScreen : TargetScreen
{
  ...
  public override bool IsValidForTarget(GameObject target) => (Object) target.GetComponent<Generator>() != (Object) null || (Object) target.GetComponent<Wire>() != (Object) null || (Object) target.GetComponent<Battery>() != (Object) null || (Object) target.GetComponent<EnergyConsumer>() != (Object) null;

  protected override void OnPrefabInit()
  {
    base.OnPrefabInit();
    this.overviewPanel = Util.KInstantiateUI(ScreenPrefabs.Instance.CollapsableContentPanel, this.gameObject);
    ...
    this.generatorsPanel = Util.KInstantiateUI(ScreenPrefabs.Instance.CollapsableContentPanel, this.gameObject);
    ...
    this.consumersPanel = Util.KInstantiateUI(ScreenPrefabs.Instance.CollapsableContentPanel, this.gameObject);
    ...
    this.batteriesPanel = Util.KInstantiateUI(ScreenPrefabs.Instance.CollapsableContentPanel, this.gameObject);
    ...
    string id)
  {
    ...
    {
      gameObject = Util.KInstantiate(this.labelTemplate, panel.GetComponent<CollapsibleDetailContentPanel>().Content.gameObject);
  ...
  private void Refresh()
  {
    ...
    if (circuitID != ushort.MaxValue)
    {
      ...
      label1.GetComponent<LocText>().text = string.Format((string) UI.DETAILTABS.ENERGYGENERATOR.AVAILABLE_JOULES, (object) GameUtil.GetFormattedJoules(availableOnCircuit));
      ...
      label3.GetComponent<LocText>().text = string.Format((string) UI.DETAILTABS.ENERGYGENERATOR.WATTAGE_CONSUMED, (object) GameUtil.GetFormattedWattage(circuitManager.GetWattsUsedByCircuit(circuitID)));
      ...
      label4.GetComponent<LocText>().text = string.Format((string) UI.DETAILTABS.ENERGYGENERATOR.POTENTIAL_WATTAGE_CONSUMED, (object) GameUtil.GetFormattedWattage(circuitManager.GetWattsNeededWhenActive(circuitID)));
      ...
      label5.GetComponent<LocText>().text = string.Format((string) UI.DETAILTABS.ENERGYGENERATOR.MAX_SAFE_WATTAGE, (object) GameUtil.GetFormattedWattage(circuitManager.GetMaxSafeWattageForCircuit(circuitID)));
        ...
        foreach (Generator generator in generatorsOnCircuit)
        {
          if ((Object) generator != (Object) null && (Object) generator.GetComponent<Battery>() == (Object) null)
          {
            ...
            if (generator.GetComponent<Operational>().IsActive)
              label5.GetComponent<LocText>().text = string.Format("{0}: {1}", (object) generator.GetComponent<KSelectable>().entityName, (object) GameUtil.GetFormattedWattage(generator.WattageRating));
            else
              label5.GetComponent<LocText>().text = string.Format("{0}: {1} / {2}", (object) generator.GetComponent<KSelectable>().entityName, (object) GameUtil.GetFormattedWattage(0.0f), (object) GameUtil.GetFormattedWattage(generator.WattageRating));
            label5.SetActive(true);
            label5.GetComponent<LocText>().fontStyle = (Object) generator.gameObject == (Object) this.selectedTarget ? FontStyles.Bold : FontStyles.Normal;
          }
        }
      }
      else
      ...
      if (batteriesOnCircuit.Count > 0)
      {
        foreach (Battery battery in batteriesOnCircuit)
        {
          if ((Object) battery != (Object) null)
          {
            ...
            label6.GetComponent<LocText>().text = string.Format("{0}: {1}", (object) battery.GetComponent<KSelectable>().entityName, (object) GameUtil.GetFormattedJoules(battery.JoulesAvailable));
            label6.SetActive(true);
            label6.GetComponent<LocText>().fontStyle = (Object) battery.gameObject == (Object) this.selectedTarget ? FontStyles.Bold : FontStyles.Normal;
          }
        }
      }
      else
  ...
  private void AddConsumerInfo(IEnergyConsumer consumer, GameObject label)
  {
    ...
    label.SetActive(true);
    label.GetComponent<LocText>().fontStyle = (Object) kmonoBehaviour.gameObject == (Object) this.selectedTarget ? FontStyles.Bold : FontStyles.Normal;
  }
}
