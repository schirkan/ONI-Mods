...
public class OilFloaterConfig : IEntityConfig
{
  ...
  public GameObject CreatePrefab()
  {
    ...
    EntityTemplates.ExtendEntityToFertileCreature(oilFloater, "OilfloaterEgg", (string) STRINGS.CREATURES.SPECIES.OILFLOATER.EGG_NAME, (string) STRINGS.CREATURES.SPECIES.OILFLOATER.DESC, "egg_oilfloater_kanim", OilFloaterTuning.EGG_MASS, "OilfloaterBaby", 60f, 20f, OilFloaterTuning.EGG_CHANCES_BASE, OilFloaterConfig.EGG_SORT_ORDER);
    return oilFloater;
  }
