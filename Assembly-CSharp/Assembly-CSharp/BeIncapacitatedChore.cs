...
public class BeIncapacitatedChore : Chore<BeIncapacitatedChore.StatesInstance>
{
  ...
  public class States : GameStateMachine<BeIncapacitatedChore.States, BeIncapacitatedChore.StatesInstance, BeIncapacitatedChore>
  {
    ...
    public override void InitializeStates(out StateMachine.BaseState default_state)
    {
      ...
      this.incapacitation_root.lookingForBed.Update("LookForAvailableClinic", (System.Action<BeIncapacitatedChore.StatesInstance, float>) ((smi, dt) => smi.master.FindAvailableMedicalBed(smi.master.GetComponent<Navigator>())), UpdateRate.SIM_1000ms).Enter("PlayAnim", (StateMachine<BeIncapacitatedChore.States, BeIncapacitatedChore.StatesInstance, BeIncapacitatedChore, object>.State.Callback) (smi =>
      {
      ...
      this.incapacitation_root.rescue.waitingForPickup.EventTransition(GameHashes.OnStore, this.incapacitation_root.rescue.carried).Update("LookForAvailableClinic", (System.Action<BeIncapacitatedChore.StatesInstance, float>) ((smi, dt) =>
      {
        bool flag = false;
