...
public class MinionBrain : Brain
{
    ...
    float max_trigger_time)
  {
    ...
    SelfEmoteReactable reactable = new SelfEmoteReactable(this.gameObject, (HashedString) reactable_id, Db.Get().ChoreTypes.Cough, (HashedString) kanim_file_name, max_trigger_time);
  ...
  private void OnUnstableGroundImpact(object data) => this.RegisterReactEmotePair("UnstableGroundShock", "anim_react_shock_kanim", 1f);
