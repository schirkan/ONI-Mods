...
public class EatChore : Chore<EatChore.StatesInstance>
{
  public static readonly Chore.Precondition EdibleIsNotNull = new Chore.Precondition()
  {
    ...
    fn = (Chore.PreconditionFn) ((ref Chore.Precondition.Context context, object data) => (Object) null != (Object) context.consumerState.consumer.GetSMI<RationMonitor.Instance>().GetEdible())
  };
  ...
  public override void Begin(Chore.Precondition.Context context)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        if ((Object) edible.gameObject == (Object) null)
  ...
  public class StatesInstance : GameStateMachine<EatChore.States, EatChore.StatesInstance, EatChore, object>.GameInstance
  {
    ...
    public bool UseSalt()
    {
      if (this.smi.sm.messstation == null || !((Object) this.smi.sm.messstation.Get(this.smi) != (Object) null))
        return false;
      MessStation component = this.smi.sm.messstation.Get(this.smi).GetComponent<MessStation>();
      return (Object) component != (Object) null && component.HasSalt;
    }
    ...
    public void CreateLocator()
    {
      ...
      if (num == Grid.InvalidCell)
        num = Grid.PosToCell(this.sm.eater.Get<Transform>(this.smi).GetPosition());
    ...
    public void ApplySaltEffect()
    {
      ...
      if (!((Object) component != (Object) null) || !component.Has(TableSaltConfig.ID.ToTag()))
        return;
      ...
      this.sm.messstation.Get(this.smi).gameObject.Trigger(1356255274);
    }
  }
