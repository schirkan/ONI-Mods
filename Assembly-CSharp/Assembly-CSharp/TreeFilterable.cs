...
public class TreeFilterable : KMonoBehaviour, ISaveLoadable
{
  ...
  public List<Tag> AcceptedTags => this.acceptedTags;
  ...
  public Tag[] GetTags() => this.acceptedTags.ToArray();

  public bool ContainsTag(Tag t) => this.acceptedTags.Contains(t);
