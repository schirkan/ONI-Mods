...
public class SafetyConditions
{
  ...
  public SafetyConditions()
  {
    ...
    int num8;
    this.IsCorrectTemperature = new SafetyChecker.Condition(nameof (IsCorrectTemperature), num8 = num6 * 2, (SafetyChecker.Condition.Callback) ((cell, cost, context) => (double) Grid.Temperature[cell] > 285.149993896484 && (double) Grid.Temperature[cell] < 303.149993896484));
    int num9;
