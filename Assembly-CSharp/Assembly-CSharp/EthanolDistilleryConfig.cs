...
public class EthanolDistilleryConfig : IBuildingConfig
{
  ...
  public override void ConfigureBuildingTemplate(GameObject go, Tag prefab_tag)
  {
    ...
    elementConverter.outputElements = new ElementConverter.OutputElement[3]
    {
      ...
      new ElementConverter.OutputElement(0.3333333f, SimHashes.ToxicSand, 366.5f, storeOutput: true),
      new ElementConverter.OutputElement(0.1666667f, SimHashes.CarbonDioxide, 366.5f)
    };
