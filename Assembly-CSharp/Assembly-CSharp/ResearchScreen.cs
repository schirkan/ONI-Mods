...
public class ResearchScreen : KModalScreen
{
  ...
  private void Update()
  {
    ...
    Vector2 vector2_5 = anchoredPosition + vector2_4 + this.keyPanDelta + zero2;
    if (!this.isDragging)
    {
      Rect rect = component.rect;
      Vector2 vector2_3 = rect.size * -0.5f * this.currentZoom;
      rect = component.rect;
      Vector2 vector2_6 = rect.size * 0.5f * this.currentZoom;
      Vector2 vector2_7 = new Vector2(Mathf.Clamp(vector2_5.x, vector2_3.x, vector2_6.x), Mathf.Clamp(vector2_5.y, vector2_3.y, vector2_6.y)) - vector2_5;
      if (!this.panLeft && !this.panRight && (!this.panUp && !this.panDown))
      {
        vector2_5 += vector2_7 * this.edgeClampFactor * Time.unscaledDeltaTime;
      }
      else
      {
        vector2_5 += vector2_7;
  ...
  protected override void OnShow(bool show)
  {
    ...
    else if ((UnityEngine.Object) SelectTool.Instance.selected != (UnityEngine.Object) null && !DetailsScreen.Instance.gameObject.activeSelf)
    {
