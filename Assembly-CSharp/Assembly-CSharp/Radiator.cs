...
public class Radiator : KMonoBehaviour, IGameObjectEffectDescriptor
{
  ...
  private void OnCellChanged() => this.GetComponent<Radiator>().Refresh();
  ...
  public void Refresh()
  {
    ...
    this.cell = cell;
    this.litCells.Clear();
    this.emitter = new RadiationGridEmitter(this.cell, this.litCells, this.Lux, this.Range, this.shape);
    this.emitter.Add();
    this.isRegistered = true;
  }

  private void TriggerRefresh(object data) => this.Refresh();
