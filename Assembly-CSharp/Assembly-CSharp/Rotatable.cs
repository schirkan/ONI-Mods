...
public class Rotatable : KMonoBehaviour, ISaveLoadable
{
  ...
  private void OrientCollider(Orientation orientation)
  {
    ...
    Matrix2x3 matrix2x3_3 = Matrix2x3.Translate((Vector2) this.pivot) * matrix2x3_2 * matrix2x3_1;
    ...
    vector2_1 = (Vector2) matrix2x3_3.MultiplyPoint((Vector3) vector2_1);
    Vector2 vector2_4 = (Vector2) matrix2x3_3.MultiplyPoint((Vector3) vector2_2);
    vector2_3 = (Vector2) matrix2x3_3.MultiplyPoint((Vector3) vector2_3);
  ...
  public bool IsRotated => (uint) this.orientation > 0U;
}
