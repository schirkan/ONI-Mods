...
public static class LightGridManager
{
  ...
  public class LightGridEmitter
  {
    ...
    public struct State : IEquatable<LightGridManager.LightGridEmitter.State>
    {
      ...
      public bool Equals(LightGridManager.LightGridEmitter.State rhs) => this.origin == rhs.origin && this.shape == rhs.shape && ((double) this.radius == (double) rhs.radius && this.intensity == rhs.intensity) && (double) this.falloffRate == (double) rhs.falloffRate && this.colour == rhs.colour;
    }
  }
}
