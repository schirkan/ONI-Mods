...
public class Recipe : IHasSortOrder
{
  ...
  private GameObject CraftRecipe(
    Storage resource_storage,
    Recipe.Ingredient[] ingredientTags)
  {
  ...
  public Color GetUIColor() => !((UnityEngine.Object) this.Icon != (UnityEngine.Object) null) ? Color.white : this.IconColor;
  ...
  public class Ingredient
  {
    ...
    public List<Element> GetElementOptions()
    {
      ...
      elementList.RemoveAll((Predicate<Element>) (e => !e.IsSolid));
      elementList.RemoveAll((Predicate<Element>) (e => !e.HasTag(this.tag)));
      return elementList;
    }
  }
}
