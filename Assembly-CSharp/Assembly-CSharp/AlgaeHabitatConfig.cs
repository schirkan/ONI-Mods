...
public class AlgaeHabitatConfig : IBuildingConfig
{
  ...
  public override void ConfigureBuildingTemplate(GameObject go, Tag prefab_tag)
  {
    ...
    {
      new ElementConverter.OutputElement(0.04f, SimHashes.Oxygen, 303.15f, outputElementOffsety: 1f)
    };
    go.AddComponent<ElementConverter>().outputElements = new ElementConverter.OutputElement[1]
    {
      new ElementConverter.OutputElement(0.2903334f, SimHashes.DirtyWater, 303.15f, storeOutput: true, outputElementOffsety: 1f)
    };
