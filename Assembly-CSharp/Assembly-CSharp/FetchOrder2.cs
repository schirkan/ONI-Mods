...
public class FetchOrder2
{
    ...
    int priorityMod = 0)
  {
    if ((double) amount <= (double) PICKUPABLETUNING.MINIMUM_PICKABLE_AMOUNT)
      DebugUtil.LogWarningArgs((object) string.Format("FetchOrder2 {0} is requesting {1} {2} to {3}", (object) chore_type.Id, (object) tags[0], (object) amount, (UnityEngine.Object) destination != (UnityEngine.Object) null ? (object) destination.name : (object) "to nowhere"));
  ...
  private void SetFetchTask(float amount) => this.Chores.Add(new FetchChore(this.choreType, this.Destination, amount, this.Tags, this.RequiredTags, this.ForbiddenTags, on_complete: new System.Action<Chore>(this.OnFetchChoreComplete), on_begin: new System.Action<Chore>(this.OnFetchChoreBegin), on_end: new System.Action<Chore>(this.OnFetchChoreEnd), operational_requirement: this.operationalRequirement, priority_mod: this.PriorityMod));
