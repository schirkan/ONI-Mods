...
public class BipedTransitionLayer : TransitionDriver.OverrideLayer
{
  ...
  public override void BeginTransition(Navigator navigator, Navigator.ActiveTransition transition)
  {
    ...
    float num2 = 1f;
    bool flag4 = (uint) (navigator.flags & PathFinder.PotentialPath.Flags.HasAtmoSuit) > 0U;
    if (!((uint) (navigator.flags & PathFinder.PotentialPath.Flags.HasJetPack) > 0U | flag4) && Grid.IsSubstantialLiquid(cell))
      num2 = 0.5f;
