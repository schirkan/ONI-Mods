...
namespace Database
{
  public class AttributeConverters : ResourceSet<AttributeConverter>
  {
    ...
    {
      ToPercentAttributeFormatter attributeFormatter1 = new ToPercentAttributeFormatter(1f);
      ...
      this.ToiletSpeed = this.Create(nameof (ToiletSpeed), "Toilet Speed", "", Db.Get().Attributes.ToiletEfficiency, 1f, -1f, (IAttributeFormatter) attributeFormatter1);
