...
namespace Database
{
  public class Techs : ResourceSet<Tech>
  {
    ...
    public static Dictionary<string, string[]> TECH_GROUPING = new Dictionary<string, string[]>()
    {
      ...
      {
        "MedicineIV",
        new string[2]{ "AdvancedDoctorStation", "HotTub" }
      },
      {
        "LiquidPiping",
        new string[4]
      ...
      {
        "FlowRedirection",
        new string[1]{ "MechanicalSurfboard" }
      },
      {
        "AdvancedFiltration",
      ...
      {
        "Screens",
        new string[1]{ PixelPackConfig.ID }
      },
      {
        "RenaissanceArt",
        new string[5]
      ...
      {
        "NotificationSystems",
        new string[2]{ LogicHammerConfig.ID, LogicAlarmConfig.ID }
      },
      {
        "ArtificialFriends",
        new string[1]{ "SweepBotStation" }
      },
      {
        "BasicRefinement",
