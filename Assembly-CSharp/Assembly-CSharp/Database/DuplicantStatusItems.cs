...
namespace Database
{
  public class DuplicantStatusItems : StatusItems
  {
    ...
    private void CreateStatusItems()
    {
      ...
      {
        string str1 = string.Format((string) DUPLICANTS.STATUSITEMS.LIGHTWORKEFFICIENCYBONUS.NO_BUILDING_WORK_ATTRIBUTE, (object) GameUtil.AddPositiveSign(GameUtil.GetFormattedPercent(DUPLICANTSTATS.LIGHT.LIGHT_WORK_EFFICIENCY_BONUS * 100f), true));
        return string.Format(str, (object) str1);
      });
