  ...
  public class RoomTypes : ResourceSet<RoomType>
  {
      ...
      : base(nameof (RoomTypes), parent)
    {
      ...
      }, new RoomDetails.Detail[2]
      {
        RoomDetails.SIZE,
        RoomDetails.BUILDING_COUNT
      }, 1, effects: new string[1]{ "RoomBedroom" }, sortKey: 4));
      ...
      }, new RoomDetails.Detail[2]
      {
        RoomDetails.SIZE,
        RoomDetails.BUILDING_COUNT
      }, 1, new RoomType[1]{ this.Bedroom }, effects: new string[1]
      {
        "RoomBarracks"
      }, sortKey: 3));
      ...
      }, new RoomDetails.Detail[2]
      {
        RoomDetails.SIZE,
        RoomDetails.BUILDING_COUNT
      }, 2, single_assignee: true, priority_building_use: true, sortKey: 8));
      ...
      }, new RoomDetails.Detail[2]
      {
        RoomDetails.SIZE,
        RoomDetails.BUILDING_COUNT
      }, single_assignee: true, priority_building_use: true, sortKey: 14));
      ...
      }, new RoomDetails.Detail[4]
      {
        ...
        RoomDetails.CREATURE_COUNT,
        RoomDetails.PLANT_COUNT
      }, 1, effects: new string[1]{ "RoomNatureReserve" }, sortKey: 16));
