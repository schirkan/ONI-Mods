  ...
  public class CreatureStatusItems : StatusItems
  {
    ...
    private void CreateStatusItems()
    {
      ...
      this.Hot.resolveStringCallback = (Func<string, object, string>) ((str, data) =>
      {
        ...
        return string.Format(str, (object) GameUtil.GetFormattedTemperature(temperatureVulnerable.internalTemperatureWarning_Low), (object) GameUtil.GetFormattedTemperature(temperatureVulnerable.internalTemperatureWarning_High));
      });
      ...
      this.Wilting.resolveStringCallback = (Func<string, object, string>) ((str, data) =>
      {
        if (data is global::Growing && data != null)
          str = str.Replace("{TimeUntilNextHarvest}", GameUtil.GetFormattedCycles(Mathf.Min(((global::Growing) data).growthTime, ((global::Growing) data).TimeUntilNextHarvest())));
      ...
      this.Unrefrigerated.resolveStringCallback = (Func<string, object, string>) ((str, data) => str.Replace("{RotTemperature}", GameUtil.GetFormattedTemperature(277.15f)));
