...
namespace Database
{
  public class Attributes : ResourceSet<Attribute>
  {
    ...
    {
      this.Construction = this.Add(new Attribute(nameof (Construction), true, Attribute.Display.Skill, true));
      ...
      this.Digging = this.Add(new Attribute(nameof (Digging), true, Attribute.Display.Skill, true));
      ...
      this.Machinery = this.Add(new Attribute(nameof (Machinery), true, Attribute.Display.Skill, true));
      ...
      this.Athletics = this.Add(new Attribute(nameof (Athletics), true, Attribute.Display.Skill, true));
      ...
      this.Learning = this.Add(new Attribute(nameof (Learning), true, Attribute.Display.Skill, true));
      ...
      this.Cooking = this.Add(new Attribute(nameof (Cooking), true, Attribute.Display.Skill, true));
      ...
      this.Art = this.Add(new Attribute(nameof (Art), true, Attribute.Display.Skill, true));
      ...
      this.Strength = this.Add(new Attribute(nameof (Strength), true, Attribute.Display.Skill, true));
      ...
      this.Caring = this.Add(new Attribute(nameof (Caring), true, Attribute.Display.Skill, true));
      ...
      this.Botanist = this.Add(new Attribute(nameof (Botanist), true, Attribute.Display.Skill, true));
      ...
      this.Ranching = this.Add(new Attribute(nameof (Ranching), true, Attribute.Display.Skill, true));
      ...
      this.QualityOfLife = this.Add(new Attribute(nameof (QualityOfLife), false, Attribute.Display.Details, false, uiSprite: "ui_icon_qualityoflife", thoughtSprite: "attribute_qualityoflife"));
      this.QualityOfLife.SetFormatter((IAttributeFormatter) new QualityOfLifeAttributeFormatter());
      this.GermResistance = this.Add(new Attribute(nameof (GermResistance), false, Attribute.Display.Details, false, uiSprite: "ui_icon_immunelevel", thoughtSprite: "attribute_immunelevel"));
