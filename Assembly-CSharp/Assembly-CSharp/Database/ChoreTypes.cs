...
namespace Database
{
  public class ChoreTypes : ResourceSet<ChoreType>
  {
      ...
      : base(nameof (ChoreTypes), parent)
    {
      ...
      this.JoyReaction = this.Add(nameof (JoyReaction), new string[0], "", new string[0], (string) DUPLICANTS.CHORES.JOYREACTION.NAME, (string) DUPLICANTS.CHORES.JOYREACTION.STATUS, (string) DUPLICANTS.CHORES.JOYREACTION.TOOLTIP, false, 5000);
      ...
      this.Relax = this.Add(nameof (Relax), new string[0], "", new string[1]
      {
        nameof (Sleep)
      }, (string) DUPLICANTS.CHORES.RELAX.NAME, (string) DUPLICANTS.CHORES.RELAX.STATUS, (string) DUPLICANTS.CHORES.RELAX.TOOLTIP, false);
      ...
      this.RanchingFetch = this.Add(nameof (RanchingFetch), new string[1]
      {
        "Ranching"
      ...
      ChoreType[][] choreTypeArray1 = new ChoreType[30][]
      {
