...
public class WorkChore<WorkableType> : Chore<WorkChore<WorkableType>.StatesInstance> where WorkableType : Workable
{
    ...
    bool add_to_daily_report = true)
  {
    ...
    int num2 = (int) priority_class;
    int master_priority_value = priority_class_value;
    int num3 = flag1 ? 1 : 0;
    int num4 = flag2 ? 1 : 0;
    int num5 = add_to_daily_report ? 1 : 0;
    // ISSUE: explicit constructor call
    base.\u002Ector(chore_type1, target1, chore_provider1, num1 != 0, on_complete1, on_begin1, on_end1, (PriorityScreen.PriorityClass) num2, master_priority_value, num3 != 0, num4 != 0, add_to_daily_report: (num5 != 0));
  ...
  public class States : GameStateMachine<WorkChore<WorkableType>.States, WorkChore<WorkableType>.StatesInstance, WorkChore<WorkableType>>
  {
    ...
    public override void InitializeStates(out StateMachine.BaseState default_state)
    {
      ...
      this.approach.InitializeStates(this.worker, this.workable, this.work).Update("CheckOperational", (System.Action<WorkChore<WorkableType>.StatesInstance, float>) ((smi, dt) =>
      {
