...
public class GameScenePartitioner : KMonoBehaviour
{
  ...
  public void AddGlobalLayerListener(ScenePartitionerLayer layer, System.Action<int, object> action) => layer.OnEvent += action;

  public void RemoveGlobalLayerListener(ScenePartitionerLayer layer, System.Action<int, object> action) => layer.OnEvent -= action;
