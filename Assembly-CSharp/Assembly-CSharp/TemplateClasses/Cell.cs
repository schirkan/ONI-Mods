...
namespace TemplateClasses
{
  ...
  public class Cell : ICloneable
  {
    ...
    public object Clone() => (object) new Cell(this.location_x, this.location_y, this.element, this.temperature, this.mass, this.diseaseName, this.diseaseCount, this.preventFoWReveal);
