...
public class GameNavGrids
{
  ...
  private void CreateDuplicantNavigation(Pathfinding pathfinding)
  {
    ...
    this.DuplicantGrid = new NavGrid("MinionNavGrid", this.MirrorTransitions(new NavGrid.Transition[108]
    {
      ...
      new NavGrid.Transition(NavType.Floor, NavType.Floor, 2, 1, NavAxis.NA, false, false, true, 10, "", new CellOffset[2]
      {
        new CellOffset(1, 0),
        new CellOffset(1, 1)
      ...
      new NavGrid.Transition(NavType.Floor, NavType.Floor, 2, -1, NavAxis.NA, false, false, false, 10, "", new CellOffset[2]
      {
        new CellOffset(1, 0),
        new CellOffset(1, 1)
      }, new CellOffset[0], new NavOffset[0], new NavOffset[6]
  ...
  public class SwimValidator : NavTableValidator
  {
    ...
    {
      bool is_valid = Grid.IsSubstantialLiquid(cell) && this.IsClear(cell, bounding_offsets, false);
  ...
  public class FloorValidator : NavTableValidator
  {
    ...
    public static bool IsWalkableCell(int cell, int anchor_cell, bool is_dupe)
    {
      ...
      if (Grid.FakeFloor[anchor_cell])
        return true;
      return Grid.Solid[anchor_cell] ? !Grid.DupePassable[anchor_cell] : is_dupe && (Grid.NavValidatorMasks[cell] & (Grid.NavValidatorFlags.Ladder | Grid.NavValidatorFlags.Pole)) == (Grid.NavValidatorFlags) 0 && (uint) (Grid.NavValidatorMasks[anchor_cell] & (Grid.NavValidatorFlags.Ladder | Grid.NavValidatorFlags.Pole)) > 0U;
    }
  ...
  {
    public WallValidator() => World.Instance.OnSolidChanged += new System.Action<int>(this.OnSolidChanged);
    ...
    private static bool IsWalkableCell(int cell, int anchor_cell) => Grid.IsValidCell(cell) && Grid.IsValidCell(anchor_cell) && NavTableValidator.IsCellPassable(cell, false) && (Grid.Solid[anchor_cell] || Grid.CritterImpassable[anchor_cell]);
    ...
    public override void Clear() => World.Instance.OnSolidChanged -= new System.Action<int>(this.OnSolidChanged);
  }

  public class CeilingValidator : NavTableValidator
  {
    public CeilingValidator() => World.Instance.OnSolidChanged += new System.Action<int>(this.OnSolidChanged);
    ...
    private static bool IsWalkableCell(int cell, int anchor_cell) => Grid.IsValidCell(cell) && Grid.IsValidCell(anchor_cell) && NavTableValidator.IsCellPassable(cell, false) && (Grid.Solid[anchor_cell] || (!Grid.HasDoor[cell] || Grid.FakeFloor[cell]) && (Grid.FakeFloor[anchor_cell] || Grid.HasDoor[anchor_cell]));
  ...
  {
    public LadderValidator() => Components.Ladders.Register(new System.Action<Ladder>(this.OnAddLadder), new System.Action<Ladder>(this.OnRemoveLadder));
    ...
    public override void Clear() => Components.Ladders.Unregister(new System.Action<Ladder>(this.OnAddLadder), new System.Action<Ladder>(this.OnRemoveLadder));
  }
  ...
  {
    public TubeValidator() => Components.ITravelTubePieces.Register(new System.Action<ITravelTubePiece>(this.OnAddLadder), new System.Action<ITravelTubePiece>(this.OnRemoveLadder));
    ...
    public override void Clear() => Components.ITravelTubePieces.Unregister(new System.Action<ITravelTubePiece>(this.OnAddLadder), new System.Action<ITravelTubePiece>(this.OnRemoveLadder));
  }
  ...
  {
    public SolidValidator() => World.Instance.OnSolidChanged += new System.Action<int>(this.OnSolidChanged);
