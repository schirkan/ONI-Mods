...
public class Storage : Workable, ISaveLoadableDetails, IGameObjectEffectDescriptor
{
  ...
  {
    new Storage.StoredItemModifierInfo(Storage.StoredItemModifier.Hide, new System.Action<GameObject, bool, bool>(Storage.MakeItemInvisible)),
    new Storage.StoredItemModifierInfo(Storage.StoredItemModifier.Insulate, new System.Action<GameObject, bool, bool>(Storage.MakeItemTemperatureInsulated)),
    new Storage.StoredItemModifierInfo(Storage.StoredItemModifier.Seal, new System.Action<GameObject, bool, bool>(Storage.MakeItemSealed)),
    new Storage.StoredItemModifierInfo(Storage.StoredItemModifier.Preserve, new System.Action<GameObject, bool, bool>(Storage.MakeItemPreserved))
  };
  [SerializeField]
  ...
  private static readonly EventSystem.IntraObjectHandler<Storage> OnDeadTagChangedDelegate = GameUtil.CreateHasTagHandler<Storage>(GameTags.Dead, (System.Action<Storage, object>) ((component, data) => component.OnDeath(data)));
  private static readonly EventSystem.IntraObjectHandler<Storage> OnQueueDestroyObjectDelegate = new EventSystem.IntraObjectHandler<Storage>((System.Action<Storage, object>) ((component, data) => component.OnQueueDestroyObject(data)));
  private static readonly EventSystem.IntraObjectHandler<Storage> OnCopySettingsDelegate = new EventSystem.IntraObjectHandler<Storage>((System.Action<Storage, object>) ((component, data) => component.OnCopySettings(data)));
  ...
  public PrioritySetting masterPriority => (bool) (UnityEngine.Object) this.prioritizable ? this.prioritizable.GetMasterPriority() : Chore.DefaultPrioritySetting;
    ...
    bool is_deserializing = false)
  {
    ...
    if (!hide_popups && (UnityEngine.Object) PopFXManager.Instance != (UnityEngine.Object) null)
    {
      ...
      string text = Assets.IsTagCountable(go.PrefabID()) ? string.Format((string) locString, (object) (int) component.TotalAmount, (object) go.GetProperName()) : string.Format((string) locString, (object) GameUtil.GetFormattedMass(component.TotalAmount), (object) go.GetProperName());
  ...
  public void DropUnlessHasTags(
    TagBits any_tags,
    TagBits required_tags,
    TagBits forbidden_tags,
    bool do_disease_transfer = true)
  {
  ...
  public void ConsumeIgnoringDisease(Tag tag, float amount) => this.ConsumeAndGetDisease(tag, amount, out SimUtil.DiseaseInfo _, out float _);
  ...
  public GameObject Drop(int ID) => this.Drop(this.Find(ID));

  private void OnDeath(object data) => this.DropAll(true, true);
