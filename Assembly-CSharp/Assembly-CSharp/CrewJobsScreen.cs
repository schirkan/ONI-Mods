...
public class CrewJobsScreen : CrewListScreen<CrewJobsEntry>
{
  ...
  private void SetJobEveryone(UnityEngine.UI.Button button, ChoreGroup chore_group) => this.SetJobEveryone(this.EveryoneToggles[button] != CrewJobsScreen.everyoneToggleState.on, chore_group);
