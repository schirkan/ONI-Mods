...
public class NameDisplayScreen : KScreen
{
  ...
  private void OnHealthAdded(Health health) => this.RegisterComponent(health.gameObject, (object) health);
  ...
  private bool ShouldShowName(GameObject representedObject) => (UnityEngine.Object) representedObject.GetComponent<MinionBrain>() != (UnityEngine.Object) null || (UnityEngine.Object) representedObject.GetComponent<CommandModule>() != (UnityEngine.Object) null || (bool) (UnityEngine.Object) representedObject.GetComponent<SweepBotStation>() || (UnityEngine.Object) representedObject.GetComponent<UserNameable>() != (UnityEngine.Object) null;
  ...
  public void AddNewEntry(GameObject representedObject)
  {
    ...
    GameObject gameObject = Util.KInstantiateUI(this.ShouldShowName(representedObject) ? this.nameAndBarsPrefab : this.barsPrefab, this.gameObject, true);
    ...
    while (index < count)
    {
      if ((UnityEngine.Object) this.entries[index].world_go != (UnityEngine.Object) null)
      {
        ...
        if (flag && CameraController.Instance.IsVisiblePos(pos))
        {
          ...
          Vector2 vector2 = (Vector2) (this.worldSpace ? pos : this.WorldToScreen(pos));
          component1.anchoredPosition = vector2;
  ...
  private NameDisplayScreen.Entry GetEntry(GameObject worldObject) => this.entries.Find((Predicate<NameDisplayScreen.Entry>) (entry => (UnityEngine.Object) entry.world_go == (UnityEngine.Object) worldObject));
