...
public class SaltPlant : StateMachineComponent<SaltPlant.StatesInstance>
{
  ...
  private void OnWilt(object data = null) => this.gameObject.GetComponent<ElementConsumer>().EnableConsumption(false);

  private void OnWiltRecover(object data = null) => this.gameObject.GetComponent<ElementConsumer>().EnableConsumption(true);
