...
public class IceCooledFan : StateMachineComponent<IceCooledFan.StatesInstance>
{
  ...
  public class States : GameStateMachine<IceCooledFan.States, IceCooledFan.StatesInstance, IceCooledFan>
  {
    ...
    public override void InitializeStates(out StateMachine.BaseState default_state)
    {
      ...
      })).Update("IceCooledFanCooling", (System.Action<IceCooledFan.StatesInstance, float>) ((smi, dt) => smi.master.DoCooling(dt))).Exit((StateMachine<IceCooledFan.States, IceCooledFan.StatesInstance, IceCooledFan, object>.State.Callback) (smi =>
      {
      ...
      this.unworkable.Update("IceFanUnworkableStatusItems", (System.Action<IceCooledFan.StatesInstance, float>) ((smi, dt) => smi.master.UpdateUnworkableStatusItems())).Transition(this.workable.waiting, (StateMachine<IceCooledFan.States, IceCooledFan.StatesInstance, IceCooledFan, object>.Transition.ConditionCallback) (smi => smi.IsWorkable())).Enter((StateMachine<IceCooledFan.States, IceCooledFan.StatesInstance, IceCooledFan, object>.State.Callback) (smi => smi.master.UpdateUnworkableStatusItems())).Exit((StateMachine<IceCooledFan.States, IceCooledFan.StatesInstance, IceCooledFan, object>.State.Callback) (smi => smi.master.UpdateUnworkableStatusItems()));
    }
