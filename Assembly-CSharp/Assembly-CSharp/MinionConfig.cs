...
public class MinionConfig : IEntityConfig
{
  ...
  public GameObject CreatePrefab()
  {
    ...
    entity.AddOrGet<KPrefabID>().AddTag(GameTags.DupeBrain);
  ...
  public static void AddMinionTraits(string name, Modifiers modifiers)
  {
    ...
    trait.Add(new AttributeModifier(Db.Get().Amounts.Stamina.deltaAttribute.Id, -0.1166667f, name));
    trait.Add(new AttributeModifier(Db.Get().Amounts.Calories.deltaAttribute.Id, -1666.667f, name));
    ...
    trait.Add(new AttributeModifier(Db.Get().Amounts.Bladder.deltaAttribute.Id, 0.1666667f, name));
