...
public class ManualGenerator : Workable, ISingleSliderControl, ISliderControl
{
  ...
  string ISliderControl.GetSliderTooltip() => string.Format((string) Strings.Get("STRINGS.UI.UISIDESCREENS.MANUALGENERATORSIDESCREEN.TOOLTIP"), (object) (float) ((double) this.batteryRefillPercent * 100.0));
