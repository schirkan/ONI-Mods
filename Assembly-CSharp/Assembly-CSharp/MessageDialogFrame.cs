...
public class MessageDialogFrame : KScreen
{
  ...
  public override float GetSortKey() => 9999f;
  ...
  protected override void OnDeactivate() => this.Unsubscribe(Messenger.Instance.gameObject, -599791736, new System.Action<object>(this.OnMessagesChanged));
  ...
  private void OnMessagesChanged(object data) => this.nextMessageButton.gameObject.SetActive((uint) Messenger.Instance.Count > 0U);
