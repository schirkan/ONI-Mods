    ...
    for (int index = 0; index < this.socializeOffsets.Length; ++index)
    {
      ...
      if ((num >= this.choreCount || !this.IsOffsetValid(socializeOffset) ? 0 : ((double) massAvailable >= 1.0 ? 1 : 0)) != 0)
      {
        ...
        if (chore == null || chore.isComplete)
          this.chores[index] = (Chore) new WaterCoolerChore((IStateMachineTarget) this, (Workable) this.workables[index], on_end: new System.Action<Chore>(this.OnChoreEnd));
      }
      else if (chore != null)
      {
