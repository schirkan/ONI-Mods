...
public class FallingWater : KMonoBehaviour, ISim200ms
{
    ...
    bool disable_randomness = false)
  {
    ...
    else
    {
      ...
      while ((double) base_mass > 0.0)
      {
        ...
        int disease_count = (int) (num2 * num3);
            ...
            switch (state)
            {
              ...
              case Element.State.Liquid:
                ...
                if (element2.id == element1.id)
                {
                  ...
                  this.SpawnLiquidSplash(physic.position.x, cell, particleProperty.elementIdx);
  ...
  private void AddToSim(int cell, int particleIdx, ref int num_particles)
  {
    ...
    SimMessages.AddRemoveSubstance(cell, (int) particleProperty.elementIdx, CellEventLogger.Instance.FallingWaterAddToSim, particleProperty.mass, particleProperty.temperature, particleProperty.diseaseIdx, particleProperty.diseaseCount);
