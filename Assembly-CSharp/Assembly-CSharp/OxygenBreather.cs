...
public class OxygenBreather : KMonoBehaviour, ISim200ms
{
  ...
  private static readonly EventSystem.IntraObjectHandler<OxygenBreather> OnDeadTagChangedDelegate = GameUtil.CreateHasTagHandler<OxygenBreather>(GameTags.Dead, (System.Action<OxygenBreather, object>) ((component, data) => component.OnDeath(data)));
  ...
  protected override void OnPrefabInit() => GameUtil.SubscribeToTags<OxygenBreather>(this, OxygenBreather.OnDeadTagChangedDelegate);
