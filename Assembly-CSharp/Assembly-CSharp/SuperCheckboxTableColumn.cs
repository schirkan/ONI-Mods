...
public class SuperCheckboxTableColumn : CheckboxTableColumn
{
  ...
  public SuperCheckboxTableColumn(
    ...
    : base(on_load_action, get_value_action, on_press_action, set_value_action, sort_comparison, on_tooltip, (System.Action<IAssignableIdentity, GameObject, ToolTip>) null)
  {
