...
public class SimulatedTemperatureAdjuster
{
  ...
  public static List<Descriptor> GetDescriptors(float temperature)
  {
    ...
    descriptorList.Add(new Descriptor(string.Format((string) UI.BUILDINGEFFECTS.ITEM_TEMPERATURE_ADJUST, (object) formattedTemperature), string.Format((string) UI.BUILDINGEFFECTS.TOOLTIPS.ITEM_TEMPERATURE_ADJUST, (object) formattedTemperature)));
  ...
  private void OnStorageChanged(object data)
  {
    ...
    if ((UnityEngine.Object) component2 == (UnityEngine.Object) null)
      return;
    if ((!this.operational ? 0 : ((UnityEngine.Object) component2.storage == (UnityEngine.Object) this.storage ? 1 : 0)) != 0)
