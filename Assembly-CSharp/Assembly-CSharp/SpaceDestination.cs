...
public class SpaceDestination
{
  ...
  public float GetCurrentOrbitPercentage()
  {
    ...
    return (float) ((double) GameClock.Instance.GetCycle() + (double) GameClock.Instance.GetCurrentCycleAsPercentage() + (double) this.startingOrbitPercentage * (double) num) % num / num;
  }
