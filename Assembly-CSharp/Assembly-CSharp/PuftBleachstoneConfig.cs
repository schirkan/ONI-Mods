...
public class PuftBleachstoneConfig : IEntityConfig
{
  ...
  public static GameObject CreatePuftBleachstone(
    ...
    bool is_baby)
  {
    GameObject wildCreature = EntityTemplates.ExtendEntityToWildCreature(BasePuftConfig.BasePuft(id, name, desc, "PuftBleachstoneBaseTrait", anim_file, is_baby, "anti_", 258.15f, 308.15f), PuftTuning.PEN_SIZE_PER_CREATURE, 75f);
