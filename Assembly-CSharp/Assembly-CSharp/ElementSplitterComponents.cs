...
public class ElementSplitterComponents : KGameObjectComponentManager<ElementSplitter>
{
  ...
  private static Pickupable OnTake(HandleVector<int>.Handle handle, float amount)
  {
    ...
    Pickupable component3 = component2.Element.substance.SpawnResource(component1.transform.GetPosition(), amount, component2.Temperature, byte.MaxValue, 0, true).GetComponent<Pickupable>();
