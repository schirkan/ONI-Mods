...
public class CommandModuleSideScreen : SideScreenContent
{
  ...
  private void ScheduleUpdate() => this.updateHandle = UIScheduler.Instance.Schedule("RefreshCommandModuleSideScreen", 1f, (System.Action<object>) (o =>
  {
    this.RefreshConditions();
    this.ScheduleUpdate();
  }), (object) null, (SchedulerGroup) null);

  public override bool IsValidForTarget(GameObject target) => (UnityEngine.Object) target.GetComponent<LaunchConditionManager>() != (UnityEngine.Object) null;
  ...
  public void RefreshConditions()
  {
    ...
    foreach (RocketLaunchCondition key in launchConditionList)
    {
      if (this.conditionTable.ContainsKey(key))
      {
        ...
        component.GetReference<LocText>("Label").color = ready ? Color.black : Color.red;
        component.GetReference<Image>("Box").color = ready ? Color.black : Color.red;
