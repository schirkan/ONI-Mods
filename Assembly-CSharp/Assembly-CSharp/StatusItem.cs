...
public class StatusItem : Resource
{
  ...
  private string ResolveString(string str, object data) => this.resolveStringCallback != null && data != null ? this.resolveStringCallback(str, data) : str;
  ...
  public bool UseConditionalCallback(HashedString overlay, Transform transform) => overlay != OverlayModes.None.ID && this.conditionalOverlayCallback != null && this.conditionalOverlayCallback(overlay, (object) transform);
