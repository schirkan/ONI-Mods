...
public class MinionResume : KMonoBehaviour, ISaveLoadable, ISim200ms
{
  ...
  public int AvailableSkillpoints => this.TotalSkillPointsGained - this.SkillsMastered;
  ...
  public bool HasSkillAptitude(Skill skill) => this.AptitudeBySkillGroup.ContainsKey((HashedString) skill.skillGroup) && (double) this.AptitudeBySkillGroup[(HashedString) skill.skillGroup] > 0.0;
  ...
  public void MasterSkill(string skillId)
  {
    ...
    GameScheduler.Instance.Schedule("Morale Tutorial", 2f, (System.Action<object>) (obj => Tutorial.Instance.TutorialMessage(Tutorial.TutorialMessages.TM_Morale)), (object) null, (SchedulerGroup) null);
  ...
  private void OnSkillPointGained()
  {
    ...
    {
      this.lastSkillNotification = new Notification((string) MISC.NOTIFICATIONS.SKILL_POINT_EARNED.NAME, NotificationType.Good, HashedString.Invalid, new Func<List<Notification>, object, string>(this.GetSkillPointGainedTooltip), custom_click_callback: ((Notification.ClickCallback) (d => ManagementMenu.Instance.OpenSkills(this.identity))));
    ...
    if ((UnityEngine.Object) PopFXManager.Instance != (UnityEngine.Object) null)
      PopFXManager.Instance.SpawnFX(PopFXManager.Instance.sprite_Plus, (string) MISC.NOTIFICATIONS.SKILL_POINT_EARNED.NAME, this.transform, new Vector3(0.0f, 0.5f, 0.0f));
  ...
  private string GetSkillPointGainedTooltip(List<Notification> notifications, object data) => string.Format((string) MISC.NOTIFICATIONS.SKILL_POINT_EARNED.TOOLTIP, (object[]) Array.Empty<object>());
  ...
  public void RemoveHat() => MinionResume.RemoveHat(this.GetComponent<KBatchedAnimController>());
