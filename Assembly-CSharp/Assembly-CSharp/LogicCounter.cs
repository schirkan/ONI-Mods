...
public class LogicCounter : Switch, ISaveLoadable
{
  ...
  private static readonly EventSystem.IntraObjectHandler<LogicCounter> OnCopySettingsDelegate = new EventSystem.IntraObjectHandler<LogicCounter>((System.Action<LogicCounter, object>) ((component, data) => component.OnCopySettings(data)));
  private static readonly EventSystem.IntraObjectHandler<LogicCounter> OnLogicValueChangedDelegate = new EventSystem.IntraObjectHandler<LogicCounter>((System.Action<LogicCounter, object>) ((component, data) => component.OnLogicValueChanged(data)));
  ...
  protected override void OnCleanUp() => Game.Instance.logicCircuitManager.onLogicTick -= new System.Action(this.LogicTick);
