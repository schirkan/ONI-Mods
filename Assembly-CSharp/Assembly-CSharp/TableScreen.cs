...
public class TableScreen : KScreen
{
  ...
  protected void StartScrollableContent(string scrollablePanelID)
  {
    if (this.column_scrollers.Contains(scrollablePanelID))
      return;
    DividerColumn dividerColumn = new DividerColumn((Func<bool>) (() => true));
    ...
    bool double_click_to_target = true)
  {
    ...
    return this.RegisterColumn(id, (TableColumn) portraitTableColumn) ? portraitTableColumn : (PortraitTableColumn) null;
  }
    ...
    bool whiteText = false)
  {
    ...
    return this.RegisterColumn(id, (TableColumn) buttonLabelColumn) ? buttonLabelColumn : (ButtonLabelColumn) null;
  }
    ...
    bool should_refresh_columns = false)
  {
    ...
    return this.RegisterColumn(id, (TableColumn) labelTableColumn) ? labelTableColumn : (LabelTableColumn) null;
  }
    ...
    System.Action<IAssignableIdentity, GameObject, ToolTip> on_sort_tooltip)
  {
    ...
    return this.RegisterColumn(id, (TableColumn) checkboxTableColumn) ? checkboxTableColumn : (CheckboxTableColumn) null;
  }
    ...
    System.Action<IAssignableIdentity, GameObject, ToolTip> on_tooltip)
  {
    ...
    if (this.RegisterColumn(id, (TableColumn) checkboxTableColumn1))
    {
      ...
      checkboxTableColumn1.MarkDirty();
  ...
  {
    NumericDropDownTableColumn dropDownTableColumn = new NumericDropDownTableColumn(user_data, options, on_load_action, set_value_action, sort_comparison, tooltip_callbacks);
    return this.RegisterColumn(id, (TableColumn) dropDownTableColumn) ? dropDownTableColumn : (NumericDropDownTableColumn) null;
  }
