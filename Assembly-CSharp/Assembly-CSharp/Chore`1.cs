...
public class Chore<StateMachineInstanceType> : Chore, IStateMachineTarget where StateMachineInstanceType : StateMachine.Instance
{
  ...
  public int Subscribe(int hash, System.Action<object> handler) => this.GetComponent<KPrefabID>().Subscribe(hash, handler);

  public void Unsubscribe(int hash, System.Action<object> handler) => this.GetComponent<KPrefabID>().Unsubscribe(hash, handler);

  public void Unsubscribe(int id) => this.GetComponent<KPrefabID>().Unsubscribe(id);

  public void Trigger(int hash, object data = null) => this.GetComponent<KPrefabID>().Trigger(hash, data);
