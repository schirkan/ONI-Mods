...
public class ModifierSet : ScriptableObject
{
  ...
  public static float ConvertValue(float value, Units units) => Units.PerDay == units ? value * (1f / 600f) : value;
  ...
  private void LoadEffects()
  {
    ...
    Effect resource2 = new Effect("EggSong", (string) STRINGS.CREATURES.MODIFIERS.INCUBATOR_SONG.NAME, (string) STRINGS.CREATURES.MODIFIERS.INCUBATOR_SONG.TOOLTIP, 600f, true, false, false);
    resource2.Add(new AttributeModifier(Db.Get().Amounts.Incubation.deltaAttribute.Id, 4f, (string) STRINGS.CREATURES.MODIFIERS.INCUBATOR_SONG.NAME, true));
  ...
  protected void LoadTraits() => TUNING.TRAITS.TRAIT_CREATORS.ForEach((System.Action<System.Action>) (action => action()));

  protected void LoadFertilityModifiers() => TUNING.CREATURES.EGG_CHANCE_MODIFIERS.MODIFIER_CREATORS.ForEach((System.Action<System.Action>) (action => action()));
