...
public class InfectedFoodDiagram : MonoBehaviour
{
  ...
  private void Update()
  {
    ...
    if ((UnityEngine.Object) WorldInventory.Instance != (UnityEngine.Object) null)
    {
      ...
      if (pickupables == null)
        return;
      foreach (Component component1 in (IEnumerable<Pickupable>) pickupables)
      {
  ...
  private class FoodBit
  {
    ...
    public float DiseasePerRation => (float) this.disease / this.rations;

    public override string ToString() => string.Format("{0}: {1:0.##} (x{2:0.##} = {3})", (object) this.name, (object) this.DiseasePerRation, (object) this.rations, (object) this.disease);
  }
}
