...
public static class Sim
{
    ...
    switch ((Sim.GameHandledMessages) message_id)
    {
      ...
      case Sim.GameHandledMessages.ReportMessage:
        ...
        if (reportMessageMessagePtr->callstack != IntPtr.Zero)
          ...
          str = Marshal.PtrToStringAnsi(reportMessageMessagePtr->file) + ":" + (object) reportMessageMessagePtr->line;
  ...
  public struct Element
  {
    ...
    public Element(global::Element e, List<global::Element> elements)
    {
      ...
      this.lowTempTransitionIdx = index1 >= 0 ? (byte) index1 : byte.MaxValue;
      this.highTempTransitionIdx = index2 >= 0 ? (byte) index2 : byte.MaxValue;
