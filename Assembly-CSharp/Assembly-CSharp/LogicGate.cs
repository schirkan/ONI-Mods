...
public class LogicGate : LogicGateBase, ILogicEventSender, ILogicNetworkConnection
{
  ...
  protected override void OnSpawn()
  {
    ...
    if (this.RequiresFourOutputs)
    {
      ...
      this.outputTwoSender = new LogicEventSender(LogicGateBase.OUTPUT_TWO_PORT_ID, this.OutputCellTwo, (System.Action<int>) (new_value =>
      {
      ...
      this.outputThreeSender = new LogicEventSender(LogicGateBase.OUTPUT_THREE_PORT_ID, this.OutputCellThree, (System.Action<int>) (new_value =>
      {
        if (!((UnityEngine.Object) this != (UnityEngine.Object) null))
          return;
        this.OnAdditionalOutputsLogicValueChanged(LogicGateBase.OUTPUT_THREE_PORT_ID, new_value);
      }), (System.Action<int, bool>) null, LogicPortSpriteType.Output);
      this.outputFourSender = new LogicEventSender(LogicGateBase.OUTPUT_FOUR_PORT_ID, this.OutputCellFour, (System.Action<int>) (new_value =>
      {
        if (!((UnityEngine.Object) this != (UnityEngine.Object) null))
          return;
  ...
  protected void RefreshAnimation()
  {
    ...
    else if (this.op == LogicGateBase.Op.Demultiplexer)
    {
      ...
      LogicCircuitNetwork networkForCell1 = Game.Instance.logicCircuitSystem.GetNetworkForCell(this.inputOne.GetLogicCell()) as LogicCircuitNetwork;
      for (int index2 = 0; index2 < LogicGate.demultiplexerSymbols.Length; ++index2)
      {
        ...
        bool showing = Array.IndexOf<KAnimHashedString>(demultiplexerSymbolPath, demultiplexerBloomSymbol) != -1 && networkForCell1 != null;
      ...
      this.ShowSymbolConditionally(networkForCell1 != null, this.inputOne.Value == 0, component, LogicGate.INPUT1_SYMBOL_BLM_RED, LogicGate.INPUT1_SYMBOL_BLM_GRN);
      ...
      for (int index2 = 0; index2 < LogicGate.demultiplexerOutputSymbols.Length; ++index2)
      {
        KAnimHashedString demultiplexerOutputSymbol = LogicGate.demultiplexerOutputSymbols[index2];
        bool flag = Array.IndexOf<KAnimHashedString>(demultiplexerSymbolPath, demultiplexerOutputSymbol) == -1 || this.inputOne.Value == 0;
        UtilityNetwork networkForCell2 = Game.Instance.logicCircuitSystem.GetNetworkForCell(numArray[index2]);
        this.TintSymbolConditionally(networkForCell1 != null && networkForCell2 != null, flag, component, demultiplexerOutputSymbol, this.inactiveTintColor, this.activeTintColor);
        this.ShowSymbolConditionally(networkForCell1 != null && networkForCell2 != null, flag, component, LogicGate.demultiplexerOutputRedSymbols[index2], LogicGate.demultiplexerOutputGreenSymbols[index2]);
      }
    }
