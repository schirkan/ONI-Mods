...
public static class SimMessages
{
    ...
    int cb_handle)
  {
    ...
    SimMessages.AddElementConsumerMessage* elementConsumerMessagePtr = stackalloc SimMessages.AddElementConsumerMessage[1];
  ...
  public static unsafe void SetElementConsumerData(int sim_handle, int cell, float consumptionRate)
  {
    if (!Sim.IsValidHandle(sim_handle))
      return;
    SimMessages.SetElementConsumerDataMessage* consumerDataMessagePtr = stackalloc SimMessages.SetElementConsumerDataMessage[1];
  ...
  public static unsafe void RemoveElementConsumer(int cb_handle, int sim_handle)
  {
    ...
    {
      SimMessages.RemoveElementConsumerMessage* elementConsumerMessagePtr = stackalloc SimMessages.RemoveElementConsumerMessage[1];
      elementConsumerMessagePtr->callbackIdx = cb_handle;
  ...
  public static unsafe void AddElementEmitter(
    ...
    int on_unblocked = -1)
  {
    SimMessages.AddElementEmitterMessage* elementEmitterMessagePtr = stackalloc SimMessages.AddElementEmitterMessage[1];
    ...
    int disease_count)
  {
    ...
    if (!Grid.IsValidCell(game_cell))
      return;
    int elementIndex = ElementLoader.GetElementIndex(element);
    SimMessages.ModifyElementEmitterMessage* elementEmitterMessagePtr = stackalloc SimMessages.ModifyElementEmitterMessage[1];
  ...
  public static unsafe void RemoveElementEmitter(int cb_handle, int sim_handle)
  {
    ...
    {
      SimMessages.RemoveElementEmitterMessage* elementEmitterMessagePtr = stackalloc SimMessages.RemoveElementEmitterMessage[1];
    ...
    int cb_handle)
  {
    ...
    if (!Grid.IsValidCell(gameCell) || (double) mass * (double) temperature <= 0.0)
      return;
    int elementIndex = ElementLoader.GetElementIndex(element);
    SimMessages.AddElementChunkMessage* elementChunkMessagePtr = stackalloc SimMessages.AddElementChunkMessage[1];
  ...
  public static unsafe void RemoveElementChunk(int sim_handle, int cb_handle)
  {
    ...
    {
      SimMessages.RemoveElementChunkMessage* elementChunkMessagePtr = stackalloc SimMessages.RemoveElementChunkMessage[1];
      elementChunkMessagePtr->callbackIdx = cb_handle;
    ...
    float heat_capacity)
  {
    if (!Sim.IsValidHandle(sim_handle))
      return;
    SimMessages.SetElementChunkDataMessage* chunkDataMessagePtr = stackalloc SimMessages.SetElementChunkDataMessage[1];
  ...
  public static unsafe void MoveElementChunk(int sim_handle, int cell)
  {
    ...
    {
      SimMessages.MoveElementChunkMessage* elementChunkMessagePtr = stackalloc SimMessages.MoveElementChunkMessage[1];
      elementChunkMessagePtr->handle = sim_handle;
  ...
  public static unsafe void ModifyElementChunkEnergy(int sim_handle, float delta_kj)
  {
    ...
    {
      SimMessages.ModifyElementChunkEnergyMessage* chunkEnergyMessagePtr = stackalloc SimMessages.ModifyElementChunkEnergyMessage[1];
    ...
    float thermal_conductivity)
  {
    ...
    {
      SimMessages.ModifyElementChunkAdjusterMessage* chunkAdjusterMessagePtr = stackalloc SimMessages.ModifyElementChunkAdjusterMessage[1];
    ...
    int callbackIdx = -1)
  {
    ...
    if (!Grid.IsValidCell(cell2))
      return;
    SimMessages.AddBuildingHeatExchangeMessage* heatExchangeMessagePtr = stackalloc SimMessages.AddBuildingHeatExchangeMessage[1];
    ...
    byte element_idx)
  {
    ...
    if (!Grid.IsValidCell(cell2))
      return;
    SimMessages.ModifyBuildingHeatExchangeMessage* heatExchangeMessagePtr = stackalloc SimMessages.ModifyBuildingHeatExchangeMessage[1];
  ...
  {
    SimMessages.RemoveBuildingHeatExchangeMessage* heatExchangeMessagePtr = stackalloc SimMessages.RemoveBuildingHeatExchangeMessage[1];
  ...
  {
    SimMessages.ModifyBuildingEnergyMessage* buildingEnergyMessagePtr = stackalloc SimMessages.ModifyBuildingEnergyMessage[1];
    Debug.Assert(Sim.IsValidHandle(sim_handle));
  ...
  {
    SimMessages.AddDiseaseEmitterMessage* diseaseEmitterMessagePtr = stackalloc SimMessages.AddDiseaseEmitterMessage[1];
  ...
  {
    Debug.Assert(Sim.IsValidHandle(sim_handle));
    SimMessages.ModifyDiseaseEmitterMessage* diseaseEmitterMessagePtr = stackalloc SimMessages.ModifyDiseaseEmitterMessage[1];
  ...
  {
    Debug.Assert(Sim.IsValidHandle(sim_handle));
    SimMessages.RemoveDiseaseEmitterMessage* diseaseEmitterMessagePtr = stackalloc SimMessages.RemoveDiseaseEmitterMessage[1];
    diseaseEmitterMessagePtr->handle = sim_handle;
  ...
  {
    SimMessages.SetSavedOptionsMessage* savedOptionsMessagePtr = stackalloc SimMessages.SetSavedOptionsMessage[1];
    if (zero_or_one == 0)
    {
      ref byte local = ref savedOptionsMessagePtr->clearBits;
      local = (byte) ((SimMessages.SimSavedOptions) local | option);
      savedOptionsMessagePtr->setBits = (byte) 0;
    }
    else
    {
      savedOptionsMessagePtr->clearBits = (byte) 0;
      ref byte local = ref savedOptionsMessagePtr->setBits;
      local = (byte) ((SimMessages.SimSavedOptions) local | option);
    }
    Sim.SIM_HandleMessage(1154135737, sizeof (SimMessages.SetSavedOptionsMessage), (byte*) savedOptionsMessagePtr);
  }
  ...
  public static unsafe void CreateSimElementsTable(List<Element> elements)
  {
    ...
    Debug.Assert(elements.Count < (int) byte.MaxValue, (object) "SimDLL internals assume there are fewer than 255 elements");
  ...
  public static unsafe void Dig(int gameCell, int callbackIdx = -1, bool skipEvent = false)
  {
    if (!Grid.IsValidCell(gameCell))
      return;
    SimMessages.DigMessage* digMessagePtr = stackalloc SimMessages.DigMessage[1];
    digMessagePtr->cellIdx = gameCell;
    digMessagePtr->callbackIdx = callbackIdx;
    digMessagePtr->skipEvent = skipEvent;
  ...
  public static unsafe void SetInsulation(int gameCell, float value)
  {
    if (!Grid.IsValidCell(gameCell))
      return;
    SimMessages.SetCellFloatValueMessage* floatValueMessagePtr = stackalloc SimMessages.SetCellFloatValueMessage[1];
  ...
  public static unsafe void SetCellProperties(int gameCell, byte properties)
  {
    if (!Grid.IsValidCell(gameCell))
      return;
    SimMessages.CellPropertiesMessage* propertiesMessagePtr = stackalloc SimMessages.CellPropertiesMessage[1];
    ...
    int callbackIdx = -1)
  {
    ...
    SimMessages.ModifyCellMessage* modifyCellMessagePtr = stackalloc SimMessages.ModifyCellMessage[1];
  ...
  {
    SimMessages.CellDiseaseModification* diseaseModificationPtr = stackalloc SimMessages.CellDiseaseModification[1];
    ...
    int callbackIdx = -1)
  {
    if (!Grid.IsValidCell(gameCell))
      return;
    int elementIndex = ElementLoader.GetElementIndex(element);
    SimMessages.MassConsumptionMessage* consumptionMessagePtr = stackalloc SimMessages.MassConsumptionMessage[1];
    ...
    int callbackIdx = -1)
  {
    if (!Grid.IsValidCell(gameCell))
      return;
    SimMessages.MassEmissionMessage* massEmissionMessagePtr = stackalloc SimMessages.MassEmissionMessage[1];
    ...
    int callback_idx)
  {
    if (!Grid.IsValidCell(game_cell))
      return;
    SimMessages.ConsumeDiseaseMessage* consumeDiseaseMessagePtr = stackalloc SimMessages.ConsumeDiseaseMessage[1];
    ...
    SimMessages.EnergySourceID id)
  {
    ...
    {
      SimMessages.ModifyCellEnergyMessage* cellEnergyMessagePtr = stackalloc SimMessages.ModifyCellEnergyMessage[1];
    ...
    SimHashes element = SimHashes.Vacuum)
  {
    if (element != SimHashes.Vacuum)
    {
      ...
      SimMessages.ModifyCell(gameCell, 0, temperature, mass, disease_idx, disease_count);
  }
  ...
  public static unsafe void CreateElementInteractions(SimMessages.ElementInteraction[] interactions)
  {
    ...
    {
      SimMessages.CreateElementInteractionsMsg* elementInteractionsMsgPtr = stackalloc SimMessages.CreateElementInteractionsMsg[1];
  ...
  public static unsafe void NewGameFrame(float elapsed_seconds, Vector2I min, Vector2I max)
  {
    ...
    Sim.NewGameFrame* newGameFramePtr = stackalloc Sim.NewGameFrame[1];
  ...
  {
    Sim.DebugProperties* debugPropertiesPtr = stackalloc Sim.DebugProperties[1];
    debugPropertiesPtr[0] = properties;
  ...
  {
    SimMessages.CellWorldZoneModification* zoneModificationPtr = stackalloc SimMessages.CellWorldZoneModification[1];
