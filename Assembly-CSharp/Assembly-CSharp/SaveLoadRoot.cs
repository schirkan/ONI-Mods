...
public class SaveLoadRoot : KMonoBehaviour
{
  ...
  private static void LoadInternal(GameObject gameObject, IReader reader)
  {
    ...
    KMonoBehaviour[] kmonoBehaviourArray = (UnityEngine.Object) gameObject != (UnityEngine.Object) null ? gameObject.GetComponents<KMonoBehaviour>() : (KMonoBehaviour[]) null;
    ...
    for (int index1 = 0; index1 < num1; ++index1)
    {
      ...
      else
      {
        ...
        if (kmonoBehaviourArray != null)
        {
          ...
          {
            System.Type type = kmonoBehaviourArray[index2].GetType();
            string str;
