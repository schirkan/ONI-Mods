...
public class Telepad : StateMachineComponent<Telepad.StatesInstance>
{
  ...
  protected override void OnPrefabInit()
  {
    ...
    if (!((UnityEngine.Object) GameUtil.GetTelepad() != (UnityEngine.Object) null))
      return;
    PopFXManager.Instance.SpawnFX(PopFXManager.Instance.sprite_Building, string.Format((string) BUILDINGS.PREFABS.HEADQUARTERSCOMPLETE.UNIQUE_POPTEXT, (object) this.GetProperName()), (Transform) null, this.transform.GetPosition());
  ...
  public class StatesInstance : GameStateMachine<Telepad.States, Telepad.StatesInstance, Telepad, object>.GameInstance
  {
    ...
    public bool IsColonyLost() => (UnityEngine.Object) GameFlowManager.Instance != (UnityEngine.Object) null && GameFlowManager.Instance.IsGameOver();
