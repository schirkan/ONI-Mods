...
public class WoundMonitor : GameStateMachine<WoundMonitor, WoundMonitor.Instance>
{
  ...
  public override void InitializeStates(out StateMachine.BaseState default_state)
  {
    ...
    this.healthy.EventTransition(GameHashes.HealthChanged, (GameStateMachine<WoundMonitor, WoundMonitor.Instance, IStateMachineTarget, object>.State) this.wounded, (StateMachine<WoundMonitor, WoundMonitor.Instance, IStateMachineTarget, object>.Transition.ConditionCallback) (smi => (uint) smi.health.State > 0U));
  ...
  public new class Instance : GameStateMachine<WoundMonitor, WoundMonitor.Instance, IStateMachineTarget, object>.GameInstance
  {
    ...
    private void PlayHitAnimation()
    {
      ...
      if (this.worker.GetComponent<Navigator>().CurrentNavType == NavType.Ladder)
        ...
        str2 = "hit_pole";
      kbatchedAnimController.Play((HashedString) str2);
      if (str1 == null)
        return;
      kbatchedAnimController.Queue((HashedString) str1, playMode);
    }
