...
public class AmbienceManager : KMonoBehaviour
{
  ...
  public class Layer : IComparable<AmbienceManager.Layer>
  {
    ...
    public void UpdateAverageTemperature() => this.averageTemperature /= (float) this.tileCount;
  ...
  public class Quadrant
  {
    ...
    public class SolidTimer
    {
      ...
      public SolidTimer() => this.solidTargetTime = Time.unscaledTime + UnityEngine.Random.value * AmbienceManager.Quadrant.SolidTimer.solidMinTime;
