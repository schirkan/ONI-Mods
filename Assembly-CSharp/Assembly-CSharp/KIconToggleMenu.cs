...
public class KIconToggleMenu : KScreen
{
  ...
  protected virtual void RefreshButtons()
  {
    ...
    if (this.toggleInfo == null)
      return;
    Transform transform1 = (UnityEngine.Object) this.toggleParent != (UnityEngine.Object) null ? this.toggleParent : this.transform;
    for (int index = 0; index < this.toggleInfo.Count; ++index)
    {
      ...
      if ((bool) (UnityEngine.Object) component1)
      {
        ...
        {
          component1.AddMultiStringTooltip(toggleInfo.tooltipHeader, (UnityEngine.Object) this.ToggleToolTipHeaderTextStyleSetting != (UnityEngine.Object) null ? (ScriptableObject) this.ToggleToolTipHeaderTextStyleSetting : (ScriptableObject) this.ToggleToolTipTextStyleSetting);
