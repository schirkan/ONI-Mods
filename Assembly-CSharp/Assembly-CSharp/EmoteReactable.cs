...
public class EmoteReactable : Reactable
{
    ...
    Navigator.ActiveTransition transition)
  {
    ...
    return !((UnityEngine.Object) component == (UnityEngine.Object) null) && component.IsMoving() && (component.CurrentNavType != NavType.Tube && component.CurrentNavType != NavType.Ladder) && component.CurrentNavType != NavType.Pole && (UnityEngine.Object) this.gameObject != (UnityEngine.Object) new_reactor;
  }
  ...
  private void NextStep(HashedString finishedAnim)
  {
    ...
    else
    {
      ...
      {
        this.kbac.Play(this.emoteSteps[this.currentStep].anim, this.emoteSteps[this.currentStep].mode);
