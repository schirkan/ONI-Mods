...
public class DebugBaseTemplateButton : KScreen
{
  ...
  public override float GetSortKey() => 10f;
      ...
      if (!_excludeEntities.Contains(buildingComplete.gameObject))
      {
        ...
        if (this.SaveAllBuildings || this.SelectedCells.Contains(Grid.PosToCell((KMonoBehaviour) buildingComplete)))
        {
          foreach (int placementCell in buildingComplete.PlacementCells)
          {
            ...
            _cells.Add(new TemplateClasses.Cell(x3 - x1, y3 - y1, Grid.Element[placementCell].id, Grid.Temperature[placementCell], Grid.Mass[placementCell], _diseaseName, Grid.DiseaseCount[placementCell]));
          }
          ...
          {
            float num5 = component5.IsSwitchedOn ? 1f : 0.0f;
          ...
          Prefab prefab = new Prefab(buildingComplete.PrefabID().Name, Prefab.Type.Building, x2, y2, _element1, _temperature, 0.0f, _disease1, _disease_count1, _rotation, templateAmountValueList1.ToArray(), templateAmountValueList2.ToArray());
          ...
          if ((UnityEngine.Object) component6 != (UnityEngine.Object) null)
          {
            foreach (GameObject go in component6.items)
            {
              ...
              if ((UnityEngine.Object) component7 != (UnityEngine.Object) null)
              {
                ...
                _disease2 = component7.DiseaseIdx != byte.MaxValue ? Db.Get().Diseases[(int) component7.DiseaseIdx].Id : (string) null;
        ...
        if (!_excludeEntities.Contains(pickupable.gameObject))
        {
          ...
          if ((this.SaveAllPickups || this.SelectedCells.Contains(cell)) && !(bool) (UnityEngine.Object) Components.Pickupables[idx].gameObject.GetComponent<MinionBrain>())
          {
            ...
            if ((UnityEngine.Object) pickupable.gameObject.GetComponent<ElementChunk>() != (UnityEngine.Object) null)
            {
              ...
              Prefab prefab = new Prefab(tag.Name, Prefab.Type.Ore, x2, y2, _element, _temperature, _units, _disease, _disease_count);
              _primaryElementOres.Add(prefab);
            }
            else
            {
              tag = pickupable.PrefabID();
              Prefab prefab = new Prefab(tag.Name, Prefab.Type.Pickupable, x2, y2, _element, _temperature, _units, _disease, _disease_count)
              {
    ...
    foreach (T component1 in component_collection)
    {
      if (!_excludeEntities.Contains(((object) component1 as KMonoBehaviour).gameObject) && ((object) component1 as KMonoBehaviour).gameObject.activeSelf)
      {
        ...
        if (this.SelectedCells.Contains(cell) && !(bool) (UnityEngine.Object) ((object) component1 as KMonoBehaviour).gameObject.GetComponent<MinionBrain>())
        {
          ...
          {
            Prefab prefab = new Prefab(((object) component1 as KMonoBehaviour).PrefabID().Name, Prefab.Type.Ore, x, y, _element, _temperature, _units, _disease, _disease_count, _amount_values: templateAmountValueList.ToArray());
            _primaryElementOres.Add(prefab);
            _excludeEntities.Add(((object) component1 as KMonoBehaviour).gameObject);
          }
          else
          {
            Prefab prefab = new Prefab(((object) component1 as KMonoBehaviour).PrefabID().Name, Prefab.Type.Other, x, y, _element, _temperature, _units, _disease, _disease_count, _amount_values: templateAmountValueList.ToArray());
