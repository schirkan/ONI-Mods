...
public class StatusItemRenderer
{
  ...
  private HashedString GetMode() => (UnityEngine.Object) OverlayScreen.Instance != (UnityEngine.Object) null ? OverlayScreen.Instance.mode : OverlayModes.None.ID;
      ...
      HashedString overlay)
    {
      ...
      if ((UnityEngine.Object) this.transform != (UnityEngine.Object) null)
      {
        ...
        if (this.dirty)
        {
          ...
          this.hasVisibleStatusItems = (uint) num1 > 0U;
