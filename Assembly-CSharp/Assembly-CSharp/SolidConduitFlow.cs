...
public class SolidConduitFlow : IConduitFlow
{
  ...
  public class SOAInfo
  {
      ...
      SolidConduitFlow.FlowDirection direction)
    {
      ...
      {
        case SolidConduitFlow.FlowDirection.Left:
          conduit = conduitConnection.left != -1 ? this.conduits[conduitConnection.left] : SolidConduitFlow.Conduit.Invalid();
          break;
        case SolidConduitFlow.FlowDirection.Right:
          conduit = conduitConnection.right != -1 ? this.conduits[conduitConnection.right] : SolidConduitFlow.Conduit.Invalid();
          break;
        case SolidConduitFlow.FlowDirection.Up:
          conduit = conduitConnection.up != -1 ? this.conduits[conduitConnection.up] : SolidConduitFlow.Conduit.Invalid();
          break;
        case SolidConduitFlow.FlowDirection.Down:
          conduit = conduitConnection.down != -1 ? this.conduits[conduitConnection.down] : SolidConduitFlow.Conduit.Invalid();
          break;
      }
      return conduit;
    }
