...
public class JobsTableScreen : TableScreen
{
  ...
  public override float GetSortKey() => 101f;
  ...
  protected override void OnActivate()
  {
    ...
    this.AddButtonLabelColumn("Names", new System.Action<IAssignableIdentity, GameObject>(this.ConfigureNameLabel), new Func<IAssignableIdentity, GameObject, string>(((TableScreen) this).get_value_name_label), (System.Action<GameObject>) (widget_go => this.GetWidgetRow(widget_go).SelectMinion()), (System.Action<GameObject>) (widget_go => this.GetWidgetRow(widget_go).SelectAndFocusMinion()), new Comparison<IAssignableIdentity>(((TableScreen) this).compare_rows_alphabetical), (System.Action<IAssignableIdentity, GameObject, ToolTip>) null, new System.Action<IAssignableIdentity, GameObject, ToolTip>(((TableScreen) this).on_tooltip_sort_alphabetically));
  ...
  private string GetUsageString() => GameUtil.ReplaceHotkeyString((string) STRINGS.UI.JOBSSCREEN.INCREASE_PRIORITY_TUTORIAL, Action.MouseLeft) + "\n" + GameUtil.ReplaceHotkeyString((string) STRINGS.UI.JOBSSCREEN.DECREASE_PRIORITY_TUTORIAL, Action.MouseRight);
  ...
  private void ChangeRowPriority(object widget_go_obj, int delta)
  {
    ...
    else
    {
      ...
      {
        if (tableColumn is PrioritizationGroupTableColumn groupTableColumn)
        {
  ...
  private void RefreshEffectListeners()
  {
    ...
    {
      MinionIdentity id = Components.LiveMinionIdentities[idx];
      Components.LiveMinionIdentities[idx].gameObject.Subscribe(540773776, (System.Action<object>) (new_role => this.MarkSingleMinionRowDirty(id)));
    }
  }
  ...
  public override void OnKeyDown(KButtonEvent e)
  {
    ...
    if (e.IsAction(Action.MouseRight))
    {
      ...
      this.GetMouseHoverInfo(out is_hovering_screen, out bool _);
