...
public class EntityThreatMonitor : GameStateMachine<EntityThreatMonitor, EntityThreatMonitor.Instance, IStateMachineTarget, EntityThreatMonitor.Def>
{
  ...
  public override void InitializeStates(out StateMachine.BaseState default_state)
  {
    ...
    this.threatened.ToggleBehaviour(GameTags.Creatures.Defend, (StateMachine<EntityThreatMonitor, EntityThreatMonitor.Instance, IStateMachineTarget, EntityThreatMonitor.Def>.Transition.ConditionCallback) (smi => (UnityEngine.Object) smi.MainThreat != (UnityEngine.Object) null), (System.Action<EntityThreatMonitor.Instance>) (smi => smi.GoTo((StateMachine.BaseState) this.safe))).Update("Threatened", new System.Action<EntityThreatMonitor.Instance, float>(EntityThreatMonitor.CritterUpdateThreats));
  }
  ...
  public new class Instance : GameStateMachine<EntityThreatMonitor, EntityThreatMonitor.Instance, IStateMachineTarget, EntityThreatMonitor.Def>.GameInstance
  {
    ...
    public void GoToThreatened() => this.smi.GoTo((StateMachine.BaseState) this.sm.threatened);
