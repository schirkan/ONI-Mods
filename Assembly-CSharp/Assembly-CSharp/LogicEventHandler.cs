...
internal class LogicEventHandler : ILogicEventReceiver, ILogicNetworkConnection, ILogicUIElement, IUniformGridObject
{
  ...
  private void TriggerAudio(int new_value)
  {
    ...
    int num2 = (int) instance2.setParameterValue("logic_volumeModifer", num1);
    int num3 = (int) instance2.setParameterValue("wireCount", (float) (networkForCell.WireCount % 24));
    int num4 = (int) instance2.setParameterValue("enabled", (float) new_value);
