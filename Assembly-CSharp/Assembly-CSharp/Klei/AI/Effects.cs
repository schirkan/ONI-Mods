...
namespace Klei.AI
{
  ...
  public class Effects : KMonoBehaviour, ISaveLoadable, ISim1000ms
  {
    ...
    public void Remove(Effect effect) => this.Remove(effect.Id);
    ...
    public void AddImmunity(Effect effect) => this.effectImmunites.Add(effect);

    public void RemoveImmunity(Effect effect) => this.effectImmunites.Remove(effect);
