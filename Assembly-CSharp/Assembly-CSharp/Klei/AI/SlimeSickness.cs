...
namespace Klei.AI
{
  public class SlimeSickness : Sickness
  {
      ...
      }, 2220f, "SlimeSicknessRecovery")
    {
      ...
      {
        new AttributeModifier("BreathDelta", -1.136364f, (string) DUPLICANTS.DISEASES.SLIMESICKNESS.NAME),
    ...
    public class SlimeLungComponent : Sickness.SicknessComponent
    {
      ...
      public class StatesInstance : GameStateMachine<SlimeSickness.SlimeLungComponent.States, SlimeSickness.SlimeLungComponent.StatesInstance, SicknessInstance, object>.GameInstance
      {
        ...
        public Reactable GetReactable() => (Reactable) new SelfEmoteReactable(this.master.gameObject, (HashedString) "SlimeLungCough", Db.Get().ChoreTypes.Cough, (HashedString) "anim_slimelungcough_kanim", min_reactor_time: 0.0f).AddStep(new EmoteReactable.EmoteStep()
        {
