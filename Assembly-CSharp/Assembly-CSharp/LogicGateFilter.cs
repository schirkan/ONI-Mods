...
public class LogicGateFilter : LogicGate, ISingleSliderControl, ISliderControl
{
  ...
  string ISliderControl.GetSliderTooltip() => string.Format((string) Strings.Get("STRINGS.UI.UISIDESCREENS.LOGIC_FILTER_SIDE_SCREEN.TOOLTIP"), (object) this.DelayAmount);
