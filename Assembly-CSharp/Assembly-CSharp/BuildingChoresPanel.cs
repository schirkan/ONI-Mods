...
public class BuildingChoresPanel : TargetScreen
{
    ...
    RectTransform parent)
  {
    ...
    {
      hierarchyReferences = Util.KInstantiateUI<HierarchyReferences>(this.chorePrefab, parent.gameObject);
    ...
    RectTransform parent)
  {
    ...
    {
      choresPanelDupeRow = Util.KInstantiateUI<BuildingChoresPanelDupeRow>(this.dupePrefab.gameObject, parent.gameObject);
