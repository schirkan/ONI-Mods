...
public class SteamTurbine : Generator
{
  ...
  protected override void OnSpawn()
  {
    ...
    this.simEmitCBHandle = Game.Instance.massEmitCallbackManager.Add(new System.Action<Sim.MassEmittedCallback, object>(SteamTurbine.OnSimEmittedCallback), (object) this, "SteamTurbineEmit");
  ...
  private void Pump(float dt)
  {
    ...
    {
      HandleVector<Game.ComplexCallbackInfo<Sim.MassConsumedCallback>>.Handle handle = Game.Instance.massConsumedCallbackManager.Add(new System.Action<Sim.MassConsumedCallback, object>(SteamTurbine.OnSimConsumeCallback), (object) this, "SteamTurbineConsume");
    ...
    if ((UnityEngine.Object) this.gasStorage != (UnityEngine.Object) null && this.gasStorage.items.Count > 0)
    {
      ...
      if ((UnityEngine.Object) first != (UnityEngine.Object) null)
      {
        ...
        if ((double) component.Mass > (double) num2)
        {
          ...
          this.liquidStorage.AddLiquid(this.destElem, mass, this.outputElementTemperature, component.DiseaseIdx, disease_count);
        }
      }
    }
  ...
  public class States : GameStateMachine<SteamTurbine.States, SteamTurbine.Instance, SteamTurbine>
  {
    ...
    public override void InitializeStates(out StateMachine.BaseState default_state)
    {
      ...
      this.root.Update("UpdateBlocked", (System.Action<SteamTurbine.Instance, float>) ((smi, dt) => smi.UpdateBlocked(dt)));
      ...
      this.operational.DefaultState(this.operational.active).EventTransition(GameHashes.OperationalChanged, this.inoperational, (StateMachine<SteamTurbine.States, SteamTurbine.Instance, SteamTurbine, object>.Transition.ConditionCallback) (smi => !smi.master.GetComponent<Operational>().IsOperational)).Update("UpdateOperational", (System.Action<SteamTurbine.Instance, float>) ((smi, dt) => smi.UpdateState(dt))).Exit((StateMachine<SteamTurbine.States, SteamTurbine.Instance, SteamTurbine, object>.State.Callback) (smi => smi.DisableStatusItems()));
      this.operational.idle.QueueAnim("on");
      this.operational.active.Update("UpdateActive", (System.Action<SteamTurbine.Instance, float>) ((smi, dt) => smi.master.Pump(dt))).ToggleStatusItem((Func<SteamTurbine.Instance, StatusItem>) (smi => SteamTurbine.activeStatusItem), (Func<SteamTurbine.Instance, object>) (smi => (object) smi.master)).Enter((StateMachine<SteamTurbine.States, SteamTurbine.Instance, SteamTurbine, object>.State.Callback) (smi =>
      {
