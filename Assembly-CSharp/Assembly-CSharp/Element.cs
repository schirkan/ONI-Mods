...
public class Element : IComparable<Element>
{
  ...
  public bool IsTemperatureInsulated => (uint) (this.state & Element.State.TemperatureInsulated) > 0U;
  ...
  public bool HasTag(Tag search_tag) => this.tag == search_tag || Array.IndexOf<Tag>(this.oreTags, search_tag) != -1;
