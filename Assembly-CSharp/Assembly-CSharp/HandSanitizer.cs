...
public class HandSanitizer : StateMachineComponent<HandSanitizer.SMInstance>, IGameObjectEffectDescriptor, IBasicBuilding
{
  ...
  public class States : GameStateMachine<HandSanitizer.States, HandSanitizer.SMInstance, HandSanitizer>
  {
    ...
    public override void InitializeStates(out StateMachine.BaseState default_state)
    {
      ...
      this.root.Update(new System.Action<HandSanitizer.SMInstance, float>(this.UpdateStatusItems));
      ...
      this.ready.occupied.PlayAnim("working_pre").QueueAnim("working_loop", true).WorkableStopTransition((Func<HandSanitizer.SMInstance, Workable>) (smi => (Workable) smi.GetComponent<HandSanitizer.Work>()), this.notready);
    }
  ...
  public class Work : Workable, IGameObjectEffectDescriptor
  {
    ...
    protected override void OnPrefabInit()
    {
      ...
      GameScheduler.Instance.Schedule("WaterFetchingTutorial", 2f, (System.Action<object>) (obj => Tutorial.Instance.TutorialMessage(Tutorial.TutorialMessages.TM_FetchingWater)), (object) null, (SchedulerGroup) null);
    }
    ...
    protected override bool OnWorkTick(Worker worker, float dt)
    {
      ...
      if (component1.outputElement != SimHashes.Vacuum)
      {
        ...
        component2.AddLiquid(component1.outputElement, num1, aggregate_temperature, finalDiseaseInfo.idx, finalDiseaseInfo.count);
      }
