...
public class BuildTool : DragTool
{
  ...
  protected override void OnActivateTool()
  {
    ...
    this.visualizer = GameUtil.KInstantiate(this.def.BuildingPreview, cursorPos, Grid.SceneLayer.Ore, gameLayer: LayerMask.NameToLayer("Place"));
    ...
    if ((Object) component1 != (Object) null)
    {
      ...
      component1.Offset = component1.Offset + this.def.placementPivot;
  ...
  private void TryBuild(int cell)
  {
    ...
    {
      if (this.def.IsValidBuildLocation(this.visualizer, posCbc, this.buildingOrientation) && this.def.IsValidPlaceLocation(this.visualizer, posCbc, this.buildingOrientation, out string _))
      {
    ...
    {
      gameObject = this.def.TryPlace(this.visualizer, posCbc, this.buildingOrientation, this.selectedElements);
      if ((Object) gameObject == (Object) null && this.def.ReplacementLayer != ObjectLayer.NumLayers)
      {
        ...
        if ((Object) replacementCandidate != (Object) null && !this.def.IsReplacementLayerOccupied(cell))
        {
          ...
          {
            gameObject = this.def.TryReplaceTile(this.visualizer, posCbc, this.buildingOrientation, this.selectedElements);
    ...
    if (this.def.MaterialsAvailable(this.selectedElements) || DebugHandler.InstantBuildMode)
    {
      ...
      if (this.placeSound != null)
      {
        ...
        Vector3 pos = posCbc;
        pos.z = 0.0f;
        EventInstance instance = SoundEvent.BeginOneShot(this.placeSound, pos);
