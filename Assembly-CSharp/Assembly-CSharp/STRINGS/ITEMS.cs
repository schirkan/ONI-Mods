  ...
  public class ITEMS
  {
    ...
    public class FOOD
    {
      ...
      public class COOKEDFISH
      {
        ...
        public static LocString DESC = (LocString) ("The cooked " + UI.FormatAsLink("Fillet", "FISHMEAT") + " of a freshly caught " + (string) CREATURES.SPECIES.PACU.NAME + ".\n\nUnsurprisingly, it tastes a bit fishy.");
        public static LocString RECIPEDESC = (LocString) ("The cooked " + UI.FormatAsLink("Fillet", "FISHMEAT") + " of a freshly caught " + (string) CREATURES.SPECIES.PACU.NAME + ".");
      }
