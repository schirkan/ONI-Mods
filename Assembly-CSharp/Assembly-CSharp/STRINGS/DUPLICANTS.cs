  ...
  public class DUPLICANTS
  {
    ...
    public class CHORES
    {
      ...
      public class UGLY_CRY
      {
        ...
        public static LocString TOOLTIP = (LocString) "This Duplicant is having a healthy cry to alleviate their negative emotions";
      }
      ...
      public class DECONSTRUCT
      {
        ...
        public static LocString TOOLTIP = (LocString) "This Duplicant is demolishing a building";
      }
      ...
      public class JOYREACTION
      {
        ...
        public static LocString TOOLTIP = (LocString) ("This Duplicant is doing something because they are " + UI.PRE_KEYWORD + "Overjoyed" + UI.PST_KEYWORD);
      ...
      public class RANCH
      {
        ...
        public static LocString TOOLTIP = (LocString) ("This Duplicant is tending to a " + UI.PRE_KEYWORD + "Critter" + UI.PST_KEYWORD + "'s wellbeing");
        public static LocString REPORT_NAME = (LocString) "Deliver to {0}";
      }
    ...
    public class STATUSITEMS
    {
      ...
      public class ROLE
      {
        ...
        public static LocString TOOLTIP = (LocString) ("This Duplicant is working as a <b>{Role}</b>" + UI.HORIZONTAL_BR_RULE + "They have <b>{Progress}</b> mastery of this job");
      }
      ...
      public class INCAPACITATED
      {
        ...
        public static LocString TOOLTIP = (LocString) ("This Duplicant is near death!" + UI.HORIZONTAL_BR_RULE + "Assign them to a Triage Cot for rescue");
      ...
      public class RATIONSNOTPERMITTED
      {
        ...
        public static LocString TOOLTIP = (LocString) ("This Duplicant is not allowed to eat any of the " + UI.FormatAsLink("Food", "FOOD") + " in their reach" + UI.HORIZONTAL_BR_RULE + "Enter the <color=#833A5FFF>CONSUMABLES</color> <color=#F44A47><b>[F]</b></color> to adjust their food permissions");
      ...
      public class STRESS_SIGNAL_AGGRESIVE
      {
        ...
        public static LocString TOOLTIP = (LocString) ("This Duplicant is trying to keep their cool" + UI.HORIZONTAL_BR_RULE + "Improve this Duplicant's " + UI.PRE_KEYWORD + "Morale" + UI.PST_KEYWORD + " before they destroy something to let off steam");
      }

      public class STRESS_SIGNAL_BINGE_EAT
      {
        public static LocString NAME = (LocString) "Stress Cravings";
        public static LocString TOOLTIP = (LocString) ("This Duplicant is consumed by hunger" + UI.HORIZONTAL_BR_RULE + "Improve this Duplicant's " + UI.PRE_KEYWORD + "Morale" + UI.PST_KEYWORD + " before they eat all the colony's " + UI.PRE_KEYWORD + "Food" + UI.PST_KEYWORD + " stores");
      }

      public class STRESS_SIGNAL_UGLY_CRIER
      {
        public static LocString NAME = (LocString) "Misty Eyed";
        public static LocString TOOLTIP = (LocString) ("This Duplicant is trying and failing to swallow their emotions" + UI.HORIZONTAL_BR_RULE + "Improve this Duplicant's " + UI.PRE_KEYWORD + "Morale" + UI.PST_KEYWORD + " before they have a good ugly cry");
      }

      public class STRESS_SIGNAL_VOMITER
      {
        public static LocString NAME = (LocString) "Stress Burp";
        public static LocString TOOLTIP = (LocString) ("Sort of like having butterflies in your stomach, except they're burps" + UI.HORIZONTAL_BR_RULE + "Improve this Duplicant's " + UI.PRE_KEYWORD + "Morale" + UI.PST_KEYWORD + " before they start to stress vomit");
      }
      ...
      public class FLEEING
      {
        ...
        public static LocString TOOLTIP = (LocString) "This Duplicant is trying to escape combat!";
        public static LocString NOTIFICATION_NAME = (LocString) "Fleeing!";
        public static LocString NOTIFICATION_TOOLTIP = (LocString) "These Duplicants are trying to escape combat:";
      }
      ...
      public class NOROLE
      {
        ...
        public static LocString TOOLTIP = (LocString) ("This Duplicant does not have a Job Assignment" + UI.HORIZONTAL_BR_RULE + "Enter the " + UI.FormatAsManagementMenu("Jobs Panel", "[J]") + " to view all available Jobs");
      }
      ...
      public class NOTOILETS
      {
        ...
        public static LocString TOOLTIP = (LocString) ("There are no " + UI.FormatAsLink("Outhouses", "OUTHOUSE") + " available for this Duplicant" + UI.HORIZONTAL_BR_RULE + UI.FormatAsLink("Outhouses", "OUTHOUSE") + " can be built from the " + UI.FormatAsBuildMenuTab("Plumbing Tab", "[5]"));
        public static LocString NOTIFICATION_NAME = (LocString) "No Outhouses built";
        public static LocString NOTIFICATION_TOOLTIP = (LocString) (UI.FormatAsLink("Outhouses", "OUTHOUSE") + " can be built from the " + UI.FormatAsBuildMenuTab("Plumbing Tab", "[5]") + "." + UI.HORIZONTAL_BR_RULE + "These Duplicants are in need of an " + UI.FormatAsLink("Outhouse", "OUTHOUSE") + ":");
      }
      ...
      public class STRESSFULLYEMPTYINGBLADDER
      {
        ...
        public static LocString TOOLTIP = (LocString) ("This poor Duplicant couldn't find an " + UI.FormatAsLink("Outhouse", "OUTHOUSE") + " in time and is super embarrassed" + UI.HORIZONTAL_BR_RULE + UI.FormatAsLink("Outhouses", "OUTHOUSE") + " can be built from the " + UI.FormatAsBuildMenuTab("Plumbing Tab", "[5]"));
        public static LocString NOTIFICATION_NAME = (LocString) "Made a mess";
        public static LocString NOTIFICATION_TOOLTIP = (LocString) ("The " + UI.FormatAsTool("Mop Tool", "[M]") + " can be used to clean up Duplicant-related \"spills\"" + UI.HORIZONTAL_BR_RULE + "These Duplicants made messes that require cleaning up:\n");
      }
      ...
      public class VOMITING
      {
        ...
        public static LocString TOOLTIP = (LocString) ("This Duplicant has unceremoniously hurled as the result of a " + UI.FormatAsLink("Disease", "DISEASE") + UI.HORIZONTAL_BR_RULE + "Duplicant-related \"spills\" can be cleaned up using the " + UI.PRE_KEYWORD + "Mop Tool" + UI.PST_KEYWORD + " " + UI.FormatAsHotkey("[M]"));
        public static LocString NOTIFICATION_NAME = (LocString) "Throwing up";
        public static LocString NOTIFICATION_TOOLTIP = (LocString) ("The " + UI.FormatAsTool("Mop Tool", "[M]") + " can be used to clean up Duplicant-related \"spills\"" + UI.HORIZONTAL_BR_RULE + "A " + UI.PRE_KEYWORD + "Disease" + UI.PST_KEYWORD + " has caused these Duplicants to throw up:");
      }

      public class STRESSVOMITING
      {
        public static LocString NAME = (LocString) "Stress vomiting";
        public static LocString TOOLTIP = (LocString) ("This Duplicant is relieving their " + UI.PRE_KEYWORD + "Stress" + UI.PST_KEYWORD + " all over the floor" + UI.HORIZONTAL_BR_RULE + "Duplicant-related \"spills\" can be cleaned up using the " + UI.PRE_KEYWORD + "Mop Tool" + UI.PST_KEYWORD + " " + UI.FormatAsHotkey("[M]"));
        public static LocString NOTIFICATION_NAME = (LocString) "Stress vomiting";
        public static LocString NOTIFICATION_TOOLTIP = (LocString) ("The " + UI.FormatAsTool("Mop Tool", "[M]") + " can used to clean up Duplicant-related \"spills\"" + UI.HORIZONTAL_BR_RULE + "These Duplicants became so " + UI.PRE_KEYWORD + "Stressed" + UI.PST_KEYWORD + " they threw up:");
      }
    ...
    public class DISEASES
    {
      ...
      {
        public static LocString TEMPLATE = (LocString) ("{InfectionSource}{Duration}{Doctor}{Fatality}{Cures}{Bedrest}" + UI.HORIZONTAL_BR_RULE + "\n{Symptoms}");
      ...
      public class DESCRIPTORS
      {
        public class INFO
        {
          ...
          public static LocString TEMPERATURE_RANGE_TOOLTIP = (LocString) ("These " + UI.PRE_KEYWORD + "Germs" + UI.PST_KEYWORD + " can survive " + UI.PRE_KEYWORD + "Temperatures" + UI.PST_KEYWORD + " between <b>{0}</b> and <b>{1}</b>" + UI.HORIZONTAL_BR_RULE + "They thrive in " + UI.PRE_KEYWORD + "Temperatures" + UI.PST_KEYWORD + " between <b>{2}</b> and <b>{3}</b>");
          public static LocString PRESSURE_RANGE = (LocString) "Pressure range: {0} to {1}\n";
          public static LocString PRESSURE_RANGE_TOOLTIP = (LocString) ("These " + UI.PRE_KEYWORD + "Germs" + UI.PST_KEYWORD + " can survive between <b>{0}</b> and <b>{1}</b> of pressure" + UI.HORIZONTAL_BR_RULE + "They thrive in pressures between <b>{2}</b> and <b>{3}</b>");
        }
      }
      ...
      public class FOODSICKNESS
      {
        ...
        public static LocString DISEASE_SOURCE_DESCRIPTOR_TOOLTIP = (LocString) ("This Duplicant will vomit approximately every <b>{0}</b>" + UI.HORIZONTAL_BR_RULE + "Each time they vomit, they will release <b>{1}</b> and lose " + UI.PRE_KEYWORD + "Calories" + UI.PST_KEYWORD);
      }
      ...
      public class SLIMESICKNESS
      {
        ...
        public static LocString DISEASE_SOURCE_DESCRIPTOR_TOOLTIP = (LocString) ("This Duplicant will cough approximately every <b>{0}</b>" + UI.HORIZONTAL_BR_RULE + "Each time they cough, they will release <b>{1}</b>");
      }
    ...
    {
      public static LocString MODIFIER_FORMAT = (LocString) "{0}: {1}";
      public static LocString TIME_REMAINING = (LocString) "\nTime Remaining: {0}";
      ...
      {
        public static LocString NAME = (LocString) "Unrested";
      ...
      {
        public static LocString NAME = (LocString) "Dead Tired";
      ...
      {
        public static LocString NAME = (LocString) "Contaminated Air";
      }
      ...
      public class PLAYEDARCADE
      {
        ...
        public static LocString TOOLTIP = (LocString) "This Duplicant recently got to play some fun video games!";
      }
      ...
      public class POWERTINKER
      {
        ...
        public static LocString TOOLTIP = (LocString) ("A skilled Duplicant has improved this generator's " + UI.PRE_KEYWORD + "Power" + UI.PST_KEYWORD + " output efficiency" + UI.HORIZONTAL_BR_RULE + "Applying this effect consumed one " + UI.PRE_KEYWORD + (string) ITEMS.INDUSTRIAL_PRODUCTS.POWER_STATION_TOOLS.NAME + UI.PST_KEYWORD);
      }

      public class FARMTINKER
      {
        public static LocString NAME = (LocString) "Farmer's Touch";
        public static LocString TOOLTIP = (LocString) ("A skilled Duplicant has encouraged this " + UI.PRE_KEYWORD + "Plant" + UI.PST_KEYWORD + " to grow a little bit faster" + UI.HORIZONTAL_BR_RULE + "Applying this effect consumed one dose of " + UI.PRE_KEYWORD + (string) ITEMS.INDUSTRIAL_PRODUCTS.FARM_STATION_TOOLS.NAME + UI.PST_KEYWORD);
      }
      ...
      public class CHARGING
      {
        ...
        public static LocString TOOLTIP = (LocString) "This Robot is charging its internal battery";
      }
    }
    ...
    public class TRAITS
    {
      ...
      public class REGENERATION
      {
        ...
        public static LocString DESC = (LocString) ("This Duplicant is constantly regenerating " + UI.PRE_KEYWORD + "Health" + UI.PST_KEYWORD + ".");
      }

      public class DEEPERDIVERSLUNGS
      {
        public static LocString NAME = (LocString) "Deep Diver's Lungs";
        public static LocString DESC = (LocString) "This Duplicant was a talented opera singer and a snorkeling instructor.";
      }
      ...
      {
        public static LocString NAME = (LocString) "No Taste";
        public static LocString DESC = (LocString) ("This Duplicant's dull senses could barely tell the difference between " + (string) ITEMS.FOOD.SALSA.NAME + " and cardboard");
      }
    ...
    public class ATTRIBUTES
    {
      ...
      public static LocString PROFESSION_DESC = (LocString) ("Expertise is determined by a Duplicant's highest " + UI.PRE_KEYWORD + "Attribute" + UI.PST_KEYWORD + UI.HORIZONTAL_BR_RULE + "Duplicants develop higher expectations as their Expertise level increases");
      ...
      {
        public static LocString NAME = (LocString) "Rocket Navigation Efficiency";
      ...
      public class SCALEGROWTHDELTA
      {
        ...
        public static LocString TOOLTIP = (LocString) ("Determines how long this " + UI.PRE_KEYWORD + "Critter" + UI.PST_KEYWORD + "'s scales will take to grow back.");
      }
    ...
    public class ROLES
    {
      ...
      {
        public static LocString NAME = (LocString) UI.FormatAsLink("Art Fundamentals", nameof (JUNIOR_ARTIST));
        public static LocString DESCRIPTION = (LocString) "Teaches the most basic level of art skill";
      }

      public class ARTIST
      {
        public static LocString NAME = (LocString) "Aesthetic Design";
        public static LocString DESCRIPTION = (LocString) "Allows moderately attractive art to be created";
      }

      public class MASTER_ARTIST
      {
        public static LocString NAME = (LocString) UI.FormatAsLink("Masterworks", nameof (MASTER_ARTIST));
      ...
      {
        public static LocString NAME = (LocString) UI.FormatAsLink("Improved Construction I", nameof (JUNIOR_BUILDER));
        public static LocString DESCRIPTION = (LocString) "Marginally improves a Duplicant's construction speeds";
      }

      public class BUILDER
      {
        public static LocString NAME = (LocString) UI.FormatAsLink("Improved Construction II", nameof (BUILDER));
      ...
      {
        public static LocString NAME = (LocString) UI.FormatAsLink("Improved Construction III", nameof (SENIOR_BUILDER));
        public static LocString DESCRIPTION = (LocString) "Further increases a Duplicant's construction speeds";
      }

      public class JUNIOR_RESEARCHER
      {
        public static LocString NAME = (LocString) UI.FormatAsLink("Advanced Research", nameof (JUNIOR_RESEARCHER));
      ...
      {
        public static LocString NAME = (LocString) UI.FormatAsLink("Field Research", nameof (RESEARCHER));
        public static LocString DESCRIPTION = (LocString) ("Duplicants can perform studies on " + UI.PRE_KEYWORD + "Geysers" + UI.PST_KEYWORD + " and other phenomena");
      }

      public class SENIOR_RESEARCHER
      {
        public static LocString NAME = (LocString) UI.FormatAsLink("Astronomy", nameof (SENIOR_RESEARCHER));
        public static LocString DESCRIPTION = (LocString) ("Enables Duplicants to study outer space using the " + (string) BUILDINGS.PREFABS.COSMICRESEARCHCENTER.NAME);
      }

      public class JUNIOR_COOK
      {
        public static LocString NAME = (LocString) UI.FormatAsLink("Grilling", nameof (JUNIOR_COOK));
      ...
      public class COOK
      {
        public static LocString NAME = (LocString) UI.FormatAsLink("Grilling II", nameof (COOK));
        public static LocString DESCRIPTION = (LocString) "Improves a Duplicant's cooking speed";
      }

      public class JUNIOR_MEDIC
      {
        public static LocString NAME = (LocString) UI.FormatAsLink("Medicine Compounding", "MEDIC");
      ...
      public class MEDIC
      {
        public static LocString NAME = (LocString) UI.FormatAsLink("Bedside Manner", nameof (MEDIC));
      ...
      {
        public static LocString NAME = (LocString) UI.FormatAsLink("Advanced Medical Care", "MEDIC");
      ...
      {
        public static LocString NAME = (LocString) UI.FormatAsLink("Improved Tinkering", nameof (MACHINE_TECHNICIAN));
      ...
      public class HAULER
      {
        public static LocString NAME = (LocString) UI.FormatAsLink("Improved Carrying I", nameof (HAULER));
      ...
      {
        public static LocString NAME = (LocString) UI.FormatAsLink("Improved Carrying II", nameof (MATERIALS_MANAGER));
      ...
      {
        public static LocString NAME = (LocString) UI.FormatAsLink("Improved Farming I", nameof (JUNIOR_FARMER));
      ...
      public class FARMER
      {
        public static LocString NAME = (LocString) UI.FormatAsLink("Crop Tending", nameof (FARMER));
      ...
      {
        public static LocString NAME = (LocString) UI.FormatAsLink("Improved Farming II", nameof (SENIOR_FARMER));
        public static LocString DESCRIPTION = (LocString) "Further increases a Duplicant's farming skills";
      }

      public class JUNIOR_MINER
      {
        public static LocString NAME = (LocString) UI.FormatAsLink("Hard Digging", nameof (JUNIOR_MINER));
        public static LocString DESCRIPTION = (LocString) ("Allows excavation of very firm materials such as " + (string) ELEMENTS.GRANITE.NAME);
      }

      public class MINER
      {
        public static LocString NAME = (LocString) UI.FormatAsLink("Superhard Digging", nameof (MINER));
        public static LocString DESCRIPTION = (LocString) ("Allows excavation of the element " + (string) ELEMENTS.KATAIRITE.NAME);
      }

      public class SENIOR_MINER
      {
        public static LocString NAME = (LocString) UI.FormatAsLink("Superduperhard Digging", nameof (SENIOR_MINER));
        public static LocString DESCRIPTION = (LocString) ("Allows excavation of extremely hard materials like " + (string) ELEMENTS.DIAMOND.NAME + " and " + (string) ELEMENTS.OBSIDIAN.NAME);
      }

      public class SUIT_EXPERT
      {
        public static LocString NAME = (LocString) UI.FormatAsLink("Exosuit Training", nameof (SUIT_EXPERT));
      ...
      {
        public static LocString NAME = (LocString) UI.FormatAsLink("Electrical Engineering", nameof (POWER_TECHNICIAN));
      ...
      {
        public static LocString NAME = (LocString) UI.FormatAsLink("Mechatronics Engineering", nameof (MECHATRONIC_ENGINEER));
      ...
      {
        public static LocString NAME = (LocString) UI.FormatAsLink("Improved Strength", nameof (HANDYMAN));
        public static LocString DESCRIPTION = (LocString) "Minorly improves a Duplicant's physical strength";
      }

      public class PLUMBER
      {
        public static LocString NAME = (LocString) UI.FormatAsLink("Plumbing", nameof (PLUMBER));
      ...
      {
        public static LocString NAME = (LocString) UI.FormatAsLink("Critter Ranching I", nameof (RANCHER));
      ...
      {
        public static LocString NAME = (LocString) UI.FormatAsLink("Critter Ranching II", nameof (SENIOR_RANCHER));
      ...
      {
        public static LocString NAME = (LocString) UI.FormatAsLink("Rocket Piloting", nameof (ASTRONAUTTRAINEE));
      ...
      public class ASTRONAUT
      {
        public static LocString NAME = (LocString) UI.FormatAsLink("Rocket Navigation", nameof (ASTRONAUT));
