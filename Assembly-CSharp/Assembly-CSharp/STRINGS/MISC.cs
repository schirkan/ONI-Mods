...
namespace STRINGS
{
  public class MISC
  {
    public class TAGS
    {
      ...
      public static LocString ICEORE = (LocString) "Ice";
      public static LocString PHOSPHORUS = (LocString) "Phosphorus";
      public static LocString BUILDABLERAW = (LocString) "Raw Mineral";
      public static LocString BUILDABLEPROCESSED = (LocString) "Refined Mineral";
      public static LocString BUILDABLEANY = (LocString) "Generic Buildable";
      public static LocString REFINEDMETAL = (LocString) "Refined Metal";
      public static LocString METAL = (LocString) "Metal Ore";
      public static LocString PRECIOUSMETAL = (LocString) "Precious Metal";
      public static LocString RAWPRECIOUSMETAL = (LocString) "Precious Metal Ore";
      public static LocString PRECIOUSROCK = (LocString) "Precious Rock";
      public static LocString ALLOY = (LocString) "Alloy";
      public static LocString BUILDINGFIBER = (LocString) "Fiber";
      public static LocString BUILDINGWOOD = (LocString) "Wood";
      public static LocString CRUSHABLE = (LocString) "Crushable";
      public static LocString BAGABLECREATURE = (LocString) "Critter";
      ...
      public static LocString INDUSTRIALINGREDIENT = (LocString) "Industrial Ingredient";
      public static LocString MEDICALSUPPLIES = (LocString) "Medical Supplies";
      public static LocString CLOTHES = (LocString) "Clothing";
      public static LocString EMITSLIGHT = (LocString) "Light Emitter";
      public static LocString BED = (LocString) "Bed";
      public static LocString MESSSTATION = (LocString) "Dining Table";
      public static LocString TOY = (LocString) "Toy";
      public static LocString SUIT = (LocString) "Suit";
      ...
      public static LocString PLUMBABLE = (LocString) "Plumbable";
      public static LocString COMPOSTABLE = (LocString) "Compostable";
      ...
      public static LocString PLASTIC = (LocString) "Plastic";
      public static LocString TOILET = (LocString) "Toilet";
      public static LocString MASSAGE_TABLE = (LocString) "Massage Table";
      ...
      public static LocString COMBUSTIBLEGAS = (LocString) "Combustible Gas";
      public static LocString COMBUSTIBLELIQUID = (LocString) "Combustible Liquid";
      public static LocString COMBUSTIBLESOLID = (LocString) "Combustible Solid";
    ...
    public class STATUSITEMS
    {
      public class OXYROCK
      {
        ...
        {
          public static LocString NAME = (LocString) "Oxylite blocked";
          public static LocString TOOLTIP = (LocString) ("This " + UI.FormatAsLink("Oxylite", nameof (OXYROCK)) + " deposit is not exposed to air and cannot emit " + UI.FormatAsLink("Oxygen", "OXYGEN"));
        }

        public class OVERPRESSURE
        {
          public static LocString NAME = (LocString) "Inert";
          public static LocString TOOLTIP = (LocString) ("Environmental " + UI.PRE_KEYWORD + "Gas Pressure" + UI.PST_KEYWORD + " is too high for this " + UI.FormatAsLink("Oxylite", nameof (OXYROCK)) + " deposit to emit " + UI.FormatAsLink("Oxygen", "OXYGEN"));
        }
      }

      public class OXYROCKBLOCKED
      {
        public static LocString NAME = (LocString) "{BlockedString}";
        public static LocString TOOLTIP = (LocString) ("This " + UI.FormatAsLink("Oxylite", "OXYROCK") + " deposit has no room to emit " + UI.FormatAsLink("Oxygen", "OXYGEN"));
      }
      ...
      {
        public static LocString NAME = (LocString) "Inert";
        public static LocString TOOLTIP = (LocString) ("Environmental " + UI.PRE_KEYWORD + "Gas Pressure" + UI.PST_KEYWORD + " is too high for this " + UI.FormatAsLink("Oxylite", "OXYROCK") + " deposit to emit " + (string) ELEMENTS.OXYGEN.NAME);
      }
      ...
      public class BLEACHSTONE
      {
        public class NEIGHBORSBLOCKED
        {
          public static LocString NAME = (LocString) "Bleachstone blocked";
          public static LocString TOOLTIP = (LocString) ("This " + UI.FormatAsLink("Bleachstone", nameof (BLEACHSTONE)) + " deposit is not exposed to air and cannot emit " + UI.FormatAsLink("Chlorine", "CHLORINE"));
        }

        public class OVERPRESSURE
        {
          public static LocString NAME = (LocString) "Inert";
          public static LocString TOOLTIP = (LocString) ("Environmental " + UI.PRE_KEYWORD + "Gas Pressure" + UI.PST_KEYWORD + " is too high for this " + UI.FormatAsLink("Bleachstone", nameof (BLEACHSTONE)) + " deposit to emit " + UI.FormatAsLink("Chlorine", "CHLORINE"));
        }
      }
      ...
      {
        public static LocString NAME = (LocString) "{BlockedString}";
        public static LocString TOOLTIP = (LocString) ("This " + UI.FormatAsLink("Bleachstone", "BLEACHSTONE") + " deposit has no room to emit " + UI.FormatAsLink("Chlorine", "CHLORINE"));
      }
      ...
      {
        public static LocString NAME = (LocString) "Inert";
        public static LocString TOOLTIP = (LocString) ("Environmental " + UI.PRE_KEYWORD + "Gas Pressure" + UI.PST_KEYWORD + " is too high for this " + UI.FormatAsLink("Bleachstone", "BLEACHSTONE") + " deposit to emit " + UI.FormatAsLink("Chlorine", "CHLORINE"));
      }
      ...
      public class NOTMARKEDFORHARVEST
      {
        ...
        public static LocString TOOLTIP = (LocString) ("Use the " + UI.FormatAsTool("Harvest Tool", "[Y]") + " to mark this plant for harvest");
      }
      ...
      public class SPOUTDORMANT
      {
        ...
        public static LocString TOOLTIP = (LocString) ("This geyser's geoactivity has halted" + UI.HORIZONTAL_BR_RULE + "It won't erupt again for some time");
      }
      ...
      public class ORDERCAPTURE
      {
        ...
        public static LocString TOOLTIP = (LocString) ("Waiting for a Duplicant to capture this " + UI.PRE_KEYWORD + "Critter" + UI.PST_KEYWORD + UI.HORIZONTAL_BR_RULE + "Only Duplicants with the " + (string) DUPLICANTS.ROLES.RANCHER.NAME + " Skill can catch critters without traps");
      }
    ...
    public class NOTIFICATIONS
    {
      ...
      public class WELCOMEMESSAGE
      {
        ...
        public static LocString MESSAGEBODY = (LocString) ("I can use the " + UI.FormatAsTool("Dig Tool", "[G]") + " and the " + UI.FormatAsBuildMenuTab("Build Menu") + " in the lower left of the screen to begin planning my first construction tasks.\n\nOnce I've placed a few errands my Duplicants will automatically get to work, without me needing to direct them individually.");
      ...
      public class FETCHINGWATERMESSAGE
      {
        ...
        public static LocString MESSAGEBODY = (LocString) ("By building a " + UI.FormatAsLink("Pitcher Pump", "LIQUIDPUMPINGSTATION") + " from the " + UI.FormatAsBuildMenuTab("Plumbing Tab", "[5]") + " over a pool of liquid, my Duplicants will be able to bottle it up and manually deliver it wherever it needs to go.");
      ...
      public class THERMALCOMFORT
      {
        ...
        public static LocString MESSAGEBODY = (LocString) ("Environments that are extremely " + UI.FormatAsLink("Hot", "HEAT") + " or " + UI.FormatAsLink("Cold", "HEAT") + " affect my Duplicants' internal body temperature and cause undue " + UI.FormatAsLink("Stress", "STRESS") + ".\n\nOpening the " + UI.FormatAsOverlay("Temperature Overlay", "[F3]") + " and checking the <b>Thermal Tolerance</b> box allows me to view all areas where my Duplicants will feel discomfort and be unable to regulate their internal body temperature.");
      }
      ...
      public class LOTS_OF_GERMS
      {
        ...
        public static LocString MESSAGEBODY = (LocString) (UI.FormatAsLink("Germs", "DISEASE") + " such as " + UI.FormatAsLink("Food Poisoning", "FOODSICKNESS") + " and " + UI.FormatAsLink("Slimelung", "SLIMESICKNESS") + " can cause " + UI.FormatAsLink("Disease", "DISEASE") + " in my Duplicants. I can use the " + UI.FormatAsOverlay("Germ Overlay", "[F9]") + " to view all germ concentrations in my colony, and even detect the sources spawning them.\n\nBuilding Wash Basins from the " + UI.FormatAsBuildMenuTab("Medicine Tab", "[8]") + " by colony toilets will tell my Duplicants they need to wash up.");
      }
      ...
      public class MORALE
      {
        ...
        public static LocString MESSAGEBODY = (LocString) "Food, Rooms, Decor, and Recreation all have have an effect on Duplicant Morale. Good experiences improve their Morale and poor experiences lower it. When Morale is below their Expectations, Duplicants will become Stressed.\n\nAs Duplicants are given new Skills they gain increased Expectations, and the colony will have to be improved to keep up their Morale. An overview of Morale and Stress can be viewed on the Vitals screen.";
      }
      ...
      public class INSULATION
      {
        ...
        public static LocString MESSAGEBODY = (LocString) ("The temperature of an environment can have positive or negative effects on the wellbeing of my Duplicants, and the plants and critters in my colony. Selecting " + UI.FormatAsHotkey("[F3]") + " will open the Temperature Overlay where I can check for hot and cold spots.\n\nI can use a Utility like an Ice-E Fan or a Space Heater to make an area colder or hotter. However, I will have limited success changing the temperature of a room unless I build the area with insulating tiles to prevent cold or warm air from escaping.");
      }
      ...
      public class RESEARCHCOMPLETE
      {
        ...
        public static LocString MESSAGEBODY = (LocString) "Eureka! My Duplicants have discovered {0} Technology.\n\nNew buildings have become available:\n  • {1}";
        public static LocString TOOLTIP = (LocString) "{0} research complete!";
      }

      public class SKILL_POINT_EARNED
      {
        public static LocString NAME = (LocString) "Skill point earned";
        ...
        public static LocString TOOLTIP = (LocString) "Duplicants can now learn new skills";
      }
      ...
      public class DUPLICANTABSORBED
      {
        ...
        public static LocString TOOLTIP = (LocString) "Printables have been reabsorbed";
      }
      ...
      public class FOODROT
      {
        ...
        public static LocString TOOLTIP = (LocString) ("These " + UI.FormatAsLink("Food", "FOOD") + " items have rotted and are no longer edible:\n• {0}");
      }
      ...
      public class NO_OXYGEN_GENERATOR
      {
        ...
        public static LocString TOOLTIP = (LocString) ("My colony is not producing any new " + UI.FormatAsLink("Oxygen", "OXYGEN") + UI.HORIZONTAL_BR_RULE + UI.FormatAsLink("Oxygen Diffusers", "MINERALDEOXIDIZER") + " can be built from the " + UI.FormatAsBuildMenuTab("Oxygen Tab", "[2]"));
      }
      ...
      public class FOODLOW
      {
        ...
        public static LocString TOOLTIP = (LocString) ("The colony's " + UI.FormatAsLink("Food", "FOOD") + " reserves are low:" + UI.HORIZONTAL_BR_RULE + "    • {0} are currently available\n    • {1} is being consumed per cycle\n\n" + UI.FormatAsLink("Microbe Mushers", "MICROBEMUSHER") + " can be built from the " + UI.FormatAsBuildMenuTab("Food Tab", "[4]"));
      }

      public class NO_MEDICAL_COTS
      {
        public static LocString NAME = (LocString) ("No " + UI.FormatAsLink("Sick Bay", "DOCTORSTATION") + " built");
        public static LocString TOOLTIP = (LocString) ("There is nowhere for sick Duplicants receive medical care" + UI.HORIZONTAL_BR_RULE + UI.FormatAsLink("Sick Bays", "DOCTORSTATION") + " can be built from the " + UI.FormatAsBuildMenuTab("Medicine Tab", "[8]"));
      }

      public class NEEDTOILET
      {
        public static LocString NAME = (LocString) ("No " + UI.FormatAsLink("Outhouse", "OUTHOUSE") + " built");
        public static LocString TOOLTIP = (LocString) ("My Duplicants have nowhere to relieve themselves" + UI.HORIZONTAL_BR_RULE + UI.FormatAsLink("Outhouses", "OUTHOUSE") + " can be built from the " + UI.FormatAsBuildMenuTab("Plumbing Tab", "[5]"));
      }

      public class NEEDFOOD
      {
        public static LocString NAME = (LocString) "Colony requires a food source";
        public static LocString TOOLTIP = (LocString) ("The colony will exhaust their supplies without a new " + UI.FormatAsLink("Food", "FOOD") + " source" + UI.HORIZONTAL_BR_RULE + UI.FormatAsLink("Microbe Mushers", "MICROBEMUSHER") + " can be built from the " + UI.FormatAsBuildMenuTab("Food Tab", "[4]"));
      }

      public class HYGENE_NEEDED
      {
        public static LocString NAME = (LocString) ("No " + UI.FormatAsLink("Wash Basin", "WASHBASIN") + " built");
        public static LocString TOOLTIP = (LocString) (UI.FormatAsLink("Germs", "DISEASE") + " are spreading in the colony because my Duplicants have nowhere to clean up" + UI.HORIZONTAL_BR_RULE + UI.FormatAsLink("Wash Basins", "WASHBASIN") + " can be built from the " + UI.FormatAsBuildMenuTab("Medicine Tab", "[8]"));
      }

      public class NEEDSLEEP
      {
        public static LocString NAME = (LocString) ("No " + UI.FormatAsLink("Cots", "COT") + " built");
        public static LocString TOOLTIP = (LocString) ("My Duplicants would appreciate a place to sleep" + UI.HORIZONTAL_BR_RULE + UI.FormatAsLink("Cots", "COTS") + " can be built from the " + UI.FormatAsBuildMenuTab("Furniture Tab", "[9]"));
      }

      public class NEEDENERGYSOURCE
      {
        public static LocString NAME = (LocString) ("Colony requires a " + UI.FormatAsLink("Power", "POWER") + " source");
        public static LocString TOOLTIP = (LocString) (UI.FormatAsLink("Power", "POWER") + " is required to operate electrical buildings" + UI.HORIZONTAL_BR_RULE + UI.FormatAsLink("Manual Generators", "MANUALGENERATOR") + " and " + UI.FormatAsLink("Wire", "WIRE") + " can be built from the " + UI.FormatAsLink("Power Tab", "[3]"));
      }
      ...
      public class LEVELUP
      {
        ...
        public static LocString SUFFIX = (LocString) " - {0} raised to {1}";
      }

      public class RESETSKILL
      {
        public static LocString NAME = (LocString) "Reset skills";
        public static LocString TOOLTIP = (LocString) ("Duplicants " + UI.PRE_KEYWORD + "Skills" + UI.PST_KEYWORD + " have been reset to defaults.");
      }
      ...
      public class HEALINGTRAITGAIN
      {
        ...
        public static LocString TOOLTIP = (LocString) ("These Duplicants' injuries weren't set and healed improperly. They developed " + UI.PRE_KEYWORD + "Traits" + UI.PST_KEYWORD + " as a result:");
        public static LocString SUFFIX = (LocString) (" has developed " + UI.PRE_KEYWORD + "{0}" + UI.PST_KEYWORD ?? "");
      }
      ...
      {
        public static LocString NAME = (LocString) "Duplicants have suffocated";
        public static LocString TOOLTIP = (LocString) ("These Duplicants have asphyxiated in " + UI.PRE_KEYWORD + "Heat" + UI.PST_KEYWORD + " air:");
      }
      ...
      public class COLONY_ACHIEVEMENT_EARNED
      {
        ...
        public static LocString TOOLTIP = (LocString) "Colony has earned a new achievement.";
      }
    }
    ...
    {
      public static LocString NAME = (LocString) "Completed Monument";
      public static LocString DESC = (LocString) "Monument has head, midsection and bottom.";
    }
  }
}
