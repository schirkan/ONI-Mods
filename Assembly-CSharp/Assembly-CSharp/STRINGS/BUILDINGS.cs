  ...
  public class BUILDINGS
  {
    public class PREFABS
    {
      ...
      public class VERTICALWINDTUNNEL
      {
        ...
        public static LocString EFFECT = (LocString) ("Must be placed above an open space and be connected to a " + UI.FormatAsLink("Power Source", "POWER") + ".\n\nIncreases Duplicants " + UI.FormatAsLink("Morale", "MORALE") + ".");
      ...
      public class SOLIDFILTER
      {
        ...
        public static LocString EFFECT = (LocString) ("Separates one " + UI.FormatAsLink("Solid", "ELEMENTS_SOLID") + " from the conveyor, sending it into a dedicated " + (string) BUILDINGS.PREFABS.SOLIDCONDUIT.NAME + ".");
        public static LocString STATUS_ITEM = (LocString) "Filters: {0}";
        public static LocString ELEMENT_NOT_SPECIFIED = (LocString) "Not Specified";
      }
      ...
      {
        public static LocString NAME = (LocString) UI.FormatAsLink("Sweepy Dock", nameof (SWEEPBOTSTATION));
        public static LocString NAMEDSTATION = (LocString) "{0}'s Dock";
        public static LocString DESC = (LocString) "Deploys a helpful little Sweepy robot.";
        public static LocString EFFECT = (LocString) ("Stores " + UI.FormatAsLink("Liquid", "ELEMENTS_LIQUID") + " and " + UI.FormatAsLink("Solid Materials", "ELEMENTS_SOLID") + " debris from the Sweepy.\n\nRequires " + UI.FormatAsLink("Power", "POWER") + " to recharge the Sweepy.\n\nDuplicants that can perform Supply errands will empty the debris into available storage bins.");
      }
      ...
      public class LOGICHAMMER
      {
        ...
        public static LocString EFFECT = (LocString) ("In its default orientation, the hammer strikes the building to the left when it recieves a " + UI.FormatAsAutomationState("Green Signal", UI.AutomationState.Active) + ".\n\nEach building has a unique sound when struck by the hammer. The hammer does no damage when it strikes.");
      ...
      {
        public static LocString NAME = (LocString) "Sticker Bomb";
