...
namespace STRINGS
{
  public class ELEMENTS
  {
    ...
    public class HARDNESS
    {
      ...
      public static LocString SOFT = (LocString) "{0} (Soft)";
      public static LocString VERYSOFT = (LocString) "{0} (Very Soft)";
      public static LocString FIRM = (LocString) "{0} (Firm)";
      public static LocString VERYFIRM = (LocString) "{0} (Very Firm)";
      public static LocString NEARLYIMPENETRABLE = (LocString) "{0} (Nearly Impenetrable)";
      public static LocString IMPENETRABLE = (LocString) "{0} (Impenetrable)";
    }
    ...
    public class IRONINGOT
    {
      ...
      public static LocString DESC = (LocString) ("(Fe) Iron is refined " + UI.FormatAsLink("Iron Ore", "IRONORE") + ".");
    }
    ...
    {
      public static LocString NAME = (LocString) UI.FormatAsLink("Phosphorus", nameof (PHOSPHORUS));
      public static LocString DESC = (LocString) ("(P) Phosphorus is a chemical element in its " + UI.FormatAsLink("Solid", "ELEMENTS_SOLID") + " state.");
    }
    ...
    public class UNOBTANIUM
    {
      ...
      public static LocString DESC = (LocString) "(Nt) Neutronium is a mysterious and extremely resilient Metallic element.\n\nIt cannot be excavated by any Duplicant mining tool.";
    }
    ...
    public class POLYPROPYLENE
    {
      ...
      public static LocString BUILD_DESC = (LocString) "Buildings made of this material have antiseptic properties";
    }
