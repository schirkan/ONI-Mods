...
namespace STRINGS
{
  ...
  {
    public static LocString MISSING_TRAIT = (LocString) "<missing trait>";
    ...
    public static class FROZEN_CORE
    {
      ...
      public static LocString DESCRIPTION = (LocString) ("The core of this world is a block of " + (string) ELEMENTS.ICE.NAME ?? "");
    }
