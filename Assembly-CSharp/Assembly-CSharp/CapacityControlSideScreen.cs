...
public class CapacityControlSideScreen : SideScreenContent
{
  ...
  public override bool IsValidForTarget(GameObject target) => target.GetComponent<IUserControlledCapacity>() != null;
  ...
  private void UpdateMaxCapacityLabel() => this.numberInput.SetDisplayValue(this.target.UserMaxCapacity.ToString());
}
