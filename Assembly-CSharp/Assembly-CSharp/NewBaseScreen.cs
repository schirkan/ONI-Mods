...
public class NewBaseScreen : KScreen
{
  ...
  public void SetStartingMinionStats(ITelepadDeliverable[] stats) => this.minionStartingStats = stats;
  ...
  private void SpawnMinions(int headquartersCell)
  {
    ...
    else
    {
      ...
      for (int index = 0; index < this.minionStartingStats.Length; ++index)
      {
        ...
        GameObject gameObject1 = Util.KInstantiate(Assets.GetPrefab((Tag) MinionConfig.ID));
