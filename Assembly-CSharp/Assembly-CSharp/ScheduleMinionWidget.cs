...
public class ScheduleMinionWidget : KMonoBehaviour
{
  ...
  public void Setup(Schedulable schedulable)
  {
    ...
    this.dropDown.Initialize(ScheduleManager.Instance.GetSchedules().Cast<IListableOption>(), new System.Action<IListableOption, object>(this.OnDropEntryClick), refreshAction: new System.Action<DropDownEntry, object>(this.DropEntryRefreshAction), displaySelectedValueWhenClosed: false, targetData: ((object) schedulable));
  }
  ...
  private void OnBlankDropEntryClick(IListableOption option, object obj) => this.ChangeAssignment((Schedule) obj, ((Component) option).GetComponent<Schedulable>());
  ...
  private void BlankDropEntryRefreshAction(DropDownEntry entry, object obj)
  {
    ...
    Schedulable component1 = entryData.GetComponent<Schedulable>();
    if (schedule.IsAssigned(component1))
    {
    ...
    Traits component2 = entryData.GetComponent<Traits>();
    entry.gameObject.GetComponent<HierarchyReferences>().GetReference<RectTransform>("NightOwlIcon").gameObject.SetActive(component2.HasTrait("NightOwl"));
    entry.gameObject.GetComponent<HierarchyReferences>().GetReference<RectTransform>("EarlyBirdIcon").gameObject.SetActive(component2.HasTrait("EarlyBird"));
  }
