...
public class SuitWearer : GameStateMachine<SuitWearer, SuitWearer.Instance>
{
  ...
  public new class Instance : GameStateMachine<SuitWearer, SuitWearer.Instance, IStateMachineTarget, object>.GameInstance
  {
    ...
    {
      if (this.navigator.CurrentNavType == NavType.Hover && (uint) (this.navigator.flags & PathFinder.PotentialPath.Flags.HasJetPack) <= 0U)
    ...
    public void ReserveSuits()
    {
      ...
      if (path.nodes == null)
        return;
      bool flag1 = (uint) (this.navigator.flags & PathFinder.PotentialPath.Flags.HasAtmoSuit) > 0U;
      bool flag2 = (uint) (this.navigator.flags & PathFinder.PotentialPath.Flags.HasJetPack) > 0U;
      for (int index = 0; index < path.nodes.Count - 1; ++index)
      {
        ...
        {
          bool flag3 = (uint) (pathFlags & PathFinder.PotentialPath.Flags.HasAtmoSuit) > 0U;
          bool flag4 = (uint) (pathFlags & PathFinder.PotentialPath.Flags.HasJetPack) > 0U;
