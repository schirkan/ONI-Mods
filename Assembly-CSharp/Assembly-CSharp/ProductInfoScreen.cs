...
public class ProductInfoScreen : KScreen
{
  ...
  private bool BuildRequirementsMet(BuildingDef def) => DebugHandler.InstantBuildMode || Game.Instance.SandboxModeActive || this.materialSelectionPanel.CanBuild(def.CraftRecipe) && Db.Get().TechItems.IsTechItemComplete(def.PrefabID);
