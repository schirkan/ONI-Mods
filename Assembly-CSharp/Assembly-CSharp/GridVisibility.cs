...
public class GridVisibility : KMonoBehaviour
{
  ...
  protected override void OnCleanUp() => Singleton<CellChangeMonitor>.Instance.UnregisterCellChangedHandler(this.transform, new System.Action(this.OnCellChange));
}
