...
public class KBoxCollider2D : KCollider2D
{
  ...
  public override Bounds bounds => new Bounds(this.transform.GetPosition() + new Vector3(this.offset.x, this.offset.y, 0.0f), new Vector3(this._size.x, this._size.y, 0.0f));
