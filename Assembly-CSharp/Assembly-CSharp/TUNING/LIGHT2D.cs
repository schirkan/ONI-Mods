...
namespace TUNING
{
  public class LIGHT2D
  {
    ...
    public static readonly Color LIGHTBUG_COLOR_ORANGE = new Color(0.5686275f, 0.4823529f, 0.4392157f, 1f);
    public static readonly Color LIGHTBUG_COLOR_PURPLE = new Color(0.4901961f, 0.4392157f, 0.5686275f, 1f);
