...
public abstract class Chore
{
  ...
  public bool InProgress() => (UnityEngine.Object) this.driver != (UnityEngine.Object) null;

  public abstract GameObject gameObject { get; }

  public abstract bool isNull { get; }

  public bool IsValid() => (UnityEngine.Object) this.provider != (UnityEngine.Object) null;
  ...
  protected void Succeed(string reason)
  {
    ...
    if (this.addToDailyReport)
    {
      ...
      SaveGame.Instance.GetComponent<ColonyAchievementTracker>().LogSuitChore((UnityEngine.Object) this.driver != (UnityEngine.Object) null ? this.driver : this.lastDriver);
    }
    this.End(reason);
    this.Cleanup();
  }
  ...
  public struct Precondition
  {
    ...
    public struct Context : IComparable<Chore.Precondition.Context>, IEquatable<Chore.Precondition.Context>
    {
      ...
      public static bool operator !=(Chore.Precondition.Context x, Chore.Precondition.Context y) => (uint) x.CompareTo(y) > 0U;
    }
  }
}
