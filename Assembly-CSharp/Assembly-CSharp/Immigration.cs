...
public class Immigration : KMonoBehaviour, ISaveLoadable, ISim200ms, IPersonalPriorityManager
{
  ...
  private void ConfigureCarePackages() => this.carePackages = new CarePackageInfo[58]
  {
  ...
  private bool DiscoveredCondition(Tag tag) => WorldInventory.Instance.IsDiscovered(tag);
