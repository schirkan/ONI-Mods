...
public class FetchChore : Chore<FetchChore.StatesInstance>
{
  ...
  public GameObject fetcher
  {
    ...
    set => this.smi.sm.fetcher.Set(value, this.smi);
  }
  ...
  public float AmountWaitingToFetch() => (UnityEngine.Object) this.fetcher == (UnityEngine.Object) null ? this.originalAmount : this.amount;
    ...
    : base(choreType, (IStateMachineTarget) destination, chore_provider, run_until_complete, on_complete, on_begin, on_end, priority_mod: priority_mod)
  {
    ...
    if ((double) amount <= (double) PICKUPABLETUNING.MINIMUM_PICKABLE_AMOUNT)
      DebugUtil.LogWarningArgs((object) string.Format("Chore {0} is requesting {1} {2} to {3}", (object) choreType.Id, (object) tags[0], (object) amount, (UnityEngine.Object) destination != (UnityEngine.Object) null ? (object) destination.name : (object) "to nowhere"));
  ...
  public override void Cleanup()
  {
    ...
    if (!((UnityEngine.Object) this.destination != (UnityEngine.Object) null))
      return;
    this.destination.Unsubscribe(644822890, new System.Action<object>(this.OnOnlyFetchMarkedItemsSettingChanged));
  }
