...
public class EntityTemplates
{
    ...
    float egg_anim_scale = 1f)
  {
    ...
    if (!string.IsNullOrEmpty(symbolPrefix))
      prefab1.ApplySymbolOverridesByAffix(Assets.GetAnim((HashedString) egg_anim), symbolPrefix);
  ...
  public static Tag GetUnbaggedCreatureTag(Tag bagged_tag) => TagManager.Create(bagged_tag.Name.Substring(6));
