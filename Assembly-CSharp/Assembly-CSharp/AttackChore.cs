...
public class AttackChore : Chore<AttackChore.StatesInstance>
{
  ...
  public string GetHitAnim()
  {
    ...
    return (bool) (UnityEngine.Object) component ? MultitoolController.GetAnimationStrings(component, this.gameObject.GetComponent<Worker>(), "hit")[1].Replace("_loop", "") : "hit";
  }
