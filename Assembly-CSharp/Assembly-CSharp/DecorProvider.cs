...
public class DecorProvider : KMonoBehaviour, IGameObjectEffectDescriptor
{
  ...
  public string GetName() => string.IsNullOrEmpty(this.overrideName) ? this.GetComponent<KSelectable>().GetName() : this.overrideName;
  ...
  public List<Descriptor> GetEffectDescriptions()
  {
    ...
    else if ((double) this.baseDecor != 0.0)
    {
      ...
      Descriptor descriptor = new Descriptor(string.Format((string) UI.BUILDINGEFFECTS.DECORPROVIDED, (object) str1, (object) str2, (object) this.baseRadius), string.Format(format, (object) str2, (object) this.baseRadius));
      descriptorList.Add(descriptor);
    }
