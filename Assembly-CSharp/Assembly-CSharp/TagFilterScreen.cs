...
public class TagFilterScreen : SideScreenContent
{
  ...
  public override bool IsValidForTarget(GameObject target) => (Object) target.GetComponent<TreeFilterable>() != (Object) null;
  ...
  public void Filter(List<Tag> acceptedTags) => this.acceptedTags = acceptedTags;
