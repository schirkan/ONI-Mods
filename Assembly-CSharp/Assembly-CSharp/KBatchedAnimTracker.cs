...
public class KBatchedAnimTracker : MonoBehaviour
{
  ...
  private void UpdateFrame()
  {
    ...
    if (this.controller.CurrentAnim != null)
    {
      ...
      if (symbolVisible && (this.previousMatrix != symbolLocalTransform || position1 != this.previousPosition || this.useTargetPoint || this.matchParentOffset && this.myAnim.Offset != this.controller.Offset))
      {
