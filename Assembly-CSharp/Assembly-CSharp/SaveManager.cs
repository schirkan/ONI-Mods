...
public class SaveManager : KMonoBehaviour
{
  ...
  protected override void OnPrefabInit() => Assets.RegisterOnAddPrefab(new System.Action<KPrefabID>(this.OnAddPrefab));
  ...
  public bool Load(IReader reader)
  {
    ...
    if (num1 != 7 || num2 > 17)
    {
      DebugUtil.LogWarningArgs((object) string.Format("SAVE FILE VERSION MISMATCH! Expected {0}.{1} but got {2}.{3}", (object) 7, (object) 17, (object) num1, (object) num2));
      return false;
    }
    this.ClearScene();
    try
