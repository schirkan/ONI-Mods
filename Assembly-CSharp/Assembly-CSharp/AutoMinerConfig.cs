...
public class AutoMinerConfig : IBuildingConfig
{
  ...
  private static void AddVisualizer(GameObject prefab, bool movable)
  {
    ...
    prefab.GetComponent<KPrefabID>().instantiateFn += (KPrefabID.PrefabFn) (go => go.GetComponent<StationaryChoreRangeVisualizer>().blocking_cb = new Func<int, bool>(AutoMiner.DigBlockingCB));
  }
}
