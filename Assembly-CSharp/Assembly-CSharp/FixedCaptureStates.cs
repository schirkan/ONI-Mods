...
public class FixedCaptureStates : GameStateMachine<FixedCaptureStates, FixedCaptureStates.Instance, IStateMachineTarget, FixedCaptureStates.Def>
{
  ...
  public override void InitializeStates(out StateMachine.BaseState default_state)
  {
    ...
    this.capture.cheer.DefaultState(this.capture.cheer.pre).ToggleStatusItem((string) CREATURES.STATUSITEMS.EXCITED_TO_BE_RANCHED.NAME, (string) CREATURES.STATUSITEMS.EXCITED_TO_BE_RANCHED.TOOLTIP, category: Db.Get().StatusItemCategories.Main);
    ...
    this.capture.move.DefaultState(this.capture.move.movetoranch).ToggleStatusItem((string) CREATURES.STATUSITEMS.GETTING_WRANGLED.NAME, (string) CREATURES.STATUSITEMS.GETTING_WRANGLED.TOOLTIP, category: Db.Get().StatusItemCategories.Main);
    ...
    this.capture.ranching.ToggleStatusItem((string) CREATURES.STATUSITEMS.GETTING_WRANGLED.NAME, (string) CREATURES.STATUSITEMS.GETTING_WRANGLED.TOOLTIP, category: Db.Get().StatusItemCategories.Main);
