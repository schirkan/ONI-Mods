...
public class BuildingDef : Def
{
  ...
  public override string Name => (string) Strings.Get("STRINGS.BUILDINGS.PREFABS." + this.PrefabID.ToUpper() + ".NAME");

  public string Desc => (string) Strings.Get("STRINGS.BUILDINGS.PREFABS." + this.PrefabID.ToUpper() + ".DESC");

  public string Flavor => "\"" + (string) Strings.Get("STRINGS.BUILDINGS.PREFABS." + this.PrefabID.ToUpper() + ".FLAVOR") + "\"";

  public string Effect => (string) Strings.Get("STRINGS.BUILDINGS.PREFABS." + this.PrefabID.ToUpper() + ".EFFECT");
    ...
    if (this.ReplacementCandidateLayers != null)
    {
      foreach (ObjectLayer replacementCandidateLayer in this.ReplacementCandidateLayers)
      {
        if (Grid.ObjectLayers[(int) replacementCandidateLayer].ContainsKey(cell))
        {
          ...
          if ((UnityEngine.Object) gameObject != (UnityEngine.Object) null && (UnityEngine.Object) gameObject.GetComponent<global::BuildingComplete>() != (UnityEngine.Object) null)
            return gameObject;
        }
      }
    }
    ...
    if ((UnityEngine.Object) resource_storage != (UnityEngine.Object) null)
    {
      ...
      if (allIngredients != null)
      {
        foreach (Recipe.Ingredient ingredient in allIngredients)
        {
          ...
          resource_storage.ConsumeAndGetDisease(ingredient.tag, ingredient.amount, out disease_info, out float _);
  ...
  public void MarkArea(int cell, Orientation orientation, ObjectLayer layer, GameObject go)
  {
    ...
    if (this.InputConduitType != ConduitType.None)
    {
      ...
      this.MarkOverlappingPorts(Grid.Objects[cell1, (int) layerForConduitType], go);
      Grid.Objects[cell1, (int) layerForConduitType] = go;
    }
    ...
    if (this.RequiresPowerInput)
    {
      ...
      int cell1 = Grid.OffsetCell(cell, rotatedCellOffset);
      this.MarkOverlappingPorts(Grid.Objects[cell1, 29], go);
      Grid.Objects[cell1, 29] = go;
    }
    ...
    if (this.BuildLocationRule == BuildLocationRule.LogicBridge)
    {
      ...
      if ((UnityEngine.Object) component != (UnityEngine.Object) null && component.inputPortInfo != null)
      {
        foreach (LogicPorts.Port port in component.inputPortInfo)
        {
          ...
          int cell1 = Grid.OffsetCell(cell, rotatedCellOffset);
          this.MarkOverlappingPorts(Grid.Objects[cell1, (int) layer], go);
          Grid.Objects[cell1, (int) layer] = go;
        }
      }
    }
    ...
    int cell2 = Grid.OffsetCell(cell, rotatedCellOffset1);
    this.MarkOverlappingPorts(Grid.Objects[cell2, (int) layerForConduitType1], go);
    Grid.Objects[cell2, (int) layerForConduitType1] = go;
  }
  ...
  public void UnmarkArea(int cell, Orientation orientation, ObjectLayer layer, GameObject go)
  {
    ...
    if (this.InputConduitType != ConduitType.None)
    {
      ...
      int cell1 = Grid.OffsetCell(cell, rotatedCellOffset);
      ObjectLayer layerForConduitType = Grid.GetObjectLayerForConduitType(this.InputConduitType);
      if ((UnityEngine.Object) Grid.Objects[cell1, (int) layerForConduitType] == (UnityEngine.Object) go)
        Grid.Objects[cell1, (int) layerForConduitType] = (GameObject) null;
    }
    if (this.OutputConduitType != ConduitType.None)
    {
      CellOffset rotatedCellOffset = Rotatable.GetRotatedCellOffset(this.UtilityOutputOffset, orientation);
    ...
    if (this.RequiresPowerInput)
    {
      CellOffset rotatedCellOffset = Rotatable.GetRotatedCellOffset(this.PowerInputOffset, orientation);
      int cell1 = Grid.OffsetCell(cell, rotatedCellOffset);
      if ((UnityEngine.Object) Grid.Objects[cell1, 29] == (UnityEngine.Object) go)
        Grid.Objects[cell1, 29] = (GameObject) null;
    }
    if (this.RequiresPowerOutput || (double) this.GeneratorWattageRating > 0.0)
    {
      CellOffset rotatedCellOffset = Rotatable.GetRotatedCellOffset(this.PowerOutputOffset, orientation);
    ...
    CellOffset rotatedCellOffset1 = Rotatable.GetRotatedCellOffset(component2.GetSecondaryConduitOffset(), orientation);
    int cell2 = Grid.OffsetCell(cell, rotatedCellOffset1);
    if (!((UnityEngine.Object) Grid.Objects[cell2, (int) layerForConduitType1] == (UnityEngine.Object) go))
      return;
    Grid.Objects[cell2, (int) layerForConduitType1] = (GameObject) null;
  }

  public int GetBuildingCell(int cell) => cell + (this.WidthInCells - 1) / 2;

  public Vector3 GetVisualizerOffset() => Vector3.right * (0.5f * (float) ((this.WidthInCells + 1) % 2));
    ...
    out string fail_reason)
  {
    ...
    if ((UnityEngine.Object) component != (UnityEngine.Object) null)
    {
      ...
      {
        global::BuildingUnderConstruction underConstruction1 = (bool) (UnityEngine.Object) gameObject1 ? gameObject1.GetComponent<global::BuildingUnderConstruction>() : (global::BuildingUnderConstruction) null;
        global::BuildingUnderConstruction underConstruction2 = (bool) (UnityEngine.Object) gameObject2 ? gameObject2.GetComponent<global::BuildingUnderConstruction>() : (global::BuildingUnderConstruction) null;
  ...
  public bool CheckRequiresPowerOutput() => (double) this.GeneratorWattageRating > 0.0 || this.RequiresPowerOutput;
