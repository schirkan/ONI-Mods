...
public abstract class Reactable
{
  ...
  public bool IsExpired() => (double) GameClock.Instance.GetTime() - (double) this.creationTime > (double) this.maxTriggerTime;
  ...
  public void Sim1000ms(float dt) => this.UpdateLocation();
