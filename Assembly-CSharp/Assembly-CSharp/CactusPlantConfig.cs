...
public class CactusPlantConfig : IEntityConfig
{
  ...
  public GameObject CreatePrefab()
  {
    ...
    EntityTemplates.CreateAndRegisterPreviewForPlant(EntityTemplates.CreateAndRegisterSeedForPlant(plant, SeedProducer.ProductionType.Hidden, "CactusPlantSeed", name2, desc2, anim2, additionalTags: additionalTags, replantGroundTag: replantGroundTag, sortOrder: 8, domesticatedDescription: domesticateddesc), "CactusPlant_preview", Assets.GetAnim((HashedString) "potted_cactus_kanim"), "place", 1, 1);
