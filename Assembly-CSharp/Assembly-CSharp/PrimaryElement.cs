...
public class PrimaryElement : KMonoBehaviour, ISaveLoadable
{
  ...
  private void OnDeserialized()
  {
    ...
    {
      DeserializeWarnings.Instance.PrimaryElementTemperatureIsNan.Warn(string.Format("{0} has invalid temperature of {1}. Resetting temperature.", (object) this.name, (object) this.Temperature));
