...
public class RequireOutputs : KMonoBehaviour
{
  ...
  protected override void OnSpawn()
  {
    ...
    if (layer != null)
      this.partitionerEntry = GameScenePartitioner.Instance.Add(nameof (RequireOutputs), (object) this.gameObject, this.utilityCell, layer, (System.Action<object>) (data => this.UpdateConnectionState()));
  ...
  private void UpdatePipeRoomState(bool force_update = false)
  {
    ...
    this.pipeBlockedGuid = this.selectable.ToggleStatusItem(Db.Get().BuildingStatusItems.ConduitBlockedMultiples, this.pipeBlockedGuid, !flag);
  }
