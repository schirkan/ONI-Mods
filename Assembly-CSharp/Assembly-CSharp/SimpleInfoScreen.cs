...
public class SimpleInfoScreen : TargetScreen
{
  ...
  public SimpleInfoScreen() => this.onStorageChangeDelegate = new System.Action<object>(this.OnStorageChange);
  ...
  {
    base.OnPrefabInit();
    this.statusItemPanel = Util.KInstantiateUI<CollapsibleDetailContentPanel>(ScreenPrefabs.Instance.CollapsableContentPanel, this.gameObject);
    ...
    this.vitalsPanel = Util.KInstantiateUI<CollapsibleDetailContentPanel>(ScreenPrefabs.Instance.CollapsableContentPanel, this.gameObject);
    this.vitalsPanel.SetTitle((string) STRINGS.UI.DETAILTABS.SIMPLEINFO.GROUPNAME_CONDITION);
    this.vitalsContainer = Util.KInstantiateUI(this.VitalsPanelTemplate, this.vitalsPanel.Content.gameObject).GetComponent<MinionVitalsPanel>();
    this.fertilityPanel = Util.KInstantiateUI<CollapsibleDetailContentPanel>(ScreenPrefabs.Instance.CollapsableContentPanel, this.gameObject);
    this.fertilityPanel.SetTitle((string) STRINGS.UI.DETAILTABS.SIMPLEINFO.GROUPNAME_FERTILITY);
    this.infoPanel = Util.KInstantiateUI(ScreenPrefabs.Instance.CollapsableContentPanel, this.gameObject);
    ...
    this.descriptionContainer = Util.KInstantiateUI<DescriptionContainer>(this.DescriptionContainerTemplate, gameObject);
    this.storagePanel = Util.KInstantiateUI(ScreenPrefabs.Instance.CollapsableContentPanel, this.gameObject);
    this.stressPanel = Util.KInstantiateUI(ScreenPrefabs.Instance.CollapsableContentPanel, this.gameObject);
    ...
    this.stampContainer = Util.KInstantiateUI(this.StampContainerTemplate, gameObject);
  ...
  public override void OnSelectTarget(GameObject target)
  {
    ...
    this.vitalsPanel.SetTitle((string) ((UnityEngine.Object) target.GetComponent<WiltCondition>() == (UnityEngine.Object) null ? STRINGS.UI.DETAILTABS.SIMPLEINFO.GROUPNAME_CONDITION : STRINGS.UI.DETAILTABS.SIMPLEINFO.GROUPNAME_REQUIREMENTS));
  ...
  private void SetPanels(GameObject target)
  {
    ...
    this.descriptionContainer.flavour.gameObject.SetActive(str2 != "" && str2 != "\n");
    ...
    else
    {
      ...
      else
      {
        ...
        else
        {
          ...
          string str1 = (string) ((UnityEngine.Object) this.selectedTarget.GetComponent<MinionIdentity>() != (UnityEngine.Object) null ? STRINGS.UI.DETAILTABS.DETAILS.GROUPNAME_MINION_CONTENTS : STRINGS.UI.DETAILTABS.DETAILS.GROUPNAME_CONTENTS);
          this.storagePanel.GetComponent<CollapsibleDetailContentPanel>().HeaderLabel.text = str1;
              ...
              if (!((UnityEngine.Object) go == (UnityEngine.Object) null))
              {
                ...
                if (storage.allowUIItemRemoval)
                {
                  ...
                  if ((UnityEngine.Object) transform != (UnityEngine.Object) null)
                  {
                    ...
                    component.onClick += (System.Action) (() => selected_storage.Drop(select_item));
                  }
                }
                ...
                string str2 = string.Format((string) STRINGS.UI.DETAILTABS.DETAILS.CONTENTS_MASS, (object) unitFormattedName, (object) GameUtil.GetFormattedMass(component1.Mass));
                string str3 = string.Format((string) STRINGS.UI.DETAILTABS.DETAILS.CONTENTS_TEMPERATURE, (object) str2, (object) GameUtil.GetFormattedTemperature(component1.Temperature));
                if (smi != null)
                {
                  string str4 = smi.StateString();
                  if (!string.IsNullOrEmpty(str4))
                    str3 += string.Format((string) STRINGS.UI.DETAILTABS.DETAILS.CONTENTS_ROTTABLE, (object) str4);
                ...
                {
                  str3 += string.Format((string) STRINGS.UI.DETAILTABS.DETAILS.CONTENTS_DISEASED, (object) GameUtil.GetFormattedDisease(component1.DiseaseIdx, component1.DiseaseCount));
                ...
                storageLabel.GetComponentInChildren<LocText>().text = str3;
    ...
    string id)
  {
    ...
    {
      gameObject = Util.KInstantiate(this.attributesLabelButtonTemplate, panel.GetComponent<CollapsibleDetailContentPanel>().Content.gameObject);
  ...
  {
    MinionIdentity identity = (UnityEngine.Object) this.selectedTarget != (UnityEngine.Object) null ? this.selectedTarget.GetComponent<MinionIdentity>() : (MinionIdentity) null;
  ...
  private void ShowAttributes(GameObject target)
  {
    ...
    {
      Descriptor descriptor = new Descriptor(string.Format("{0}: {1}", (object) attributeInstance.Name, (object) attributeInstance.GetFormattedValue()), attributeInstance.GetAttributeValueTooltip());
  ...
  private void SetStamps(GameObject target)
  {
    ...
    int num = (UnityEngine.Object) target.GetComponent<BuildingComplete>() != (UnityEngine.Object) null ? 1 : 0;
  }
