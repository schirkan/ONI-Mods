...
public class MinionStatsPanel : TargetScreen
{
  ...
  public override bool IsValidForTarget(GameObject target) => (bool) (UnityEngine.Object) target.GetComponent<MinionIdentity>();

  protected override void OnPrefabInit()
  {
    base.OnPrefabInit();
    this.resumePanel = Util.KInstantiateUI(ScreenPrefabs.Instance.CollapsableContentPanel, this.gameObject);
    this.attributesPanel = Util.KInstantiateUI(ScreenPrefabs.Instance.CollapsableContentPanel, this.gameObject);
  ...
  private void ScheduleUpdate() => this.updateHandle = UIScheduler.Instance.Schedule("RefreshMinionStatsPanel", 1f, (System.Action<object>) (o =>
  {
    this.Refresh();
    this.ScheduleUpdate();
