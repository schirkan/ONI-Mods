...
public class DesalinatorConfig : IBuildingConfig
{
  ...
  public override void ConfigureBuildingTemplate(GameObject go, Tag prefab_tag)
  {
    ...
    {
      new ElementConverter.OutputElement(3.5f, SimHashes.Water, 313.15f, storeOutput: true, diseaseWeight: 0.75f),
      new ElementConverter.OutputElement(1.5f, SimHashes.Salt, 313.15f, storeOutput: true, diseaseWeight: 0.25f)
    };
