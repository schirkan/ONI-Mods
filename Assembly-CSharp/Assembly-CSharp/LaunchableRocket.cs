...
public class LaunchableRocket : StateMachineComponent<LaunchableRocket.StatesInstance>
{
  ...
  public class StatesInstance : GameStateMachine<LaunchableRocket.States, LaunchableRocket.StatesInstance, LaunchableRocket, object>.GameInstance
  {
    ...
    public bool IsMissionState(Spacecraft.MissionState state) => SpacecraftManager.instance.GetSpacecraftFromLaunchConditionManager(this.master.GetComponent<LaunchConditionManager>()).state == state;

    public void SetMissionState(Spacecraft.MissionState state) => SpacecraftManager.instance.GetSpacecraftFromLaunchConditionManager(this.master.GetComponent<LaunchConditionManager>()).SetState(state);
  }
  ...
  public class States : GameStateMachine<LaunchableRocket.States, LaunchableRocket.StatesInstance, LaunchableRocket>
  {
    ...
    public override void InitializeStates(out StateMachine.BaseState default_state)
    {
      ...
      this.grounded.EventTransition(GameHashes.LaunchRocket, this.not_grounded.launch_pre).Enter((StateMachine<LaunchableRocket.States, LaunchableRocket.StatesInstance, LaunchableRocket, object>.State.Callback) (smi =>
      {
      ...
      this.not_grounded.launch_loop.EventTransition(GameHashes.ReturnRocket, this.not_grounded.returning).Update((System.Action<LaunchableRocket.StatesInstance, float>) ((smi, dt) =>
      {
        smi.master.isLanding = false;
        bool flag = true;
  ...
  private class UpdateRocketLandingParameter : LoopingSoundParameterUpdater
  {
    ...
    public override void Add(LoopingSoundParameterUpdater.Sound sound) => this.entries.Add(new LaunchableRocket.UpdateRocketLandingParameter.Entry()
    {
        ...
        if (!((UnityEngine.Object) entry.rocketModule == (UnityEngine.Object) null))
        {
          ...
          if (!((UnityEngine.Object) conditionManager == (UnityEngine.Object) null))
          {
            ...
            if (!((UnityEngine.Object) component == (UnityEngine.Object) null))
            {
              ...
              {
                ev = entry.ev;
                int num = (int) ev.setParameterValueByIndex(entry.parameterIdx, 1f);
              }
              else
              {
                ev = entry.ev;
                int num = (int) ev.setParameterValueByIndex(entry.parameterIdx, 0.0f);
              }
            }
          }
        }
  ...
  private class UpdateRocketSpeedParameter : LoopingSoundParameterUpdater
  {
    ...
    public override void Add(LoopingSoundParameterUpdater.Sound sound) => this.entries.Add(new LaunchableRocket.UpdateRocketSpeedParameter.Entry()
    {
      rocketModule = sound.transform.GetComponent<RocketModule>(),
      ev = sound.ev,
      parameterIdx = sound.description.GetParameterIdx(this.parameter)
