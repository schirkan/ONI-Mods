...
public class RustDeoxidizerConfig : IBuildingConfig
{
  ...
  private const float CHLORINE_CONVERSION_RATIO = 0.02999997f;
  ...
  public override void ConfigureBuildingTemplate(GameObject go, Tag prefab_tag)
  {
    ...
    elementConverter.outputElements = new ElementConverter.OutputElement[3]
    {
      ...
      new ElementConverter.OutputElement(0.02999997f, SimHashes.ChlorineGas, 348.15f, outputElementOffsety: 1f),
