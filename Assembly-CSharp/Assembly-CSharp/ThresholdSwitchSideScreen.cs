...
public class ThresholdSwitchSideScreen : SideScreenContent, IRender200ms
{
  ...
  private void UpdateLabels() => this.currentValue.text = string.Format((string) UI.UISIDESCREENS.THRESHOLD_SWITCH_SIDESCREEN.CURRENT_VALUE, (object) this.thresholdSwitch.ThresholdValueName, (object) this.thresholdSwitch.Format(this.thresholdSwitch.CurrentValue, true));

  public override string GetTitle() => (UnityEngine.Object) this.target != (UnityEngine.Object) null ? (string) this.thresholdSwitch.Title : (string) UI.UISIDESCREENS.THRESHOLD_SWITCH_SIDESCREEN.TITLE;
}
