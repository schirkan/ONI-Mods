...
public class RetiredColonyInfoScreen : KModalScreen
{
  ...
  private void RefreshUIScale(object data = null) => this.StartCoroutine(this.DelayedRefreshScale());
  ...
  private IEnumerator DelayedRefreshScale()
  {
    ...
    if ((UnityEngine.Object) GameObject.Find("ScreenSpaceOverlayCanvas") != (UnityEngine.Object) null)
    {
      ...
      Rect rect = this.colonyScroll.rectTransform().rect;
  ...
  private bool LoadSlideshow(RetiredColonyData data)
  {
    ...
    return this.currentSlideshowFiles != null && (uint) this.currentSlideshowFiles.Length > 0U;
  }
  ...
  private void CorrectTimelapseImageSize(Sprite sprite)
  {
    ...
    double x;
    float num1 = (float) (x = (double) fittedSize.x);
    component.preferredWidth = (float) x;
    component.minWidth = num1;
    double y;
    float num2 = (float) (y = (double) fittedSize.y);
    component.preferredHeight = (float) y;
