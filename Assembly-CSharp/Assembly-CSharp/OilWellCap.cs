...
public class OilWellCap : Workable, ISingleSliderControl, ISliderControl, IElementEmitter
{
  ...
  string ISliderControl.GetSliderTooltip() => string.Format((string) Strings.Get("STRINGS.UI.UISIDESCREENS.OIL_WELL_CAP_SIDE_SCREEN.TOOLTIP"), (object) (float) ((double) this.depressurizePercent * 100.0));
  ...
  public class States : GameStateMachine<OilWellCap.States, OilWellCap.StatesInstance, OilWellCap>
  {
    ...
    public override void InitializeStates(out StateMachine.BaseState default_state)
    {
      ...
      this.root.ToggleRecurringChore((Func<OilWellCap.StatesInstance, Chore>) (smi => (Chore) smi.master.CreateWorkChore()));
      this.idle.PlayAnim("off").ToggleStatusItem(Db.Get().BuildingStatusItems.WellPressurizing).ParamTransition<float>((StateMachine<OilWellCap.States, OilWellCap.StatesInstance, OilWellCap, object>.Parameter<float>) this.pressurePercent, this.overpressure, GameStateMachine<OilWellCap.States, OilWellCap.StatesInstance, OilWellCap, object>.IsGTEOne).ParamTransition<bool>((StateMachine<OilWellCap.States, OilWellCap.StatesInstance, OilWellCap, object>.Parameter<bool>) this.working, (GameStateMachine<OilWellCap.States, OilWellCap.StatesInstance, OilWellCap, object>.State) this.releasing_pressure, GameStateMachine<OilWellCap.States, OilWellCap.StatesInstance, OilWellCap, object>.IsTrue).EventTransition(GameHashes.OperationalChanged, (GameStateMachine<OilWellCap.States, OilWellCap.StatesInstance, OilWellCap, object>.State) this.active, (StateMachine<OilWellCap.States, OilWellCap.StatesInstance, OilWellCap, object>.Transition.ConditionCallback) (smi => smi.master.operational.IsOperational));
      this.active.DefaultState(this.active.pre).ToggleStatusItem(Db.Get().BuildingStatusItems.WellPressurizing).EventTransition(GameHashes.OperationalChanged, this.idle, (StateMachine<OilWellCap.States, OilWellCap.StatesInstance, OilWellCap, object>.Transition.ConditionCallback) (smi => !smi.master.operational.IsOperational)).Enter((StateMachine<OilWellCap.States, OilWellCap.StatesInstance, OilWellCap, object>.State.Callback) (smi => smi.master.operational.SetActive(true))).Exit((StateMachine<OilWellCap.States, OilWellCap.StatesInstance, OilWellCap, object>.State.Callback) (smi => smi.master.operational.SetActive(false))).Update((System.Action<OilWellCap.StatesInstance, float>) ((smi, dt) => smi.master.AddGasPressure(dt)));
