...
public class InfoDialogScreen : KModalScreen
{
  ...
  {
    Util.KInstantiateUI(this.plainTextTemplate.gameObject, this.contentContainer).GetComponent<InfoScreenPlainText>().SetText(text);
    return this;
  }

  public InfoDialogScreen AddLineItem(string text, string tooltip)
  {
    InfoScreenLineItem component = Util.KInstantiateUI(this.lineItemTemplate.gameObject, this.contentContainer).GetComponent<InfoScreenLineItem>();
  ...
  {
    Util.KInstantiateUI(this.subHeaderTemplate.gameObject, this.contentContainer).GetComponent<InfoScreenPlainText>().SetText(text);
    return this;
  }
  ...
  public void OnSelect_OK() => this.Deactivate();
}
