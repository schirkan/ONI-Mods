...
public class LiquidCooledFan : StateMachineComponent<LiquidCooledFan.StatesInstance>, IGameObjectEffectDescriptor
{
  ...
  private void CoolContents(float dt)
  {
    ...
    this.liquidStorage.ConsumeAndGetDisease(GameTags.Water, amount, out disease_info, out float _);
  ...
  public class States : GameStateMachine<LiquidCooledFan.States, LiquidCooledFan.StatesInstance, LiquidCooledFan>
  {
    ...
    public override void InitializeStates(out StateMachine.BaseState default_state)
    {
      ...
      this.work_pst.Update("LiquidFanEmitCooledContents", (System.Action<LiquidCooledFan.StatesInstance, float>) ((smi, dt) => smi.master.EmitContents())).ScheduleGoTo(2f, (StateMachine.BaseState) this.unworkable);
      this.unworkable.Update("LiquidFanEmitCooledContents", (System.Action<LiquidCooledFan.StatesInstance, float>) ((smi, dt) => smi.master.EmitContents())).Update("LiquidFanUnworkableStatusItems", (System.Action<LiquidCooledFan.StatesInstance, float>) ((smi, dt) => smi.master.UpdateUnworkableStatusItems())).Transition(this.workable.waiting, (StateMachine<LiquidCooledFan.States, LiquidCooledFan.StatesInstance, LiquidCooledFan, object>.Transition.ConditionCallback) (smi => smi.IsWorkable())).Enter((StateMachine<LiquidCooledFan.States, LiquidCooledFan.StatesInstance, LiquidCooledFan, object>.State.Callback) (smi => smi.master.UpdateUnworkableStatusItems())).Exit((StateMachine<LiquidCooledFan.States, LiquidCooledFan.StatesInstance, LiquidCooledFan, object>.State.Callback) (smi => smi.master.UpdateUnworkableStatusItems()));
