...
public class LadderDiseaseTransitionLayer : TransitionDriver.OverrideLayer
{
  ...
  public override void BeginTransition(Navigator navigator, Navigator.ActiveTransition transition) => base.BeginTransition(navigator, transition);

  public override void UpdateTransition(Navigator navigator, Navigator.ActiveTransition transition) => base.UpdateTransition(navigator, transition);
