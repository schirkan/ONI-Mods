...
public class SleepChore : Chore<SleepChore.StatesInstance>
{
  ...
  public static bool IsLightLevelOk(int cell) => Grid.LightIntensity[cell] <= 0;
  ...
  public class StatesInstance : GameStateMachine<SleepChore.States, SleepChore.StatesInstance, SleepChore, object>.GameInstance
  {
    ...
    public bool IsLoudSleeper() => (UnityEngine.Object) this.sm.sleeper.Get(this.smi).GetComponent<Snorer>() != (UnityEngine.Object) null;
