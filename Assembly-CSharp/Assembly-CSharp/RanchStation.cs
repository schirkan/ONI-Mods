...
public class RanchStation : GameStateMachine<RanchStation, RanchStation.Instance, IStateMachineTarget, RanchStation.Def>
{
  ...
  public override void InitializeStates(out StateMachine.BaseState default_state)
  {
    ...
    this.operational.TagTransition(GameTags.Operational, this.unoperational, true).ToggleChore((Func<RanchStation.Instance, Chore>) (smi => smi.CreateChore()), this.unoperational, this.unoperational).Update("FindRanachable", (System.Action<RanchStation.Instance, float>) ((smi, dt) => smi.FindRanchable()), UpdateRate.SIM_1000ms);
  }
  ...
  public new class Instance : GameStateMachine<RanchStation, RanchStation.Instance, IStateMachineTarget, RanchStation.Def>.GameInstance
  {
    ...
    public Chore CreateChore() => (Chore) new RancherChore(this.GetComponent<KPrefabID>());
    ...
    public void SetRancherIsAvailableForRanching() => this.shouldCreatureGoGetRanched = true;

    public void ClearRancherIsAvailableForRanching() => this.shouldCreatureGoGetRanched = false;
    ...
    public void TriggerRanchStationNoLongerAvailable()
    {
      ...
      this.targetRanchable.Trigger(1689625967);
    ...
    public void RanchCreature()
    {
      ...
      this.targetRanchable.Trigger(1827504087);
    }
  }
}
