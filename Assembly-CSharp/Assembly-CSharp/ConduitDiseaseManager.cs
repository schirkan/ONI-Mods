...
public class ConduitDiseaseManager : KCompactedVector<ConduitDiseaseManager.Data>
{
  ...
  private static ElemGrowthInfo GetGrowthInfo(byte disease_idx, byte elem_idx) => disease_idx == byte.MaxValue ? Klei.AI.Disease.DEFAULT_GROWTH_INFO : Db.Get().Diseases[(int) disease_idx].elemGrowthInfo[(int) elem_idx];
