...
public class IncubatingStates : GameStateMachine<IncubatingStates, IncubatingStates.Instance, IStateMachineTarget, IncubatingStates.Def>
{
  ...
  public override void InitializeStates(out StateMachine.BaseState default_state)
  {
    ...
    this.root.ToggleStatusItem((string) CREATURES.STATUSITEMS.IN_INCUBATOR.NAME, (string) CREATURES.STATUSITEMS.IN_INCUBATOR.TOOLTIP, category: Db.Get().StatusItemCategories.Main);
