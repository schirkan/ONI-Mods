...
public class ComplexFabricatorSM : StateMachineComponent<ComplexFabricatorSM.StatesInstance>
{
  ...
  public class States : GameStateMachine<ComplexFabricatorSM.States, ComplexFabricatorSM.StatesInstance, ComplexFabricatorSM>
  {
    ...
    public override void InitializeStates(out StateMachine.BaseState default_state)
    {
      ...
      this.idle.waitingForWorker.ToggleStatusItem(Db.Get().BuildingStatusItems.PendingWork).EventTransition(GameHashes.FabricatorOrdersUpdated, this.idle.idleQueue, (StateMachine<ComplexFabricatorSM.States, ComplexFabricatorSM.StatesInstance, ComplexFabricatorSM, object>.Transition.ConditionCallback) (smi => !smi.master.fabricator.WaitingForWorker)).EnterTransition((GameStateMachine<ComplexFabricatorSM.States, ComplexFabricatorSM.StatesInstance, ComplexFabricatorSM, object>.State) this.operating, (StateMachine<ComplexFabricatorSM.States, ComplexFabricatorSM.StatesInstance, ComplexFabricatorSM, object>.Transition.ConditionCallback) (smi => !smi.master.fabricator.duplicantOperated));
