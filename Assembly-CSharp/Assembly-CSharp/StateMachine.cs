...
public abstract class StateMachine
{
  ...
  public abstract class Instance
  {
    ...
    public void GoTo(string state_name) => this.GoTo(this.stateMachine.GetState(state_name));
    ...
    public void Trigger(int hash, object data = null) => this.GetMaster().GetComponent<KPrefabID>().Trigger(hash, data);
