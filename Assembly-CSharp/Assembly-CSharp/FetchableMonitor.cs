...
public class FetchableMonitor : GameStateMachine<FetchableMonitor, FetchableMonitor.Instance>
{
  ...
  private void UpdateStorage(FetchableMonitor.Instance smi, object data) => Game.Instance.fetchManager.UpdateStorage(smi.pickupable.PrefabID(), smi.fetchable, data as Storage);

  private void UpdateTags(FetchableMonitor.Instance smi, object data) => Game.Instance.fetchManager.UpdateTags(smi.pickupable.PrefabID(), smi.fetchable);
  ...
  public new class Instance : GameStateMachine<FetchableMonitor, FetchableMonitor.Instance, IStateMachineTarget, object>.GameInstance
  {
    ...
    public bool IsFetchable() => !this.sm.forceUnfetchable.Get(this) && !this.pickupable.IsEntombed && this.pickupable.IsReachable() && ((!((Object) this.equippable != (Object) null) || !this.equippable.isEquipped) && !this.pickupable.HasTag(GameTags.StoredPrivate));
  }
}
