...
public class CrabConfig : IEntityConfig
{
  ...
  public static GameObject CreateCrab(
    ...
    string deathDropID)
  {
    GameObject wildCreature = EntityTemplates.ExtendEntityToWildCreature(BaseCrabConfig.BaseCrab(id, name, desc, anim_file, "CrabBaseTrait", is_baby, onDeathDropID: deathDropID), CrabTuning.PEN_SIZE_PER_CREATURE, 100f);
