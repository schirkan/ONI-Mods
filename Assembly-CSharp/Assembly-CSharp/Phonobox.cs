...
public class Phonobox : StateMachineComponent<Phonobox.StatesInstance>, IGameObjectEffectDescriptor
{
  ...
  private Chore CreateChore(int i)
  {
    ...
    WorkChore<PhonoboxWorkable> workChore = new WorkChore<PhonoboxWorkable>(relax, (IStateMachineTarget) workable2, on_end: on_end, allow_in_red_alert: false, schedule_block: schedule_block, allow_prioritization: false, priority_class: PriorityScreen.PriorityClass.high);
