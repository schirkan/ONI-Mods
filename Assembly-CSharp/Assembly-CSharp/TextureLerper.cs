...
public class TextureLerper
{
  ...
  private Vector4 GetVisibleCellRange()
  {
    ...
    Vector3 pos = Grid.CellToPos(cell, (float) num2, (float) num3, (float) num4);
    int num5 = Math.Max(0, (int) ((double) pos.x / (double) cellSizeInMeters));
    int num6 = Math.Max(0, (int) ((double) pos.y / (double) cellSizeInMeters));
    ...
    int num7 = Mathf.Min(a1, Grid.WidthInCells - 1);
    int num8 = Mathf.Min(a2, Grid.HeightInCells - 1);
    return new Vector4((float) num5, (float) num6, (float) num7, (float) num8);
  }
}
