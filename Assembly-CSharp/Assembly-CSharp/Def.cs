    ...
    bool centered = false)
  {
    switch (item)
    {
      ...
      case Element _:
        ...
        return (item as Element).IsGas ? new Tuple<Sprite, Color>(Assets.GetSprite((HashedString) "element_gas"), (Color) (item as Element).substance.uiColour) : new Tuple<Sprite, Color>((Sprite) null, Color.clear);
      case GameObject _:
