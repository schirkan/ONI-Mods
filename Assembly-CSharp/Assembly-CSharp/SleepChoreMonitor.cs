...
public class SleepChoreMonitor : GameStateMachine<SleepChoreMonitor, SleepChoreMonitor.Instance>
{
  ...
  public override void InitializeStates(out StateMachine.BaseState default_state)
  {
    ...
    this.sleeponfloor.EventTransition(GameHashes.AssignablesChanged, this.checkforbed).EventTransition(GameHashes.AssignableReachabilityChanged, this.checkforbed, (StateMachine<SleepChoreMonitor, SleepChoreMonitor.Instance, IStateMachineTarget, object>.Transition.ConditionCallback) (smi => smi.IsBedReachable())).ToggleChore(new Func<SleepChoreMonitor.Instance, Chore>(this.CreateSleepOnFloorChore), this.satisfied, this.satisfied);
