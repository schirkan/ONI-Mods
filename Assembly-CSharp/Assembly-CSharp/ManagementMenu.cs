...
public class ManagementMenu : KIconToggleMenu
{
  ...
  protected override void OnPrefabInit()
  {
    ...
    this.consumablesInfo = new KIconToggleMenu.ToggleInfo((string) UI.CONSUMABLES, "OverviewUI_consumables_icon", hotkey: Action.ManageConsumables, tooltip: ((string) UI.TOOLTIPS.MANAGEMENTMENU_CONSUMABLES));
    this.vitalsInfo = new KIconToggleMenu.ToggleInfo((string) UI.VITALS, "OverviewUI_vitals_icon", hotkey: Action.ManageVitals, tooltip: ((string) UI.TOOLTIPS.MANAGEMENTMENU_VITALS));
    this.reportsInfo = new KIconToggleMenu.ToggleInfo((string) UI.REPORT, "OverviewUI_reports_icon", hotkey: Action.ManageReport, tooltip: ((string) UI.TOOLTIPS.MANAGEMENTMENU_DAILYREPORT));
    this.reportsInfo.prefabOverride = this.smallPrefab;
    this.researchInfo = new KIconToggleMenu.ToggleInfo((string) UI.RESEARCH, "OverviewUI_research_nav_icon", hotkey: Action.ManageResearch, tooltip: ((string) UI.TOOLTIPS.MANAGEMENTMENU_RESEARCH));
    this.jobsInfo = new KIconToggleMenu.ToggleInfo((string) UI.JOBS, "OverviewUI_priority_icon", hotkey: Action.ManagePriorities, tooltip: ((string) UI.TOOLTIPS.MANAGEMENTMENU_JOBS));
    this.skillsInfo = new KIconToggleMenu.ToggleInfo((string) UI.SKILLS, "OverviewUI_jobs_icon", hotkey: Action.ManageSkills, tooltip: ((string) UI.TOOLTIPS.MANAGEMENTMENU_SKILLS));
    this.starmapInfo = new KIconToggleMenu.ToggleInfo((string) UI.STARMAP.MANAGEMENT_BUTTON, "OverviewUI_starmap_icon", hotkey: Action.ManageStarmap, tooltip: ((string) UI.TOOLTIPS.MANAGEMENTMENU_STARMAP));
    this.codexInfo = new KIconToggleMenu.ToggleInfo((string) UI.CODEX.MANAGEMENT_BUTTON, "OverviewUI_database_icon", hotkey: Action.ManageDatabase, tooltip: ((string) UI.TOOLTIPS.MANAGEMENTMENU_CODEX));
    this.codexInfo.prefabOverride = this.smallPrefab;
    this.scheduleInfo = new KIconToggleMenu.ToggleInfo((string) UI.SCHEDULE, "OverviewUI_schedule2_icon", hotkey: Action.ManageSchedule, tooltip: ((string) UI.TOOLTIPS.MANAGEMENTMENU_SCHEDULE));
  ...
  public void CheckResearch(object o)
  {
    ...
    string tooltip = disabled ? this.researchTooltipDisabled : this.researchTooltip;
  ...
  public void CheckSkills(object o = null)
  {
    ...
    string tooltip = disabled ? this.skillsTooltipDisabled : this.skillsTooltip;
  ...
  public void CheckStarmap(object o = null)
  {
    ...
    string tooltip = disabled ? this.starmapTooltipDisabled : this.starmapTooltip;
  ...
  private bool StarmapAvailable() => Components.Telescopes.Count > 0 || DebugHandler.InstantBuildMode;
  ...
  public void ToggleScreen(ManagementMenu.ScreenData screenData)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        AudioMixer.instance.Stop((HashedString) AudioMixerSnapshots.Get().MenuOpenMigrated);
        this.activeScreen.toggleInfo.toggle.ActivateFlourish(false);
  ...
  public void OnButtonClick(KIconToggleMenu.ToggleInfo toggle_info) => this.ToggleScreen(this.ScreenInfoMatch[toggle_info]);
