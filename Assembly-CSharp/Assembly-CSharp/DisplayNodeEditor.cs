...
public class DisplayNodeEditor : BaseNodeEditor
{
  ...
  public override System.Type GetObjectType => typeof (DisplayNodeEditor);

  public override NoiseBase GetTarget() => (NoiseBase) null;
  ...
  public override bool Calculate()
  {
    ...
    float[] noise = WorldGen.GenerateNoise(Vector2.zero, this.settings.zoom, nmbp, 256, 256);
