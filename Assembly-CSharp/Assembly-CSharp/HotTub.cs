...
public class HotTub : StateMachineComponent<HotTub.StatesInstance>, IGameObjectEffectDescriptor
{
  ...
  protected override void OnSpawn()
  {
    ...
    for (int index = 0; index < this.workables.Length; ++index)
    {
      ...
      hotTubWorkable2.OnWorkableEventCB = hotTubWorkable2.OnWorkableEventCB + (System.Action<Workable.WorkableEvent>) (ev => this.OnWorkableEvent(player_index, ev));
  ...
  private Chore CreateChore(int i)
  {
    ...
    WorkChore<HotTubWorkable> workChore = new WorkChore<HotTubWorkable>(relax, (IStateMachineTarget) workable2, on_end: on_end, allow_in_red_alert: false, schedule_block: schedule_block, allow_prioritization: false, priority_class: PriorityScreen.PriorityClass.high);
  ...
  public class States : GameStateMachine<HotTub.States, HotTub.StatesInstance, HotTub>
  {
    ...
    public override void InitializeStates(out StateMachine.BaseState default_state)
    {
      ...
      this.root.Update((System.Action<HotTub.StatesInstance, float>) ((smi, dt) =>
      {
  ...
  public class StatesInstance : GameStateMachine<HotTub.States, HotTub.StatesInstance, HotTub, object>.GameInstance
  {
    ...
    public bool IsTubTooHot() => (double) this.smi.master.GetComponent<PrimaryElement>().Temperature > (double) this.smi.master.maxOperatingTemperature;
