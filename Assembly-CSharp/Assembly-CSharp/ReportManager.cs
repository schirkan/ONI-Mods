...
public class ReportManager : KMonoBehaviour
{
  ...
  public Dictionary<ReportManager.ReportType, ReportManager.ReportGroup> ReportGroups = new Dictionary<ReportManager.ReportType, ReportManager.ReportGroup>()
  {
    ...
    },
    {
      ...
      new ReportManager.ReportGroup((ReportManager.FormattingFn) (v => GameUtil.GetFormattedDiseaseAmount((int) v)), true, 1, (string) UI.ENDOFDAYREPORT.DISEASE_STATUS.NAME, (string) UI.ENDOFDAYREPORT.DISEASE_STATUS.TOOLTIP, "", ReportManager.ReportEntry.Order.Descending, ReportManager.ReportEntry.Order.Descending)
    },
    {
      ReportManager.ReportType.LevelUp,
      new ReportManager.ReportGroup((ReportManager.FormattingFn) null, false, 1, (string) UI.ENDOFDAYREPORT.LEVEL_UP.NAME, (string) UI.ENDOFDAYREPORT.LEVEL_UP.TOOLTIP, "", ReportManager.ReportEntry.Order.Descending, ReportManager.ReportEntry.Order.Descending)
    },
    {
      ReportManager.ReportType.ToiletIncident,
      new ReportManager.ReportGroup((ReportManager.FormattingFn) null, false, 1, (string) UI.ENDOFDAYREPORT.TOILET_INCIDENT.NAME, (string) UI.ENDOFDAYREPORT.TOILET_INCIDENT.TOOLTIP, "", ReportManager.ReportEntry.Order.Descending, ReportManager.ReportEntry.Order.Descending)
    },
    {
    ...
    },
    {
      ...
      new ReportManager.ReportGroup((ReportManager.FormattingFn) (v => GameUtil.GetFormattedPercent((float) ((double) v / 600.0 * 100.0))), true, 2, (string) UI.ENDOFDAYREPORT.WORK_TIME.NAME, (string) UI.ENDOFDAYREPORT.WORK_TIME.POSITIVE_TOOLTIP, "", ReportManager.ReportEntry.Order.Descending, ReportManager.ReportEntry.Order.Descending, group_format_fn: ((ReportManager.GroupFormattingFn) ((v, num_entries) => GameUtil.GetFormattedPercent((float) ((double) v / 600.0 * 100.0) / num_entries))))
    },
    {
      ReportManager.ReportType.TravelTime,
      new ReportManager.ReportGroup((ReportManager.FormattingFn) (v => GameUtil.GetFormattedPercent((float) ((double) v / 600.0 * 100.0))), true, 2, (string) UI.ENDOFDAYREPORT.TRAVEL_TIME.NAME, (string) UI.ENDOFDAYREPORT.TRAVEL_TIME.POSITIVE_TOOLTIP, "", ReportManager.ReportEntry.Order.Descending, ReportManager.ReportEntry.Order.Descending, group_format_fn: ((ReportManager.GroupFormattingFn) ((v, num_entries) => GameUtil.GetFormattedPercent((float) ((double) v / 600.0 * 100.0) / num_entries))))
    },
    {
      ReportManager.ReportType.PersonalTime,
      new ReportManager.ReportGroup((ReportManager.FormattingFn) (v => GameUtil.GetFormattedPercent((float) ((double) v / 600.0 * 100.0))), true, 2, (string) UI.ENDOFDAYREPORT.PERSONAL_TIME.NAME, (string) UI.ENDOFDAYREPORT.PERSONAL_TIME.POSITIVE_TOOLTIP, "", ReportManager.ReportEntry.Order.Descending, ReportManager.ReportEntry.Order.Descending, group_format_fn: ((ReportManager.GroupFormattingFn) ((v, num_entries) => GameUtil.GetFormattedPercent((float) ((double) v / 600.0 * 100.0) / num_entries))))
    },
    {
      ReportManager.ReportType.IdleTime,
      new ReportManager.ReportGroup((ReportManager.FormattingFn) (v => GameUtil.GetFormattedPercent((float) ((double) v / 600.0 * 100.0))), true, 2, (string) UI.ENDOFDAYREPORT.IDLE_TIME.NAME, (string) UI.ENDOFDAYREPORT.IDLE_TIME.POSITIVE_TOOLTIP, "", ReportManager.ReportEntry.Order.Descending, ReportManager.ReportEntry.Order.Descending, group_format_fn: ((ReportManager.GroupFormattingFn) ((v, num_entries) => GameUtil.GetFormattedPercent((float) ((double) v / 600.0 * 100.0) / num_entries))))
    },
    {
    ...
    },
    {
      ...
      new ReportManager.ReportGroup(new ReportManager.FormattingFn(GameUtil.GetFormattedRoundedJoules), true, 3, (string) UI.ENDOFDAYREPORT.ENERGY_WASTED.NAME, (string) UI.ENDOFDAYREPORT.ENERGY_WASTED.POSITIVE_TOOLTIP, (string) UI.ENDOFDAYREPORT.ENERGY_WASTED.NEGATIVE_TOOLTIP, ReportManager.ReportEntry.Order.Descending, ReportManager.ReportEntry.Order.Descending)
    },
    {
  ...
  public class ReportEntry
  {
    ...
    public void IterateNotes(System.Action<ReportManager.ReportEntry.Note> callback) => ReportManager.Instance.noteStorage.IterateNotes(this.noteStorageId, callback);
  ...
  public class DailyReport
  {
    ...
    public ReportManager.ReportEntry GetEntry(ReportManager.ReportType reportType)
    {
      ...
      ReportManager.ReportEntry reportEntry1 = new ReportManager.ReportEntry(reportType, this.noteStorage.GetNewNoteId(), (string) null);
  ...
  public class NoteStorage
  {
    ...
    public void IterateNotes(int report_entry_id, System.Action<ReportManager.ReportEntry.Note> callback) => this.noteEntries.IterateNotes(this.stringTable, report_entry_id, callback);
    ...
    private class StringTable
    {
      ...
      {
        string str = "";
        this.strings.TryGetValue(hash, out str);
        return str;
      }
