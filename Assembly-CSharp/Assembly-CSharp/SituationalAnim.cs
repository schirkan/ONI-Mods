...
public class SituationalAnim : KMonoBehaviour
{
  ...
  private void SetAnim(string animName) => this.GetComponent<KBatchedAnimController>().Play((HashedString) animName);
    ...
    SituationalAnim.MustSatisfy requirement)
  {
    ...
    return requirement == SituationalAnim.MustSatisfy.Any ? (uint) result > 0U : result == SituationalAnim.MustSatisfy.None;
  }
