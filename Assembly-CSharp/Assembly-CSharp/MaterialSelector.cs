...
public class MaterialSelector : KScreen
{
  ...
  public void RefreshToggleContents()
  {
    foreach (KeyValuePair<Tag, KToggle> elementToggle in this.ElementToggles)
    {
      ...
      string str = Util.FormatWholeNumber(WorldInventory.Instance.GetAmount(elem));
      locText2.text = str;
  ...
  private bool IsEnoughMass(Tag t) => (double) WorldInventory.Instance.GetAmount(t) >= (double) this.activeMass || DebugHandler.InstantBuildMode || Game.Instance.SandboxModeActive || MaterialSelector.AllowInsufficientMaterialBuild();
  ...
  private void UpdateHeader()
  {
    ...
    if (num == 0)
    {
      componentInChildren.text = string.Format((string) STRINGS.UI.PRODUCTINFO_MISSINGRESOURCES_TITLE, (object) this.activeIngredient.tag.ProperName(), (object) GameUtil.GetFormattedMass(this.activeIngredient.amount));
  ...
  private int ElementSorter(Tag at, Tag bt)
  {
    ...
    IHasSortOrder hasSortOrder1 = (UnityEngine.Object) prefab1 != (UnityEngine.Object) null ? prefab1.GetComponent<IHasSortOrder>() : (IHasSortOrder) null;
    GameObject prefab2 = Assets.TryGetPrefab(bt);
    IHasSortOrder hasSortOrder2 = (UnityEngine.Object) prefab2 != (UnityEngine.Object) null ? prefab2.GetComponent<IHasSortOrder>() : (IHasSortOrder) null;
