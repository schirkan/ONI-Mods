...
namespace Rendering.World
{
  public abstract class TileRenderer : KMonoBehaviour
  {
    ...
    protected override void OnSpawn()
    {
      ...
      this.LoadBrushes();
      this.VisibleAreaUpdater = new VisibleAreaUpdater(new System.Action<int>(this.UpdateOutsideView), new System.Action<int>(this.UpdateInsideView), (System.Action<int>) null, (System.Action<int>) null, nameof (TileRenderer));
    }
