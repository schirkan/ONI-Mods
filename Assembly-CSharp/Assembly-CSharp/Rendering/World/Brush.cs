...
namespace Rendering.World
{
  public class Brush
  {
    ...
    public void Refresh()
    {
      bool flag = (uint) this.mesh.Meshes.Length > 0U;
    ...
    public void Render() => this.mesh.Render(new Vector3(0.0f, 0.0f, Grid.GetLayerZ(Grid.SceneLayer.Ground)), Quaternion.identity, this.material, this.layer, this.propertyBlock);
