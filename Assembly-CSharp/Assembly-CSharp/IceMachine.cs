...
public class IceMachine : StateMachineComponent<IceMachine.StatesInstance>
{
  ...
  {
    int num = !((UnityEngine.Object) this.waterStorage != (UnityEngine.Object) null) ? 0 : ((double) this.waterStorage.GetMassAvailable(SimHashes.Water) >= 0.100000001490116 ? 1 : 0);
