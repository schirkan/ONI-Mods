...
public class PlayerController : KMonoBehaviour, IInputHandler
{
  ...
  protected override void OnSpawn() => this.ActivateTool(this.tools[0]);
  ...
  public bool IsUsingDefaultTool() => (Object) this.activeTool == (Object) this.tools[0];

  private void StartDrag(Action action)
  {
    if (!this.draggingAllowed || this.dragAction != Action.Invalid)
      return;
