...
public class NavGrid
{
  ...
  public void InitializeGraph() => NavGridUpdater.InitializeNavGrid(this.NavTable, this.ValidNavTypes, this.Validators, this.boundingOffsets, this.maxLinksPerCell, this.Links, this.transitionsByNavType);
  ...
  public struct Link
  {
    ...
    {
      get => this._transitionId;
      set => this._transitionId = value;
    }
  ...
  public struct Transition
  {
    ...
    public int IsValid(int cell, NavTable nav_table)
    {
      ...
      int num1 = Grid.OffsetCell(cell, (int) this.x, (int) this.y);
      ...
      if (this.start == NavType.Tube)
      {
        if (this.end == NavType.Tube)
        {
          ...
          TravelTubeUtilityNetworkLink utilityNetworkLink1 = (bool) (UnityEngine.Object) gameObject1 ? gameObject1.GetComponent<TravelTubeUtilityNetworkLink>() : (TravelTubeUtilityNetworkLink) null;
          TravelTubeUtilityNetworkLink utilityNetworkLink2 = (bool) (UnityEngine.Object) gameObject2 ? gameObject2.GetComponent<TravelTubeUtilityNetworkLink>() : (TravelTubeUtilityNetworkLink) null;
          if ((bool) (UnityEngine.Object) utilityNetworkLink1)
          {
            ...
            if (num1 != linked_cell1 && num1 != linked_cell2)
              return Grid.InvalidCell;
            UtilityConnections cell1 = UtilityConnectionsExtensions.DirectionFromToCell(cell, num1);
            if (cell1 == (UtilityConnections) 0 || Game.Instance.travelTubeSystem.GetConnections(num1, false) != cell1)
              return Grid.InvalidCell;
          }
          else if ((bool) (UnityEngine.Object) utilityNetworkLink2)
          {
            ...
            if (cell != linked_cell1 && cell != linked_cell2)
              return Grid.InvalidCell;
            UtilityConnections cell1 = UtilityConnectionsExtensions.DirectionFromToCell(num1, cell);
          ...
          else
          {
            ...
            for (int index1 = 0; index1 < 2; ++index1)
            {
              if ((!flag || index1 != 0 ? (flag ? 0 : (index1 == 1 ? 1 : 0)) : 1) != 0)
              {
                ...
                for (int index2 = 0; index2 < Mathf.Abs((int) this.x); ++index2)
                {
              ...
              else
              {
                ...
                for (int index2 = 0; index2 < Mathf.Abs((int) this.y); ++index2)
                {
                  UtilityConnections connections = Game.Instance.travelTubeSystem.GetConnections(cell1, false);
