...
public class MonumentSideScreen : SideScreenContent
{
  ...
  public override bool IsValidForTarget(GameObject target) => (UnityEngine.Object) target.GetComponent<MonumentPart>() != (UnityEngine.Object) null;
  ...
  public void GenerateStateButtons()
  {
    ...
    foreach (Tuple<string, string> selectableStatesAndSymbol in this.target.selectableStatesAndSymbols)
    {
      ...
      gameObject.GetComponent<KButton>().fgImage.sprite = Def.GetUISpriteFromMultiObjectAnim(animFile, targetState, symbolName: second);
    }
  }
}
