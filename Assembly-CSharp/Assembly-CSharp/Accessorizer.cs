...
public class Accessorizer : KMonoBehaviour
{
  ...
  private void OnDeserialized() => this.ApplyAccessories();

  public void AddAccessory(Accessory accessory)
  {
    if (accessory == null)
      return;
    this.animController.GetComponent<SymbolOverrideController>().AddSymbolOverride((HashedString) accessory.slot.targetSymbolId, accessory.symbol);
  ...
  public void RemoveAccessory(Accessory accessory)
  {
    ...
    this.animController.GetComponent<SymbolOverrideController>().TryRemoveSymbolOverride((HashedString) accessory.slot.targetSymbolId);
  }
