...
public class AnimEventManager
{
  ...
  public struct EventPlayerData
  {
    ...
    public ComponentType GetComponent<ComponentType>() => this.controller.GetComponent<ComponentType>();
    ...
    public string currentAnimFile => this.controller.currentAnimFile;

    public KAnimHashedString currentAnimFileHash => this.controller.currentAnimFileHash;

    public string currentAnim => this.controller.currentAnim;
