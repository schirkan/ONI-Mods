...
public class ElementLoader
{
    ...
    SubstanceTable substanceTable)
  {
    ...
    elem.substance.nameTag = Array.IndexOf<SimHashes>((SimHashes[]) Enum.GetValues(typeof (SimHashes)), elem.id) < 0 ? (tag_string != null ? TagManager.Create(tag_string) : Tag.Invalid) : GameTagExtensions.Create(elem.id);
