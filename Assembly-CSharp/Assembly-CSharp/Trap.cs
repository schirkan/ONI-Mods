...
public class Trap : StateMachineComponent<Trap.StatesInstance>
{
  ...
  public KPrefabID GetContents() => this.contents.Get();
  ...
  public class StatesInstance : GameStateMachine<Trap.States, Trap.StatesInstance, Trap, object>.GameInstance
  {
    ...
    public void OnCreatureOnTrap(object data)
    {
      ...
      component.Store(cmp.gameObject, true);
    ...
    public void DisableEvents() => GameScenePartitioner.Instance.Free(ref this.partitionerEntry);
  }
  ...
  public class States : GameStateMachine<Trap.States, Trap.StatesInstance, Trap>
  {
    ...
    public override void InitializeStates(out StateMachine.BaseState default_state)
    {
      ...
      Trap.CreateStatusItems();
      this.ready.OnSignal(this.trapTriggered, this.trapping).ToggleStatusItem(Trap.statusReady).Exit((StateMachine<Trap.States, Trap.StatesInstance, Trap, object>.State.Callback) (smi => smi.DisableEvents()));
