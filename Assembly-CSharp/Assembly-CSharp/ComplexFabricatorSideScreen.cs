...
public class ComplexFabricatorSideScreen : SideScreenContent
{
  ...
  public override string GetTitle() => (UnityEngine.Object) this.targetFab == (UnityEngine.Object) null ? Strings.Get(this.titleKey).ToString().Replace("{0}", "") : string.Format((string) Strings.Get(this.titleKey), (object) this.targetFab.GetProperName());

  public override bool IsValidForTarget(GameObject target) => (UnityEngine.Object) target.GetComponent<ComplexFabricator>() != (UnityEngine.Object) null;
  ...
  protected override void OnShow(bool show)
  {
    ...
    {
      AudioMixer.instance.Stop((HashedString) AudioMixerSnapshots.Get().FabricatorSideScreenOpenSnapshot);
    ...
    else
    {
      ...
      foreach (ComplexRecipe recipe1 in this.targetFab.GetRecipes())
      {
        ...
        if (flag1)
        {
          ...
          Tuple<Sprite, Color> uiSprite2 = Def.GetUISprite((object) recipe.results[0].material);
          ...
          switch (target.sideScreenStyle)
          {
            ...
            case ComplexFabricatorSideScreen.StyleSetting.GridInputOutput:
              newToggle = Util.KInstantiateUI<KToggle>(this.recipeButtonMultiple, this.recipeGrid);
              ...
              foreach (ComplexRecipe.RecipeElement ingredient in recipe.ingredients)
              {
                ...
                gameObject.GetComponent<Image>().color = Def.GetUISprite((object) ingredient.material).second;
              ...
              foreach (ComplexRecipe.RecipeElement result in recipe.results)
              {
                ...
                gameObject.GetComponent<Image>().color = Def.GetUISprite((object) result.material).second;
