...
public class SkillMinionWidget : KMonoBehaviour, IPointerEnterHandler, IEventSystemHandler, IPointerExitHandler, IPointerClickHandler
{
  ...
  public void SetMinon(IAssignableIdentity identity)
  {
    ...
    this.portrait.SetIdentityObject(this.minion);
  }
  ...
  public void Refresh()
  {
    ...
    if ((UnityEngine.Object) minion1 != (UnityEngine.Object) null)
    {
      ...
      this.morale.text = string.Format("{0}/{1}", (object) attributeInstance1.GetTotalValue(), (object) attributeInstance2.GetTotalValue());
    ...
    else
    {
      ...
      hat = string.IsNullOrEmpty(minion2.targetHat) ? minion2.currentHat : minion2.targetHat;
  ...
  public void RefreshHat(string hat) => this.GetComponent<HierarchyReferences>().GetReference("selectedHat").GetComponent<Image>().sprite = Assets.GetSprite((HashedString) (string.IsNullOrEmpty(hat) ? "hat_role_none" : hat));
  ...
  private void OnHatDropEntryClick(IListableOption skill, object data)
  {
    ...
    if (this.minion != this.skillsScreen.CurrentlySelectedMinion)
      return;
    this.skillsScreen.selectedHat.sprite = Assets.GetSprite((HashedString) (string.IsNullOrEmpty(component.TargetHat) ? "hat_role_none" : component.TargetHat));
  }
