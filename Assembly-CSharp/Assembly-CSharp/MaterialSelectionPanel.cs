...
public class MaterialSelectionPanel : KScreen
{
  ...
  protected override void OnPrefabInit()
  {
    ...
    this.priorityScreen.InstantiateButtons(new System.Action<PrioritySetting>(this.OnPriorityClicked));
  ...
  public void AddSelectAction(MaterialSelector.SelectMaterialActions action) => this.MaterialSelectors.ForEach((System.Action<MaterialSelector>) (selector => selector.selectMaterialActions += action));

  public void ClearSelectActions() => this.MaterialSelectors.ForEach((System.Action<MaterialSelector>) (selector => selector.selectMaterialActions = (MaterialSelector.SelectMaterialActions) null));

  public void ClearMaterialToggles() => this.MaterialSelectors.ForEach((System.Action<MaterialSelector>) (selector => selector.ClearMaterialToggles()));
  ...
  public void RefreshSelectors()
  {
    ...
    if ((DebugHandler.InstantBuildMode || Game.Instance.SandboxModeActive || techItem == null ? 0 : (!techItem.IsComplete() ? 1 : 0)) != 0)
    {
  ...
  public void UpdateResourceToggleValues() => this.MaterialSelectors.ForEach((System.Action<MaterialSelector>) (selector =>
  {
