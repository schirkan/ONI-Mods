...
public class AssignableSideScreen : SideScreenContent
{
  ...
  public override string GetTitle() => (UnityEngine.Object) this.targetAssignable != (UnityEngine.Object) null ? string.Format(base.GetTitle(), (object) this.targetAssignable.GetProperName()) : base.GetTitle();
  ...
  public override bool IsValidForTarget(GameObject target) => (UnityEngine.Object) target.GetComponent<Assignable>() != (UnityEngine.Object) null;
  ...
  {
    this.ClearContent();
    this.currentOwnerText.text = string.Format((string) UI.UISIDESCREENS.ASSIGNABLESIDESCREEN.UNASSIGNED, (object[]) Array.Empty<object>());
    if ((UnityEngine.Object) this.targetAssignable == (UnityEngine.Object) null)
      return;
