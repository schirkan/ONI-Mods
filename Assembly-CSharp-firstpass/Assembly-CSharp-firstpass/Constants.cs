...
public static class Constants
{
  ...
  public static readonly Color POSITIVE_COLOR = new Color(0.3215686f, 0.7529412f, 0.4745098f);
  public static readonly string POSITIVE_COLOR_STR = "#" + Constants.POSITIVE_COLOR.ToHexString();
  public static readonly Color NEGATIVE_COLOR = new Color(0.9568627f, 0.2901961f, 0.2784314f);
  ...
  public const float AUDIO_HIGHLIGHT_POSITION_INTENSITY = 0.0f;
}
