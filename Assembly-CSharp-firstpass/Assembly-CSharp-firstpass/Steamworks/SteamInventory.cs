...
namespace Steamworks
{
  public static class SteamInventory
  {
    ...
    {
      InteropHelp.TestIfAvailableClient();
      if ((long) pOutItemsArray.Length != (long) punOutItemsArraySize)
    ...
    {
      InteropHelp.TestIfAvailableClient();
      if ((long) pItemDefIDs.Length != (long) punItemDefIDsArraySize)
    ...
    public static SteamAPICall_t RequestEligiblePromoItemDefinitionsIDs(
      CSteamID steamID)
    {
      InteropHelp.TestIfAvailableClient();
    ...
    public static bool GetItemPrice(
      SteamItemDef_t iDefinition,
