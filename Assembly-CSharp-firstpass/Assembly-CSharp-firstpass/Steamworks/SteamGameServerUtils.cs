...
namespace Steamworks
{
  public static class SteamGameServerUtils
  {
    ...
    public static ESteamAPICallFailure GetAPICallFailureReason(
    ...
    public static int FilterText(
      out string pchOutFilteredText,
      uint nByteSizeOutFilteredText,
      string pchInputMessage,
      bool bLegalOnly)
    {
      InteropHelp.TestIfAvailableGameServer();
      IntPtr num1 = Marshal.AllocHGlobal((int) nByteSizeOutFilteredText);
      using (InteropHelp.UTF8StringHandle pchInputMessage1 = new InteropHelp.UTF8StringHandle(pchInputMessage))
      {
        int num2 = NativeMethods.ISteamUtils_FilterText(CSteamGameServerAPIContext.GetSteamUtils(), num1, nByteSizeOutFilteredText, pchInputMessage1, bLegalOnly);
        pchOutFilteredText = num2 != -1 ? InteropHelp.PtrToStringUTF8(num1) : (string) null;
