  ...
  public static class SteamUGC
  {
      ...
      string pchCursor = null)
    {
      ...
      using (InteropHelp.UTF8StringHandle pchCursor1 = new InteropHelp.UTF8StringHandle(pchCursor))
        return (UGCQueryHandle_t) NativeMethods.ISteamUGC_CreateQueryAllUGCRequest0(CSteamAPIContext.GetSteamUGC(), eQueryType, eMatchingeMatchingUGCTypeFileType, nCreatorAppID, nConsumerAppID, pchCursor1);
    }
      ...
      uint cchValueSize)
    {
      ...
      {
        bool queryUgcKeyValueTag0 = NativeMethods.ISteamUGC_GetQueryUGCKeyValueTag0(CSteamAPIContext.GetSteamUGC(), handle, index, pchKey1, num, cchValueSize);
