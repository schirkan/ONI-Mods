...
namespace Steamworks
{
  public static class SteamFriends
  {
    ...
    public static EFriendRelationship GetFriendRelationship(
    ...
    public static void ActivateGameOverlayToWebPage(
      string pchURL,
      EActivateGameOverlayToWebPageMode eMode = EActivateGameOverlayToWebPageMode.k_EActivateGameOverlayToWebPageMode_Default)
    {
      ...
      using (InteropHelp.UTF8StringHandle pchURL1 = new InteropHelp.UTF8StringHandle(pchURL))
        NativeMethods.ISteamFriends_ActivateGameOverlayToWebPage(CSteamAPIContext.GetSteamFriends(), pchURL1, eMode);
    }
