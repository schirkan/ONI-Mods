...
namespace Steamworks
{
  ...
  internal static class NativeMethods
  {
    ...
    [DllImport("sdkencryptedappticket64", CallingConvention = CallingConvention.Cdecl)]
    [return: MarshalAs(UnmanagedType.I1)]
    public static extern bool SteamEncryptedAppTicket_BIsTicketSigned(
      [In, Out] byte[] rgubTicketDecrypted,
      uint cubTicketDecrypted,
      [In, Out] byte[] pubRSAKey,
      uint cubRSAKey);
    ...
    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamApps_GetLaunchCommandLine", CallingConvention = CallingConvention.Cdecl)]
    public static extern int ISteamApps_GetLaunchCommandLine(
      IntPtr instancePtr,
      IntPtr pszCommandLine,
      int cubCommandLine);

    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamApps_BIsSubscribedFromFamilySharing", CallingConvention = CallingConvention.Cdecl)]
    [return: MarshalAs(UnmanagedType.I1)]
    ...
    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamClient_GetISteamGameSearch", CallingConvention = CallingConvention.Cdecl)]
    ...
    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamClient_GetISteamInput", CallingConvention = CallingConvention.Cdecl)]
    public static extern IntPtr ISteamClient_GetISteamInput(
      IntPtr instancePtr,
      HSteamUser hSteamUser,
      HSteamPipe hSteamPipe,
      InteropHelp.UTF8StringHandle pchVersion);

    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamClient_GetISteamParties", CallingConvention = CallingConvention.Cdecl)]
    public static extern IntPtr ISteamClient_GetISteamParties(
      IntPtr instancePtr,
      HSteamUser hSteamUser,
      HSteamPipe hSteamPipe,
      InteropHelp.UTF8StringHandle pchVersion);

    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamClient_GetISteamRemotePlay", CallingConvention = CallingConvention.Cdecl)]
    public static extern IntPtr ISteamClient_GetISteamRemotePlay(
      IntPtr instancePtr,
      HSteamUser hSteamUser,
      HSteamPipe hSteamPipe,
      InteropHelp.UTF8StringHandle pchVersion);
    ...
    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamController_ActivateActionSetLayer", CallingConvention = CallingConvention.Cdecl)]
    public static extern void ISteamController_ActivateActionSetLayer(
      IntPtr instancePtr,
      ControllerHandle_t controllerHandle,
      ControllerActionSetHandle_t actionSetLayerHandle);

    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamController_DeactivateActionSetLayer", CallingConvention = CallingConvention.Cdecl)]
    public static extern void ISteamController_DeactivateActionSetLayer(
      IntPtr instancePtr,
      ControllerHandle_t controllerHandle,
      ControllerActionSetHandle_t actionSetLayerHandle);

    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamController_DeactivateAllActionSetLayers", CallingConvention = CallingConvention.Cdecl)]
    public static extern void ISteamController_DeactivateAllActionSetLayers(
      IntPtr instancePtr,
      ControllerHandle_t controllerHandle);

    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamController_GetActiveActionSetLayers", CallingConvention = CallingConvention.Cdecl)]
    public static extern int ISteamController_GetActiveActionSetLayers(
      IntPtr instancePtr,
      ControllerHandle_t controllerHandle,
      [In, Out] ControllerActionSetHandle_t[] handlesOut);
    ...
    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamController_GetInputTypeForHandle", CallingConvention = CallingConvention.Cdecl)]
    ...
    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamController_GetStringForXboxOrigin", CallingConvention = CallingConvention.Cdecl)]
    public static extern IntPtr ISteamController_GetStringForXboxOrigin(
      IntPtr instancePtr,
      EXboxOrigin eOrigin);

    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamController_GetGlyphForXboxOrigin", CallingConvention = CallingConvention.Cdecl)]
    public static extern IntPtr ISteamController_GetGlyphForXboxOrigin(
      IntPtr instancePtr,
      EXboxOrigin eOrigin);

    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamController_GetActionOriginFromXboxOrigin", CallingConvention = CallingConvention.Cdecl)]
    public static extern EControllerActionOrigin ISteamController_GetActionOriginFromXboxOrigin(
      IntPtr instancePtr,
      ControllerHandle_t controllerHandle,
      EXboxOrigin eOrigin);

    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamController_TranslateActionOrigin", CallingConvention = CallingConvention.Cdecl)]
    public static extern EControllerActionOrigin ISteamController_TranslateActionOrigin(
      IntPtr instancePtr,
      ESteamInputType eDestinationInputType,
      EControllerActionOrigin eSourceOrigin);

    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamController_GetControllerBindingRevision", CallingConvention = CallingConvention.Cdecl)]
    [return: MarshalAs(UnmanagedType.I1)]
    public static extern bool ISteamController_GetControllerBindingRevision(
      IntPtr instancePtr,
      ControllerHandle_t controllerHandle,
      out int pMajor,
      out int pMinor);
    ...
    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamFriends_IsClanPublic", CallingConvention = CallingConvention.Cdecl)]
    [return: MarshalAs(UnmanagedType.I1)]
    public static extern bool ISteamFriends_IsClanPublic(IntPtr instancePtr, CSteamID steamIDClan);

    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamFriends_IsClanOfficialGameGroup", CallingConvention = CallingConvention.Cdecl)]
    [return: MarshalAs(UnmanagedType.I1)]
    public static extern bool ISteamFriends_IsClanOfficialGameGroup(
      IntPtr instancePtr,
      CSteamID steamIDClan);

    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamFriends_GetNumChatsWithUnreadPriorityMessages", CallingConvention = CallingConvention.Cdecl)]
    ...
    public static extern void ISteamHTMLSurface_KeyDown(
      ...
      [MarshalAs(UnmanagedType.I1)] bool bIsSystemKey);
    ...
    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamHTMLSurface_OpenDeveloperTools", CallingConvention = CallingConvention.Cdecl)]
    public static extern void ISteamHTMLSurface_OpenDeveloperTools(
      IntPtr instancePtr,
      HHTMLBrowser unBrowserHandle);
    ...
    public static extern int ISteamInput_GetConnectedControllers(
      IntPtr instancePtr,
      [In, Out] InputHandle_t[] handlesOut);

    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamInput_GetActionSetHandle", CallingConvention = CallingConvention.Cdecl)]
    public static extern ulong ISteamInput_GetActionSetHandle(
      IntPtr instancePtr,
      InteropHelp.UTF8StringHandle pszActionSetName);

    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamInput_ActivateActionSet", CallingConvention = CallingConvention.Cdecl)]
    public static extern void ISteamInput_ActivateActionSet(
      IntPtr instancePtr,
      InputHandle_t inputHandle,
      InputActionSetHandle_t actionSetHandle);

    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamInput_GetCurrentActionSet", CallingConvention = CallingConvention.Cdecl)]
    public static extern ulong ISteamInput_GetCurrentActionSet(
      IntPtr instancePtr,
      InputHandle_t inputHandle);

    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamInput_ActivateActionSetLayer", CallingConvention = CallingConvention.Cdecl)]
    public static extern void ISteamInput_ActivateActionSetLayer(
      IntPtr instancePtr,
      InputHandle_t inputHandle,
      InputActionSetHandle_t actionSetLayerHandle);

    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamInput_DeactivateActionSetLayer", CallingConvention = CallingConvention.Cdecl)]
    public static extern void ISteamInput_DeactivateActionSetLayer(
      IntPtr instancePtr,
      InputHandle_t inputHandle,
      InputActionSetHandle_t actionSetLayerHandle);

    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamInput_DeactivateAllActionSetLayers", CallingConvention = CallingConvention.Cdecl)]
    public static extern void ISteamInput_DeactivateAllActionSetLayers(
      IntPtr instancePtr,
      InputHandle_t inputHandle);

    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamInput_GetActiveActionSetLayers", CallingConvention = CallingConvention.Cdecl)]
    public static extern int ISteamInput_GetActiveActionSetLayers(
      IntPtr instancePtr,
      InputHandle_t inputHandle,
      [In, Out] InputActionSetHandle_t[] handlesOut);

    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamInput_GetDigitalActionHandle", CallingConvention = CallingConvention.Cdecl)]
    public static extern ulong ISteamInput_GetDigitalActionHandle(
      IntPtr instancePtr,
      InteropHelp.UTF8StringHandle pszActionName);

    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamInput_GetDigitalActionData", CallingConvention = CallingConvention.Cdecl)]
    public static extern InputDigitalActionData_t ISteamInput_GetDigitalActionData(
      IntPtr instancePtr,
      InputHandle_t inputHandle,
      InputDigitalActionHandle_t digitalActionHandle);

    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamInput_GetDigitalActionOrigins", CallingConvention = CallingConvention.Cdecl)]
    ...
    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamInput_GetAnalogActionHandle", CallingConvention = CallingConvention.Cdecl)]
    public static extern ulong ISteamInput_GetAnalogActionHandle(
      IntPtr instancePtr,
      InteropHelp.UTF8StringHandle pszActionName);

    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamInput_GetAnalogActionData", CallingConvention = CallingConvention.Cdecl)]
    public static extern InputAnalogActionData_t ISteamInput_GetAnalogActionData(
      IntPtr instancePtr,
      InputHandle_t inputHandle,
      InputAnalogActionHandle_t analogActionHandle);

    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamInput_GetAnalogActionOrigins", CallingConvention = CallingConvention.Cdecl)]
    public static extern int ISteamInput_GetAnalogActionOrigins(
      IntPtr instancePtr,
      InputHandle_t inputHandle,
      InputActionSetHandle_t actionSetHandle,
      InputAnalogActionHandle_t analogActionHandle,
    ...
    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamInput_GetGlyphForActionOrigin", CallingConvention = CallingConvention.Cdecl)]
    public static extern IntPtr ISteamInput_GetGlyphForActionOrigin(
      IntPtr instancePtr,
      EInputActionOrigin eOrigin);

    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamInput_GetStringForActionOrigin", CallingConvention = CallingConvention.Cdecl)]
    public static extern IntPtr ISteamInput_GetStringForActionOrigin(
      IntPtr instancePtr,
      EInputActionOrigin eOrigin);

    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamInput_StopAnalogActionMomentum", CallingConvention = CallingConvention.Cdecl)]
    public static extern void ISteamInput_StopAnalogActionMomentum(
      IntPtr instancePtr,
      InputHandle_t inputHandle,
      InputAnalogActionHandle_t eAction);

    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamInput_GetMotionData", CallingConvention = CallingConvention.Cdecl)]
    public static extern InputMotionData_t ISteamInput_GetMotionData(
      IntPtr instancePtr,
      InputHandle_t inputHandle);

    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamInput_TriggerVibration", CallingConvention = CallingConvention.Cdecl)]
    ...
    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamInput_SetLEDColor", CallingConvention = CallingConvention.Cdecl)]
    ...
    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamInput_TriggerHapticPulse", CallingConvention = CallingConvention.Cdecl)]
    public static extern void ISteamInput_TriggerHapticPulse(
      IntPtr instancePtr,
      InputHandle_t inputHandle,
      ESteamControllerPad eTargetPad,
      ushort usDurationMicroSec);

    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamInput_TriggerRepeatedHapticPulse", CallingConvention = CallingConvention.Cdecl)]
    ...
    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamInput_ShowBindingPanel", CallingConvention = CallingConvention.Cdecl)]
    [return: MarshalAs(UnmanagedType.I1)]
    public static extern bool ISteamInput_ShowBindingPanel(
      IntPtr instancePtr,
      InputHandle_t inputHandle);

    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamInput_GetInputTypeForHandle", CallingConvention = CallingConvention.Cdecl)]
    public static extern ESteamInputType ISteamInput_GetInputTypeForHandle(
      IntPtr instancePtr,
      InputHandle_t inputHandle);

    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamInput_GetControllerForGamepadIndex", CallingConvention = CallingConvention.Cdecl)]
    public static extern ulong ISteamInput_GetControllerForGamepadIndex(
      IntPtr instancePtr,
      int nIndex);

    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamInput_GetGamepadIndexForController", CallingConvention = CallingConvention.Cdecl)]
    public static extern int ISteamInput_GetGamepadIndexForController(
      IntPtr instancePtr,
      InputHandle_t ulinputHandle);

    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamInput_GetStringForXboxOrigin", CallingConvention = CallingConvention.Cdecl)]
    public static extern IntPtr ISteamInput_GetStringForXboxOrigin(
      IntPtr instancePtr,
      EXboxOrigin eOrigin);

    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamInput_GetGlyphForXboxOrigin", CallingConvention = CallingConvention.Cdecl)]
    public static extern IntPtr ISteamInput_GetGlyphForXboxOrigin(
      IntPtr instancePtr,
      EXboxOrigin eOrigin);
    ...
    public static extern EInputActionOrigin ISteamInput_GetActionOriginFromXboxOrigin(
      IntPtr instancePtr,
      InputHandle_t inputHandle,
      EXboxOrigin eOrigin);

    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamInput_TranslateActionOrigin", CallingConvention = CallingConvention.Cdecl)]
    public static extern EInputActionOrigin ISteamInput_TranslateActionOrigin(
      IntPtr instancePtr,
      ESteamInputType eDestinationInputType,
      EInputActionOrigin eSourceOrigin);

    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamInput_GetDeviceBindingRevision", CallingConvention = CallingConvention.Cdecl)]
    [return: MarshalAs(UnmanagedType.I1)]
    public static extern bool ISteamInput_GetDeviceBindingRevision(
      IntPtr instancePtr,
      InputHandle_t inputHandle,
      out int pMajor,
      out int pMinor);

    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamInput_GetRemotePlaySessionID", CallingConvention = CallingConvention.Cdecl)]
    public static extern uint ISteamInput_GetRemotePlaySessionID(
      IntPtr instancePtr,
      InputHandle_t inputHandle);
    ...
    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamInventory_StartPurchase", CallingConvention = CallingConvention.Cdecl)]
    ...
    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamInventory_RequestPrices", CallingConvention = CallingConvention.Cdecl)]
    public static extern ulong ISteamInventory_RequestPrices(IntPtr instancePtr);

    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamInventory_GetNumItemsWithPrices", CallingConvention = CallingConvention.Cdecl)]
    public static extern uint ISteamInventory_GetNumItemsWithPrices(IntPtr instancePtr);

    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamInventory_GetItemsWithPrices", CallingConvention = CallingConvention.Cdecl)]
    [return: MarshalAs(UnmanagedType.I1)]
    public static extern bool ISteamInventory_GetItemsWithPrices(
      IntPtr instancePtr,
      [In, Out] SteamItemDef_t[] pArrayItemDefs,
      [In, Out] ulong[] pCurrentPrices,
      [In, Out] ulong[] pBasePrices,
      uint unArrayLength);

    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamInventory_GetItemPrice", CallingConvention = CallingConvention.Cdecl)]
    [return: MarshalAs(UnmanagedType.I1)]
    public static extern bool ISteamInventory_GetItemPrice(
      IntPtr instancePtr,
      SteamItemDef_t iDefinition,
      out ulong pCurrentPrice,
      out ulong pBasePrice);

    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamInventory_StartUpdateProperties", CallingConvention = CallingConvention.Cdecl)]
    public static extern ulong ISteamInventory_StartUpdateProperties(IntPtr instancePtr);

    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamInventory_RemoveProperty", CallingConvention = CallingConvention.Cdecl)]
    [return: MarshalAs(UnmanagedType.I1)]
    ...
    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamInventory_SetProperty", CallingConvention = CallingConvention.Cdecl)]
    [return: MarshalAs(UnmanagedType.I1)]
    ...
    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamInventory_SetProperty0", CallingConvention = CallingConvention.Cdecl)]
    [return: MarshalAs(UnmanagedType.I1)]
    ...
    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamInventory_SetProperty1", CallingConvention = CallingConvention.Cdecl)]
    [return: MarshalAs(UnmanagedType.I1)]
    ...
    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamInventory_SetProperty2", CallingConvention = CallingConvention.Cdecl)]
    [return: MarshalAs(UnmanagedType.I1)]
    ...
    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamInventory_SubmitUpdateProperties", CallingConvention = CallingConvention.Cdecl)]
    [return: MarshalAs(UnmanagedType.I1)]
    ...
    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamGameSearch_AddGameSearchParams", CallingConvention = CallingConvention.Cdecl)]
    public static extern EGameSearchErrorCode_t ISteamGameSearch_AddGameSearchParams(
      IntPtr instancePtr,
      InteropHelp.UTF8StringHandle pchKeyToFind,
      InteropHelp.UTF8StringHandle pchValuesToFind);

    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamGameSearch_SearchForGameWithLobby", CallingConvention = CallingConvention.Cdecl)]
    public static extern EGameSearchErrorCode_t ISteamGameSearch_SearchForGameWithLobby(
      IntPtr instancePtr,
      CSteamID steamIDLobby,
      int nPlayerMin,
      int nPlayerMax);

    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamGameSearch_SearchForGameSolo", CallingConvention = CallingConvention.Cdecl)]
    public static extern EGameSearchErrorCode_t ISteamGameSearch_SearchForGameSolo(
      IntPtr instancePtr,
      int nPlayerMin,
      int nPlayerMax);

    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamGameSearch_AcceptGame", CallingConvention = CallingConvention.Cdecl)]
    public static extern EGameSearchErrorCode_t ISteamGameSearch_AcceptGame(
      IntPtr instancePtr);

    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamGameSearch_DeclineGame", CallingConvention = CallingConvention.Cdecl)]
    public static extern EGameSearchErrorCode_t ISteamGameSearch_DeclineGame(
      IntPtr instancePtr);

    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamGameSearch_RetrieveConnectionDetails", CallingConvention = CallingConvention.Cdecl)]
    public static extern EGameSearchErrorCode_t ISteamGameSearch_RetrieveConnectionDetails(
      IntPtr instancePtr,
      CSteamID steamIDHost,
      IntPtr pchConnectionDetails,
      int cubConnectionDetails);

    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamGameSearch_EndGameSearch", CallingConvention = CallingConvention.Cdecl)]
    public static extern EGameSearchErrorCode_t ISteamGameSearch_EndGameSearch(
      IntPtr instancePtr);

    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamGameSearch_SetGameHostParams", CallingConvention = CallingConvention.Cdecl)]
    public static extern EGameSearchErrorCode_t ISteamGameSearch_SetGameHostParams(
      IntPtr instancePtr,
      InteropHelp.UTF8StringHandle pchKey,
      InteropHelp.UTF8StringHandle pchValue);

    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamGameSearch_SetConnectionDetails", CallingConvention = CallingConvention.Cdecl)]
    public static extern EGameSearchErrorCode_t ISteamGameSearch_SetConnectionDetails(
      IntPtr instancePtr,
      InteropHelp.UTF8StringHandle pchConnectionDetails,
      int cubConnectionDetails);

    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamGameSearch_RequestPlayersForGame", CallingConvention = CallingConvention.Cdecl)]
    public static extern EGameSearchErrorCode_t ISteamGameSearch_RequestPlayersForGame(
      IntPtr instancePtr,
      int nPlayerMin,
      int nPlayerMax,
      int nMaxTeamSize);

    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamGameSearch_HostConfirmGameStart", CallingConvention = CallingConvention.Cdecl)]
    public static extern EGameSearchErrorCode_t ISteamGameSearch_HostConfirmGameStart(
      IntPtr instancePtr,
      ulong ullUniqueGameID);

    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamGameSearch_CancelRequestPlayersForGame", CallingConvention = CallingConvention.Cdecl)]
    public static extern EGameSearchErrorCode_t ISteamGameSearch_CancelRequestPlayersForGame(
      IntPtr instancePtr);

    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamGameSearch_SubmitPlayerResult", CallingConvention = CallingConvention.Cdecl)]
    public static extern EGameSearchErrorCode_t ISteamGameSearch_SubmitPlayerResult(
      IntPtr instancePtr,
      ulong ullUniqueGameID,
      CSteamID steamIDPlayer,
      EPlayerResult_t EPlayerResult);

    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamGameSearch_EndGame", CallingConvention = CallingConvention.Cdecl)]
    public static extern EGameSearchErrorCode_t ISteamGameSearch_EndGame(
      IntPtr instancePtr,
      ulong ullUniqueGameID);

    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamParties_GetNumActiveBeacons", CallingConvention = CallingConvention.Cdecl)]
    public static extern uint ISteamParties_GetNumActiveBeacons(IntPtr instancePtr);

    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamParties_GetBeaconByIndex", CallingConvention = CallingConvention.Cdecl)]
    public static extern ulong ISteamParties_GetBeaconByIndex(IntPtr instancePtr, uint unIndex);

    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamParties_GetBeaconDetails", CallingConvention = CallingConvention.Cdecl)]
    [return: MarshalAs(UnmanagedType.I1)]
    public static extern bool ISteamParties_GetBeaconDetails(
      IntPtr instancePtr,
    ...
    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamParties_JoinParty", CallingConvention = CallingConvention.Cdecl)]
    public static extern ulong ISteamParties_JoinParty(
      IntPtr instancePtr,
      PartyBeaconID_t ulBeaconID);

    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamParties_GetNumAvailableBeaconLocations", CallingConvention = CallingConvention.Cdecl)]
    [return: MarshalAs(UnmanagedType.I1)]
    public static extern bool ISteamParties_GetNumAvailableBeaconLocations(
      IntPtr instancePtr,
      out uint puNumLocations);

    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamParties_GetAvailableBeaconLocations", CallingConvention = CallingConvention.Cdecl)]
    [return: MarshalAs(UnmanagedType.I1)]
    public static extern bool ISteamParties_GetAvailableBeaconLocations(
      IntPtr instancePtr,
      [In, Out] SteamPartyBeaconLocation_t[] pLocationList,
      uint uMaxNumLocations);

    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamParties_CreateBeacon", CallingConvention = CallingConvention.Cdecl)]
    public static extern ulong ISteamParties_CreateBeacon(
      IntPtr instancePtr,
      uint unOpenSlots,
    ...
    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamParties_OnReservationCompleted", CallingConvention = CallingConvention.Cdecl)]
    public static extern void ISteamParties_OnReservationCompleted(
      IntPtr instancePtr,
      PartyBeaconID_t ulBeacon,
      CSteamID steamIDUser);

    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamParties_CancelReservation", CallingConvention = CallingConvention.Cdecl)]
    public static extern void ISteamParties_CancelReservation(
      IntPtr instancePtr,
      PartyBeaconID_t ulBeacon,
      CSteamID steamIDUser);

    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamParties_ChangeNumOpenSlots", CallingConvention = CallingConvention.Cdecl)]
    public static extern ulong ISteamParties_ChangeNumOpenSlots(
      IntPtr instancePtr,
      PartyBeaconID_t ulBeacon,
      uint unOpenSlots);

    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamParties_DestroyBeacon", CallingConvention = CallingConvention.Cdecl)]
    [return: MarshalAs(UnmanagedType.I1)]
    public static extern bool ISteamParties_DestroyBeacon(
      IntPtr instancePtr,
      PartyBeaconID_t ulBeacon);

    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamParties_GetBeaconLocationData", CallingConvention = CallingConvention.Cdecl)]
    [return: MarshalAs(UnmanagedType.I1)]
    public static extern bool ISteamParties_GetBeaconLocationData(
      IntPtr instancePtr,
      SteamPartyBeaconLocation_t BeaconLocation,
      ESteamPartyBeaconLocationData eData,
      IntPtr pchDataStringOut,
    ...
    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamRemotePlay_GetSessionCount", CallingConvention = CallingConvention.Cdecl)]
    public static extern uint ISteamRemotePlay_GetSessionCount(IntPtr instancePtr);

    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamRemotePlay_GetSessionID", CallingConvention = CallingConvention.Cdecl)]
    public static extern uint ISteamRemotePlay_GetSessionID(IntPtr instancePtr, int iSessionIndex);

    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamRemotePlay_GetSessionSteamID", CallingConvention = CallingConvention.Cdecl)]
    public static extern ulong ISteamRemotePlay_GetSessionSteamID(
      IntPtr instancePtr,
      uint unSessionID);

    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamRemotePlay_GetSessionClientName", CallingConvention = CallingConvention.Cdecl)]
    public static extern IntPtr ISteamRemotePlay_GetSessionClientName(
      IntPtr instancePtr,
      uint unSessionID);

    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamRemotePlay_GetSessionClientFormFactor", CallingConvention = CallingConvention.Cdecl)]
    public static extern ESteamDeviceFormFactor ISteamRemotePlay_GetSessionClientFormFactor(
      IntPtr instancePtr,
      uint unSessionID);

    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamRemotePlay_BGetSessionClientResolution", CallingConvention = CallingConvention.Cdecl)]
    [return: MarshalAs(UnmanagedType.I1)]
    public static extern bool ISteamRemotePlay_BGetSessionClientResolution(
      IntPtr instancePtr,
      uint unSessionID,
    ...
    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamUGC_CreateQueryAllUGCRequest0", CallingConvention = CallingConvention.Cdecl)]
    public static extern ulong ISteamUGC_CreateQueryAllUGCRequest0(
      IntPtr instancePtr,
      EUGCQuery eQueryType,
      EUGCMatchingUGCType eMatchingeMatchingUGCTypeFileType,
      AppId_t nCreatorAppID,
    ...
    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamUGC_GetQueryUGCKeyValueTag0", CallingConvention = CallingConvention.Cdecl)]
    [return: MarshalAs(UnmanagedType.I1)]
    public static extern bool ISteamUGC_GetQueryUGCKeyValueTag0(
      IntPtr instancePtr,
      UGCQueryHandle_t handle,
      uint index,
      InteropHelp.UTF8StringHandle pchKey,
    ...
    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamUGC_SetAllowLegacyUpload", CallingConvention = CallingConvention.Cdecl)]
    [return: MarshalAs(UnmanagedType.I1)]
    public static extern bool ISteamUGC_SetAllowLegacyUpload(
      IntPtr instancePtr,
      UGCUpdateHandle_t handle,
      [MarshalAs(UnmanagedType.I1)] bool bAllowLegacyUpload);

    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamUGC_RemoveAllItemKeyValueTags", CallingConvention = CallingConvention.Cdecl)]
    [return: MarshalAs(UnmanagedType.I1)]
    public static extern bool ISteamUGC_RemoveAllItemKeyValueTags(
      IntPtr instancePtr,
      UGCUpdateHandle_t handle);
    ...
    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamUser_GetMarketEligibility", CallingConvention = CallingConvention.Cdecl)]
    public static extern ulong ISteamUser_GetMarketEligibility(IntPtr instancePtr);

    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamUser_GetDurationControl", CallingConvention = CallingConvention.Cdecl)]
    ...
    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamUtils_IsSteamChinaLauncher", CallingConvention = CallingConvention.Cdecl)]
    [return: MarshalAs(UnmanagedType.I1)]
    public static extern bool ISteamUtils_IsSteamChinaLauncher(IntPtr instancePtr);

    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamUtils_InitFilterText", CallingConvention = CallingConvention.Cdecl)]
    [return: MarshalAs(UnmanagedType.I1)]
    public static extern bool ISteamUtils_InitFilterText(IntPtr instancePtr);

    [DllImport("steam_api64", EntryPoint = "SteamAPI_ISteamUtils_FilterText", CallingConvention = CallingConvention.Cdecl)]
    public static extern int ISteamUtils_FilterText(
      IntPtr instancePtr,
      IntPtr pchOutFilteredText,
      uint nByteSizeOutFilteredText,
      InteropHelp.UTF8StringHandle pchInputMessage,
      [MarshalAs(UnmanagedType.I1)] bool bLegalOnly);
