...
namespace Steamworks
{
  public static class SteamGameServerUGC
  {
    ...
    {
      InteropHelp.TestIfAvailableGameServer();
      using (InteropHelp.UTF8StringHandle pchCursor1 = new InteropHelp.UTF8StringHandle(pchCursor))
        return (UGCQueryHandle_t) NativeMethods.ISteamUGC_CreateQueryAllUGCRequest0(CSteamGameServerAPIContext.GetSteamUGC(), eQueryType, eMatchingeMatchingUGCTypeFileType, nCreatorAppID, nConsumerAppID, pchCursor1);
    }
    ...
    {
      InteropHelp.TestIfAvailableGameServer();
      IntPtr num = Marshal.AllocHGlobal((int) cchValueSize);
      using (InteropHelp.UTF8StringHandle pchKey1 = new InteropHelp.UTF8StringHandle(pchKey))
      {
        bool queryUgcKeyValueTag0 = NativeMethods.ISteamUGC_GetQueryUGCKeyValueTag0(CSteamGameServerAPIContext.GetSteamUGC(), handle, index, pchKey1, num, cchValueSize);
        pchValue = queryUgcKeyValueTag0 ? InteropHelp.PtrToStringUTF8(num) : (string) null;
        Marshal.FreeHGlobal(num);
        return queryUgcKeyValueTag0;
      }
    }
    ...
    public static SteamAPICall_t CreateItem(
      AppId_t nConsumerAppId,
    ...
    public static SteamAPICall_t SubmitItemUpdate(
      UGCUpdateHandle_t handle,
    ...
    public static SteamAPICall_t SetUserItemVote(
      PublishedFileId_t nPublishedFileID,
      bool bVoteUp)
    {
      InteropHelp.TestIfAvailableGameServer();
    ...
    public static SteamAPICall_t AddAppDependency(
      PublishedFileId_t nPublishedFileID,
      AppId_t nAppID)
    {
      InteropHelp.TestIfAvailableGameServer();
