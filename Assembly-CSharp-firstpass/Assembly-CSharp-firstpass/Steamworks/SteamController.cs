...
namespace Steamworks
{
  public static class SteamController
  {
    ...
    {
      InteropHelp.TestIfAvailableClient();
      return handlesOut.Length == 16 ? NativeMethods.ISteamController_GetConnectedControllers(CSteamAPIContext.GetSteamController(), handlesOut) : throw new ArgumentException("handlesOut must be the same size as Constants.STEAM_CONTROLLER_MAX_COUNT!");
    }

    public static ControllerActionSetHandle_t GetActionSetHandle(
    ...
    {
      InteropHelp.TestIfAvailableClient();
      return handlesOut.Length == 16 ? NativeMethods.ISteamController_GetActiveActionSetLayers(CSteamAPIContext.GetSteamController(), controllerHandle, handlesOut) : throw new ArgumentException("handlesOut must be the same size as Constants.STEAM_CONTROLLER_MAX_ACTIVE_LAYERS!");
    }

    public static ControllerDigitalActionHandle_t GetDigitalActionHandle(
    ...
    public static ControllerAnalogActionHandle_t GetAnalogActionHandle(
      string pszActionName)
    {
      InteropHelp.TestIfAvailableClient();
      using (InteropHelp.UTF8StringHandle pszActionName1 = new InteropHelp.UTF8StringHandle(pszActionName))
    ...
    public static ControllerMotionData_t GetMotionData(
      ControllerHandle_t controllerHandle)
    {
      InteropHelp.TestIfAvailableClient();
    ...
    public static ESteamInputType GetInputTypeForHandle(
      ControllerHandle_t controllerHandle)
    {
      InteropHelp.TestIfAvailableClient();
    ...
    public static EControllerActionOrigin GetActionOriginFromXboxOrigin(
      ControllerHandle_t controllerHandle,
      EXboxOrigin eOrigin)
    {
      InteropHelp.TestIfAvailableClient();
    ...
    public static EControllerActionOrigin TranslateActionOrigin(
    ...
    public static bool GetControllerBindingRevision(
      ControllerHandle_t controllerHandle,
      out int pMajor,
      out int pMinor)
    {
